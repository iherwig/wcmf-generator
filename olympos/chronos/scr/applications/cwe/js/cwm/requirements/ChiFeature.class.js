...
Ext.extend(cwm.requirements.ChiFeature, cwe.model.ModelClass);

cwm.requirements.ChiFeature.prototype.getEditorItems = function() {
...
cwe.model.ModelClassContainer.getInstance().registerClass(new cwm.requirements.ChiFeature());
