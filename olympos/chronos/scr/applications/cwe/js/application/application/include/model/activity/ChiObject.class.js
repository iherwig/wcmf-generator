...
application.application.include.model.activity.ChiObject = function() {
	...
	this.cweModelElementId = "ChiObject";
	this.name = "ChiObject";
...
Ext.extend(application.application.include.model.activity.ChiObject, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ChiObject());
