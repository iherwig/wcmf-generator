...
application.application.include.model.UseCases.ChiBusinessPartnerPassive = function() {
	...
	this.cweModelElementId = "ChiBusinessPartnerPassive";
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessPartnerPassive, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessPartnerPassive());
