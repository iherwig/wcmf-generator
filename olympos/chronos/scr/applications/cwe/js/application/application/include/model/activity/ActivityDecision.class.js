...
application.application.include.model.activity.ActivityDecision = function() {
	application.application.include.model.activity.ActivityDecision.superclass.constructor.call(this, arguments);
	
	this.cweModelElementId = "ActivityDecision";
	...
	, 
		...
		{
			name : "childNMActivityActivityDecision",
			mapping : "childNMActivityActivityDecision"
		}
	, 
		{
			name : "childFigure",
	...
	, 
		...
		"childNMActivityActivityDecision" : {
			isParent : false,
...
Ext.extend(application.application.include.model.activity.ActivityDecision, cwe.model.ModelClass);


application.application.include.model.activity.ActivityDecision.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityDecision.prototype.getEditorItems = function() {
	return [
	...
	new cwe.editor.control.TextField({
		...
		new cwe.editor.control.MultipleAssociate( {
			...
			fieldLabel : "childNMActivityActivityDecision",
			name : "childNMActivityActivityDecision",
			dataIndex : "childNMActivityActivityDecision",
			targetCweModelElementId : "NMActivityActivityDecision",
			isParent : false
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivityDecision());
