...
application.application.include.model.activity.ActivitySend = function() {
	...
	this.cweModelElementId = "ActivitySend";
...
Ext.extend(application.application.include.model.activity.ActivitySend, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivitySend());
