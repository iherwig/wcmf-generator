...
application.application.include.model.domain.DisplayType = function() {
	...
	this.cweModelElementId = "DisplayType";
...
Ext.extend(application.application.include.model.domain.DisplayType, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.DisplayType());
