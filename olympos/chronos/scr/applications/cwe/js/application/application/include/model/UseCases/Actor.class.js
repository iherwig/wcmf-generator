...
Ext.extend(application.application.include.model.UseCases.Actor, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.Actor());
