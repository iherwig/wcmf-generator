...
application.application.include.model.domain.ChiActionKey = function() {
	application.application.include.model.domain.ChiActionKey.superclass.constructor.call(this, arguments);
	
	this.cweModelElementId = "ChiActionKey";
	this.name = "ChiActionKey";
	this.treeIconClass = "ChiActionKeyTreeIcon16x16";
...
Ext.extend(application.application.include.model.domain.ChiActionKey, cwe.model.ModelClass);


application.application.include.model.domain.ChiActionKey.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.domain.ChiActionKey.prototype.getEditorItems = function() {
	return [
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiActionKey());
