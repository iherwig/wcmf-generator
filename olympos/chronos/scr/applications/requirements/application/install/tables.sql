...
(
  ...
  `fk_diagram_id` INT(11), # columnId=EAID_F6E80A6E_A203_4fb4_9DD0_FE227031ADD1_fk_diagram_id referencedTable=Diagram
...
CREATE TABLE `NMUCActor` # entityType=NMUCActor tableId=EAID_0863D9E9_ADE5_4c27_9118_97B5FEECAEAE
(
  `id` INT(11) NOT NULL, # columnId=EAID_0863D9E9_ADE5_4c27_9118_97B5FEECAEAE_id 
  `fk_chibusinessusecasecore_id` INT(11), # columnId=EAID_63789429_77BC_46a1_81D8_1D06696D0669_fk_chibusinessusecasecore_id referencedTable=ChiBusinessUseCaseCore
  `fk_chiworkerexternal_id` INT(11), # columnId=EAID_52B75F68_6CC4_42bc_875F_E778C772B4C6_fk_chiworkerexternal_id referencedTable=ChiWorkerExternal
  `fk_chiworkerinternal_id` INT(11), # columnId=EAID_2A793A11_60C7_4108_9C85_18F6F015505F_fk_chiworkerinternal_id referencedTable=ChiWorkerInternal
  `fk_chiworker_id` INT(11), # columnId=EAID_4B1FF5A9_E03E_441c_ADD2_BD9B082D4D20_fk_chiworker_id referencedTable=ChiWorker
