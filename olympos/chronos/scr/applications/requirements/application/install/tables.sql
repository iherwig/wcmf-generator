...
CREATE TABLE `UserRDB` # entityType=UserRDB tableId=EAID_B8AEA9E2_2228_42b9_9121_FDA1DF50E05D
(
  ...
  `firstname` VARCHAR(255), # columnId={7AA15204-4902-45a5-AF96-599B511B4812} 
...
(
  ...
  `name` VARCHAR(255), # columnId={451E3B0C-4DF2-4f43-9F9E-88306EFE8D68} 
  PRIMARY KEY (`id`)
) TYPE=MyISAM;
#
...
CREATE TABLE `NMUserRole` # entityType=NMUserRole tableId=EAID_4AB7C88E_CE09_4fba_A8C9_1DBEEC9B5EFC
(
...
(
  ...
  `author` VARCHAR(255), # columnId={D186E5D9-FDC7-45ff-B40F-B7E648E7AACD} 
