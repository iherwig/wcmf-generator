...
<?php if ($this->_tpl_vars['viewMode'] == 'detail'): ?>
    ...
    // ChiGoal
    <?php $this->assign('template', $this->_tpl_vars['possibleparents']['ChiGoal']); ?>
...
, sortable:true, renderer:grids['ChiGoalParent'].renderColumnDefault.createDelegate(grids['ChiGoalParent'])});
...
'}, handler:function(){dlgChiGoalParent.show('ChiGoal', grids['ChiGoalParent'], '<?php echo $this->_tpl_vars['node']->getOID(); ?>
', true);}});
    <?php endif; ?>
    buttonDefs['ChiGoalParent'] = curButtonDefs;
    // grid initialization
    grids['ChiGoalParent'].init('<?php echo $this->_tpl_vars['template']->getObjectDisplayName(); ?>
', 'ChiGoal', "<?php echo ((is_array($_tmp=$this->_tpl_vars['nodeUtil']->getParentQuery('ChiGoal',$this->_tpl_vars['node']))) ? $this->_run_mod_handler('replace', true, $_tmp, "'", "\'") : smarty_modifier_replace($_tmp, "'", "\'")); ?>
", columDefs['ChiGoalParent'], {paging:false, autoheight:true, singleSelect:true, ddRows:<?php echo $this->_tpl_vars['ddRows']; ?>
}, [new wcmf.grid.EditAction()<?php if ($this->_tpl_vars['template']->getProperty('composition') == false): ?>, new wcmf.grid.DeleteAction()<?php endif; ?>], buttonDefs['ChiGoalParent']);
    ...
    // ChiIssue
    <?php $this->assign('template', $this->_tpl_vars['possiblechildren']['ChiIssue']); ?>
...
", header:"<?php echo $this->_tpl_vars['name']; ?>
", width:<?php echo $this->_tpl_vars['columnWidth']; ?>
, sortable:true, renderer:grids['ChiIssueChild'].renderColumnDefault.createDelegate(grids['ChiIssueChild'])});
    <?php endforeach; endif; unset($_from); ?>
...
'); submitAction('new');}});
      ...
      curButtonDefs.push({icon:'images/link.png', cls:'x-btn-icon', tooltip:{text:'<?php echo smarty_function_translate(array('text' => 'Associate selected'), $this);?>
'}, 
        handler:function(){dlgChiIssueChild.show('<?php echo $this->_tpl_vars['realSubject']->getType(); ?>
', grids['ChiIssueChild'], '<?php echo $this->_tpl_vars['poid']; ?>
', false);}});
      <?php endif; ?>
    <?php endif; ?>
    buttonDefs['ChiIssueChild'] = curButtonDefs;
    // grid initialization
    grids['ChiIssueChild'].init('<?php echo $this->_tpl_vars['realSubject']->getObjectDisplayName(); ?>
', 'ChiIssue', '<?php echo ((is_array($_tmp=$this->_tpl_vars['nodeUtil']->getChildQuery($this->_tpl_vars['node'],'ChiIssue'))) ? $this->_run_mod_handler('replace', true, $_tmp, "'", "\'") : smarty_modifier_replace($_tmp, "'", "\'")); ?>
', columDefs['ChiIssueChild'], {paging:true, autoheight:true, singleSelect:true, ddRows:<?php echo $this->_tpl_vars['ddRows']; ?>
}, [new wcmf.grid.EditAction(), <?php if ($this->_tpl_vars['template']->getProperty('canCreate')): ?>new wcmf.grid.DuplicateAction(), <?php endif; ?>new wcmf.grid.DeleteAction()], buttonDefs['ChiIssueChild'], {ptype:'<?php echo $this->_tpl_vars['node']->getType(); ?>
...
'});
    ...
    <?php $this->assign('template', $this->_tpl_vars['possiblechildren']['NMFeatureRequirements']); ?>
    <?php $this->assign('realSubject', $this->_tpl_vars['template']); ?>
    <?php if ($this->_tpl_vars['template']->getProperty('realSubject')): ?>
      <?php $this->assign('realSubject', $this->_tpl_vars['template']->getProperty('realSubject')); ?>
    <?php endif; ?>
...
", header:"<?php echo $this->_tpl_vars['name']; ?>
", width:<?php echo $this->_tpl_vars['columnWidth']; ?>
, sortable:true, renderer:grids['NMFeatureRequirementsChild'].renderColumnDefault.createDelegate(grids['NMFeatureRequirementsChild'])});
    <?php endforeach; endif; unset($_from); ?>
...
'); submitAction('new');}});
      ...
      curButtonDefs.push({icon:'images/link.png', cls:'x-btn-icon', tooltip:{text:'<?php echo smarty_function_translate(array('text' => 'Associate selected'), $this);?>
'}, 
        handler:function(){dlgNMFeatureRequirementsChild.show('<?php echo $this->_tpl_vars['realSubject']->getType(); ?>
', grids['NMFeatureRequirementsChild'], '<?php echo $this->_tpl_vars['poid']; ?>
', false);}});
      <?php endif; ?>
    <?php endif; ?>
    buttonDefs['NMFeatureRequirementsChild'] = curButtonDefs;
    // grid initialization
    grids['NMFeatureRequirementsChild'].init('<?php echo $this->_tpl_vars['realSubject']->getObjectDisplayName(); ?>
', 'NMFeatureRequirements', '<?php echo ((is_array($_tmp=$this->_tpl_vars['nodeUtil']->getChildQuery($this->_tpl_vars['node'],'NMFeatureRequirements'))) ? $this->_run_mod_handler('replace', true, $_tmp, "'", "\'") : smarty_modifier_replace($_tmp, "'", "\'")); ?>
', columDefs['NMFeatureRequirementsChild'], {paging:true, autoheight:true, singleSelect:true, ddRows:<?php echo $this->_tpl_vars['ddRows']; ?>
}, [new wcmf.grid.EditAction(), <?php if ($this->_tpl_vars['template']->getProperty('canCreate')): ?>new wcmf.grid.DuplicateAction(), <?php endif; ?>new wcmf.grid.DeleteAction()], buttonDefs['NMFeatureRequirementsChild'], {ptype:'<?php echo $this->_tpl_vars['node']->getType(); ?>
', poid:'<?php echo $this->_tpl_vars['node']->getOID(); ?>
'});
...
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('reqType'); ?>
	...
	<span class="right"><?php echo $this->_tpl_vars['nodeUtil']->getInputControl($this->_tpl_vars['node'],'reqType'); ?>
</span>

	<span class="dottedSeparator"></span>
	<span class="left" title="<?php echo $this->_tpl_vars['node']->getValueDescription('Priority'); ?>
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('Priority'); ?>
</span>
	<span class="right"><?php echo $this->_tpl_vars['nodeUtil']->getInputControl($this->_tpl_vars['node'],'Priority'); ?>
</span>
...
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('Author'); ?>
	...
	<span class="dottedSeparator"></span>
	<span class="left" title="<?php echo $this->_tpl_vars['node']->getValueDescription('Proofreader'); ?>
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('Proofreader'); ?>
</span>
	<span class="right"><?php echo $this->_tpl_vars['nodeUtil']->getInputControl($this->_tpl_vars['node'],'Proofreader'); ?>
</span>
