...
req.figure.ChiBase = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiBase", label, oid, parentoids, childoids);
}
...
req.figure.ChiBase.prototype.getStore = function(){
...
req.figure.ChiBase.prototype.showEdit = function(bd, oid){
