...
class PackageRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Package' && $parentType == 'Package') return 'Composition';
    if ($parentType == 'Model') return 'fk_model_id';
    if ($parentType == 'Package') return 'Composition';
    return '';
  }
  /**
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'Package', 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'Composition')
    );
    $nodeDef['_children'] = array
    (

      array('type' => 'Package', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'Composition', 'order_by' => array()),
      ...
      array('type' => 'Class', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'Class', 'pk_columns' => array('id'), 'fk_columns' => 'fk_package_id', 'order_by' => array()),
