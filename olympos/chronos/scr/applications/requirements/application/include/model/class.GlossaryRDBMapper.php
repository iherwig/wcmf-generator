...
require_once(BASE."application/include/model/class.Glossary.php");

/**
 * @class GlossaryRDBMapper
 * GlossaryRDBMapper maps Glossary Nodes to the database.
 * Glossary description: 
 *
 * @author 
 * @version 1.0
 */
class GlossaryRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Glossary' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION ID(application/include/model/class.GlossaryRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
     ...
     /* 
      * Value description: the type of glossary entry (eg business, technical, etc)
      */
      array('name' => 'entryType', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'entrytype', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
    ...
    (
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_glossary_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
