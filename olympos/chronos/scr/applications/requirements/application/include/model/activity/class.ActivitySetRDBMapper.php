...
class ActivitySetRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivitySet' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'ProductionRuleSet', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ProductionRuleSet', 'pk_columns' => array('id'), 'fk_columns' => 'fk_activityset_id', 'order_by' => array()),
