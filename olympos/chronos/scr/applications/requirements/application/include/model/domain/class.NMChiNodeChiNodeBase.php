 ...
 * @version 1.0
 */
class NMChiNodeChiNodeBase extends Relation
{
    function NMChiNodeChiNodeBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::Relation($oid, 'NMChiNodeChiNode');
      else
    ...
    {
      return Message::get("NMChiNodeChiNode");
    }
    /**
