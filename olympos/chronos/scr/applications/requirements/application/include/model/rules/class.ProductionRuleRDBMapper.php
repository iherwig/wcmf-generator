...
require_once(BASE."application/include/model/rules/class.ProductionRule.php");

/**
 * @class ProductionRuleRDBMapper
 * ProductionRuleRDBMapper maps ProductionRule Nodes to the database.
 * ProductionRule description: 
 *
 * @author 
 * @version 1.0
 */
class ProductionRuleRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ProductionRule' && $parentType == 'ProductionRuleSet') return 'fk_productionruleset_id';
    if ($this->getType() == 'ProductionRule' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION ID(application/include/model/rules/class.ProductionRuleRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'RuleAction', 'minOccurs' => 1, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'RuleAction', 'pk_columns' => array('id'), 'fk_columns' => 'fk_productionrule_id', 'order_by' => array()),
      array('type' => 'RuleCondition', 'minOccurs' => 1, 'maxOccurs' => 1, 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'RuleCondition', 'pk_columns' => array('id'), 'fk_columns' => 'fk_productionrule_id', 'order_by' => array()),
      array('type' => 'RuleVariable', 'minOccurs' => 1, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'RuleVariable', 'pk_columns' => array('id'), 'fk_columns' => 'fk_productionrule_id', 'order_by' => array()),
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_productionrule_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
