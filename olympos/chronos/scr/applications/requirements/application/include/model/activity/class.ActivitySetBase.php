 ...
 * @version 1.0
 */
class ActivitySetBase extends EntityBaseExtended
{
    function ActivitySetBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::EntityBaseExtended($oid, 'ActivitySet');
      else
    ...
    {
      return $this->getChildrenEx(null, 'Activity', array('Aggregation' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ActivityDecision', array('Aggregation' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ActivityReceive', array('Aggregation' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ActivitySend', array('Aggregation' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ActivityInitial', array('Aggregation' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ActivityFinal', array('Aggregation' => $this->getDBID()), null, false);
    }
    /**
