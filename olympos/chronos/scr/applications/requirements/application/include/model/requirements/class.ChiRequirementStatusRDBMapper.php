...
require_once(BASE."application/include/model/requirements/class.ChiRequirementStatus.php");

/**
 * @class ChiRequirementStatusRDBMapper
 * ChiRequirementStatusRDBMapper maps ChiRequirementStatus Nodes to the database.
 * ChiRequirementStatus description: 
 *
 * @author 
 * @version 1.0
 */
class ChiRequirementStatusRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  {
    return new ChiRequirementStatus($oid);
  }
  /**
...
// PROTECTED REGION ID(application/include/model/requirements/class.ChiRequirementStatusRDBMapper.php/Properties) ENABLED START
