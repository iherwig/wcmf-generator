...
class NMFeatureRequirementsRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('ChiFeature', 'ChiRequirement')),
      array('name' => 'is_searchable', 'value' => true),
      array('name' => 'display_value', 'value' => 'Name'),
// PROTECTED REGION ID(application/include/model/requirements/class.NMFeatureRequirementsRDBMapper.php/Properties) START
