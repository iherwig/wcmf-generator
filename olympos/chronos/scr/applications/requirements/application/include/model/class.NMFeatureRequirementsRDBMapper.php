...
require_once(BASE."application/include/model/class.NMFeatureRequirements.php");
...
// PROTECTED REGION ID(application/include/model/class.NMFeatureRequirementsRDBMapper.php/Properties) START
