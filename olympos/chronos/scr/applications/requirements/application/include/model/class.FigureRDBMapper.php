...
// PROTECTED REGION END
    ...
    (
     ...
     /* 
      * Value description: defines if inherited attributes should be displayed for a ClassFigure
      */
      array('name' => 'showInheritedAttributes', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'showinheritedattributes', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
