...
class ActivityInitialRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivityInitial' && $parentType == 'ActivitySet') return 'Aggregation';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'Activity', 'minOccurs' => 0, 'maxOccurs' => 1, 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Activity', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
