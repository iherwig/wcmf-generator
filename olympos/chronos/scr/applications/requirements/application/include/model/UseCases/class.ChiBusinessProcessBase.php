...
class ChiBusinessProcessBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'ChiBusinessUseCase', array('Composition' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiBusinessUseCaseCore', array('Composition' => $this->getDBID()), null, false);
    }
