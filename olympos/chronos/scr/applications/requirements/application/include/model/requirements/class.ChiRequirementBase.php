...
class ChiRequirementBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'ChiRequirement', array('Composition' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiIssue', array('Dependency' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'NMFeatureRequirements', array('Realization' => $this->getDBID()), null, false);
    }
    /**
    ...
    function loadChildren($type, $buildDepth=BUILDDEPTH_SINGLE, $forceUpdate=false)
    {
      ...
      if ($type == 'ChiFeature')
      {
        ...
        $children = parent::getChildrenEx(null, 'NMFeatureRequirements', array('Realization' => $this->getDBID()), null, false);
    ...
    function addChild(&$child, $addtype=ADDCHILD_BACK)
    {
      if ($child != null && $child->getType() == 'ChiFeature')
      {
        ...
        $relOID = $persistenceFacade->getFirstOID('NMFeatureRequirements', array('Realization' => $this->getDBID(), 'Realization' => $child->getDBID()));
        if ($relOID == null)
        {
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiFeature')
      {
        ...
        $associationNodeConstraint = array('NMFeatureRequirements', array('Realization' => $this->getDBID(), 'Realization' => $ids[0]));
        $associationNode = &$this->getFirstChild('NMFeatureRequirements', $associationNodeConstraint, null);
