...
req.figure.ChiView = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiView", label, oid, parentoids, childoids);
}
...
req.figure.ChiView.prototype.getStore = function(){
...
req.figure.ChiView.prototype.showEdit = function(bd, oid){
