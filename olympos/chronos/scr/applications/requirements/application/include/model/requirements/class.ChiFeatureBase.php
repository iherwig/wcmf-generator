...
class ChiFeatureBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'ChiBusinessUseCase', array('fk_chifeature_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_chifeature_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiBusinessUseCaseCore', array('fk_chifeature_id' => $this->getDBID()), null);
    }
