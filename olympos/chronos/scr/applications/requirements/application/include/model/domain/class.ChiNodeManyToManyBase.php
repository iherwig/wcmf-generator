...
class ChiNodeManyToManyBase extends ChiNode
{
    ...
    /**
     * @deprecated use getNodeManyToManySourceEndChildren() instead
     */
    function getNodeManyToManySourceEndList()
    {
    ...
    function getNodeManyToManySourceEndChildren()
    {
      return $this->getChildrenEx(null, 'ChiAssociation', array('fk_chinodemanytomanysource_id' => $this->getDBID()), null, false);
    }
    /**
     * @deprecated use getNodeManyToManyTargetEndChildren() instead
     */
    function getNodeManyToManyTargetEndList()
    {
    ...
    function getNodeManyToManyTargetEndChildren()
    {
