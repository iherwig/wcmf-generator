...
/**
 * @class NMChiNodeChiNodeRDBMapper
 * NMChiNodeChiNodeRDBMapper maps NMChiNodeChiNode Nodes to the database.
 * NMChiNodeChiNode description: this class handle all the relationships between ChiNodes.
 *
 * @author 
 * @version 1.0
 */
class NMChiNodeChiNodeRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  {
    return new NMChiNodeChiNode($oid);
  }
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'NMChiNodeChiNode' && $parentType == 'Package') return 'fk_package_id';
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('ChiNodeTarget', 'ChiNodeSource', 'Package')),
      array('name' => 'is_searchable', 'value' => true),
      array('name' => 'display_value', 'value' => 'Name'),
// PROTECTED REGION ID(application/include/model/domain/class.NMChiNodeChiNodeRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_nmchinodechinode_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
