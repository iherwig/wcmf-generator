...
class ChiIssueBase extends ChiBase
{
    ...
    function getValueDisplayName($name, $type=null)
    {
      ...
      if ($name == 'Dependency') $displayName = Message::get("Dependency");
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'Dependency') $description = Message::get("");
    ...
    function getDependency($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('Dependency', DATATYPE_IGNORE);
      else
        return $this->getValue('Dependency', DATATYPE_IGNORE);
    }
    function setDependency($Dependency)
    {
      return $this->setValue('Dependency', $Dependency, DATATYPE_IGNORE);
    }
    ...
    {
      $fkValue = $this->getValue('Dependency', DATATYPE_IGNORE);
      if ($fkValue != null)
    ...
    {
      if ($node != null)
        $this->setValue('Dependency', $node->getDBID(), DATATYPE_IGNORE);
    }
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_chiissue_id' => $this->getDBID()), null, false);
    }
