...
class ChiBusinessUseCaseRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessUseCase' && $parentType == 'ChiBusinessProcess') return 'Composition';
    if ($this->getType() == 'ChiBusinessUseCase' && $parentType == 'ChiFeature') return 'Realization';
    if ($this->getType() == 'ChiBusinessUseCase' && $parentType == 'Package') return 'fk_package_id';
    if ($parentType == 'ChiBusinessProcess') return 'Composition';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiBusinessProcess', 'is_navigable' => true, 'table_name' => 'ChiBusinessProcess', 'pk_columns' => array('id'), 'fk_columns' => 'Composition'),
    ...
    (
      array('type' => 'ActivitySet', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ActivitySet', 'pk_columns' => array('id'), 'fk_columns' => 'Aggregation', 'order_by' => array()),
      array('type' => 'NMUCActor', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMUCActor', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
      array('type' => 'ChiController', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiController', 'pk_columns' => array('id'), 'fk_columns' => 'Realization', 'order_by' => array('sortkey')),
