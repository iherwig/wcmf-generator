...
class RoleRDBBase extends Role
{
    ...
    function addChild(&$child, $addtype=ADDCHILD_BACK)
    {
      if ($child != null && $child->getType() == 'UserRDB')
      {
        ...
        $relOID = $persistenceFacade->getFirstOID('NMUserRole', array('fk_rolerdb_id' => $this->getDBID(), 'fk_userrdb_id' => $child->getDBID()));
        if ($relOID == null)
        {
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'UserRDB')
      {
        ...
        $associationNodeConstraint = array('NMUserRole', array('fk_rolerdb_id' => $this->getDBID(), 'fk_userrdb_id' => $ids[0]));
