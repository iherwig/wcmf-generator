...
require_once(BASE."application/include/model/requirements/class.ChiStatus.php");

/**
 * @class ChiStatusRDBMapper
 * ChiStatusRDBMapper maps ChiStatus Nodes to the database.
 * ChiStatus description: 
 *
 * @author 
 * @version 1.0
 */
class ChiStatusRDBMapper extends NodeUnifiedRDBMapper
{
  /**
...
// PROTECTED REGION ID(application/include/model/requirements/class.ChiStatusRDBMapper.php/Properties) ENABLED START
