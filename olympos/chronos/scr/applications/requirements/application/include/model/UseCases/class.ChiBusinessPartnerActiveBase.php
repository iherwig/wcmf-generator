<?php
/**
 * This file was generated by wCMFGenerator 3.0.0017 from requirements.uml on Wed Jul 01 16:44:11 CEST 2009. 
...
class ChiBusinessPartnerActiveBase extends ChiBusinessPartner
{
    ...
    function getValueDisplayName($name, $type=null)
    {
      ...
      if ($name == 'Generalization') $displayName = Message::get("Generalization");
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'Generalization') $description = Message::get("");
    ...
    function getGeneralization($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('Generalization', DATATYPE_IGNORE);
      else
        return $this->getValue('Generalization', DATATYPE_IGNORE);
    }
    function setGeneralization($Generalization)
    {
      return $this->setValue('Generalization', $Generalization, DATATYPE_IGNORE);
    }
    function getSortkey()
    {
    ...
    {
      $fkValue = $this->getValue('Generalization', DATATYPE_IGNORE);
      if ($fkValue != null)
    ...
    {
      if ($node != null)
        $this->setValue('Generalization', $node->getDBID(), DATATYPE_IGNORE);
    }
    ...
    {
      return $this->getChildrenEx(null, 'ChiBusinessPartnerActive', array('Generalization' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_chibusinesspartneractive_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'NMUCActor', array('fk_chibusinesspartneractive_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    function loadChildren($type, $buildDepth=BUILDDEPTH_SINGLE, $forceUpdate=false)
    {
      ...
      if ($type == 'ChiBusinessUseCase')
      {
        ...
        $children = parent::getChildrenEx(null, 'NMUCActor', array('fk_chibusinesspartneractive_id' => $this->getDBID()), null, false);
    ...
    function addChild(&$child, $addtype=ADDCHILD_BACK)
    {
      if ($child != null && $child->getType() == 'ChiBusinessUseCase')
      {
        ...
        $relOID = $persistenceFacade->getFirstOID('NMUCActor', array('fk_chibusinesspartneractive_id' => $this->getDBID(), 'Association' => $child->getDBID()));
        if ($relOID == null)
        {
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessUseCase')
      {
        ...
        $associationNodeConstraint = array('NMUCActor', array('fk_chibusinesspartneractive_id' => $this->getDBID(), 'Association' => $ids[0]));
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessUseCaseCore')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('NMUCActor', array('fk_chibusinesspartneractive_id' => $this->getDBID(), 'fk_chibusinessusecasecore_id' => $ids[0]));
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
