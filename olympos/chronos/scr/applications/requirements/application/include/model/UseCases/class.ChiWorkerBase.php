<?php
/**
 * This file was generated by wCMFGenerator 3.0.0017 from requirements.uml on Wed Jul 01 16:43:56 CEST 2009. 
...
class ChiWorkerBase extends Actor
{
    ...
    function addChild(&$child, $addtype=ADDCHILD_BACK)
    {
      if ($child != null && $child->getType() == 'ChiBusinessUseCase')
      {
        ...
        $relOID = $persistenceFacade->getFirstOID('NMUCActor', array('fk_chiworker_id' => $this->getDBID(), 'Association' => $child->getDBID()));
        if ($relOID == null)
        {
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessUseCase')
      {
        ...
        $associationNodeConstraint = array('NMUCActor', array('fk_chiworker_id' => $this->getDBID(), 'Association' => $ids[0]));
