...
require_once(BASE."application/include/model/class.Glossar.php");

/**
 * @class GlossarRDBMapper
 * GlossarRDBMapper maps Glossar Nodes to the database.
 * Glossar description: 
 *
 * @author 
 * @version 1.0
 */
class GlossarRDBMapper extends NodeUnifiedRDBMapper
{
  /**
...
// PROTECTED REGION ID(application/include/model/class.GlossarRDBMapper.php/Properties) ENABLED START
