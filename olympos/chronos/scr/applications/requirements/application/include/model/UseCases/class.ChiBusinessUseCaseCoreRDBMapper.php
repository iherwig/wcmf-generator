...
class ChiBusinessUseCaseCoreRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessUseCaseCore' && $parentType == 'ChiFeature') return 'Realization';
    if ($this->getType() == 'ChiBusinessUseCaseCore' && $parentType == 'ChiBusinessProcess') return 'Composition';
