...
require_once(BASE."application/include/model/domain/class.DisplayType.php");

/**
 * @class DisplayTypeRDBMapper
 * DisplayTypeRDBMapper maps DisplayType Nodes to the database.
 * DisplayType description: list all the allowed display types (e.g image, text, links)
 *
 * @author 
 * @version 1.0
 */
class DisplayTypeRDBMapper extends NodeUnifiedRDBMapper
{
  /**
...
// PROTECTED REGION ID(application/include/model/domain/class.DisplayTypeRDBMapper.php/Properties) ENABLED START
