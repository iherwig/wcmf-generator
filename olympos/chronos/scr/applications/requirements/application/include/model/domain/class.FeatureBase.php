...
/**
 * @class Feature
 * Feature description: this object reppresent a UML::class
 *
 * @author 
 * @version 1.0
 */
class FeatureBase extends ChiBase
{
    function FeatureBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::__construct($oid, 'Feature');
      else
    ...
    function getVisibility($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('visibility', DATATYPE_ATTRIBUTE);
      else
        return $this->getValue('visibility', DATATYPE_ATTRIBUTE);
    }
    function setVisibility($visibility)
    {
      return $this->setValue('visibility', $visibility, DATATYPE_ATTRIBUTE);
    }
    function getIsAbstract($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('isAbstract', DATATYPE_ATTRIBUTE);
      else
        return $this->getValue('isAbstract', DATATYPE_ATTRIBUTE);
    }
    function setIsAbstract($isAbstract)
    {
      return $this->setValue('isAbstract', $isAbstract, DATATYPE_ATTRIBUTE);
    }
    function getSortkey()
    {
      ...
      if ($name == 'getFigureList')
    {
      ...
      if ($name == 'getFigureChildren') {
        return $this->getChildrenEx(null, 'Figure', array('fk_feature_id' => $this->getDBID()), null, false);
    }
    }
