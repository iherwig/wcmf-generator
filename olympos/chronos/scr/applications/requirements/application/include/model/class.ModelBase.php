 ...
 * @version 1.0
 */
class ModelBase extends EntityBaseExtended
{
    function ModelBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::EntityBaseExtended($oid, 'Model');
      else
    ...
    {
      return $this->getChildrenEx(null, 'Package', array('fk_model_id' => $this->getDBID()), null, false);
    }
