...
req.figure.EntityBase = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "EntityBase", label, oid, parentoids, childoids);
}
...
req.figure.EntityBase.prototype.getStore = function(){
...
req.figure.EntityBase.prototype.showEdit = function(bd, oid){
