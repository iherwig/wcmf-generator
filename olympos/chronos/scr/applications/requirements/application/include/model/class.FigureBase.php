<?php
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Mon Mar 21 15:09:07 CET 2011. 
...
class FigureBase extends EntityBase
{
    ...
    function getValueDisplayName($name, $type=null)
    {
      ...
      if ($name == 'showInheritedAttributes') $displayName = Message::get("showInheritedAttributes");
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'showInheritedAttributes') $description = Message::get("defines if inherited attributes should be displayed for a ClassFigure");
    ...
    function getShowInheritedAttributes($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('showInheritedAttributes', DATATYPE_ATTRIBUTE);
      else
        return $this->getValue('showInheritedAttributes', DATATYPE_ATTRIBUTE);
    }
    function setShowInheritedAttributes($showInheritedAttributes)
    {
      return $this->setValue('showInheritedAttributes', $showInheritedAttributes, DATATYPE_ATTRIBUTE);
    }
