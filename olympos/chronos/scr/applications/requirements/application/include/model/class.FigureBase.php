...
class FigureBase extends EntityBase
{
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'BackgroundColor') $description = Message::get("");
      if ($name == 'ForegroundColor') $description = Message::get("");
      if ($name == 'GID') $description = Message::get("");
      if ($name == 'PositionY') $description = Message::get("");
      if ($name == 'PostionX') $description = Message::get("");
