...
class FigureBase extends EntityBase
{
    ...
    function getValueDisplayName($name, $type=null)
    {
      ...
      if ($name == 'fk_class_id') $displayName = Message::get("fk_class_id");
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'fk_class_id') $description = Message::get("");
    ...
    function getFkClassId($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('fk_class_id', DATATYPE_IGNORE);
      else
        return $this->getValue('fk_class_id', DATATYPE_IGNORE);
    }
    function setFkClassId($fk_class_id)
    {
      return $this->setValue('fk_class_id', $fk_class_id, DATATYPE_IGNORE);
    }
    ...
    function getClassOID()
    {
      $fkValue = $this->getValue('fk_class_id', DATATYPE_IGNORE);
      if ($fkValue != null)
        return PersistenceFacade::composeOID(array('type' => 'Class', 'id' => array($fkValue)));
      else
        return null;
    }
    ...
    {
      if ($node != null)
        $this->setValue('fk_class_id', $node->getDBID(), DATATYPE_IGNORE);
    }
    ...
    function getClassParents()
    {
      return $this->getParentsEx(null, 'Class', null, null);
    }
