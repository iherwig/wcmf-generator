...
class UserRDBBase extends User
{
    ...
    {
      return $this->getChildrenEx(null, 'Locktable', array('fk_userrdb_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'NMUserRole', array('fk_userrdb_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    function loadChildren($type, $buildDepth=BUILDDEPTH_SINGLE, $forceUpdate=false)
    {
      ...
      if ($type == 'RoleRDB')
      {
        ...
        $children = parent::getChildrenEx(null, 'NMUserRole', array('fk_userrdb_id' => $this->getDBID()), null, false);
    ...
    function addChild(&$child, $addtype=ADDCHILD_BACK)
    {
      if ($child != null && $child->getType() == 'RoleRDB')
      {
        ...
        $relOID = $persistenceFacade->getFirstOID('NMUserRole', array('fk_userrdb_id' => $this->getDBID(), 'fk_rolerdb_id' => $child->getDBID()));
        if ($relOID == null)
        {
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'RoleRDB')
      {
        ...
        $associationNodeConstraint = array('NMUserRole', array('fk_userrdb_id' => $this->getDBID(), 'fk_rolerdb_id' => $ids[0]));
        $associationNode = &$this->getFirstChild('NMUserRole', $associationNodeConstraint, null);
