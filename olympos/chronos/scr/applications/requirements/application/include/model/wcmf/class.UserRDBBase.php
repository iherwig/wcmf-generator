...
class UserRDBBase extends User
{
    ...
    {
      Message::log("use of deprecated method getRoleRDBList. use getRoleRDBChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
    ...
    {
      Message::log("use of deprecated method getLocktableList. use getLocktableChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
