...
class DiagramRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Diagram' && $parentType == 'ChiBusinessProcess') return 'fk_chibusinessprocess_id';
    if ($this->getType() == 'Diagram' && $parentType == 'Package') return 'fk_package_id';
    return '';
  }
  /**
...
// PROTECTED REGION ID(application/include/model/class.DiagramRDBMapper.php/Properties) START
// PROTECTED REGION END
    ...
    (
      array('type' => 'NMFiguresDiagram', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMFiguresDiagram', 'pk_columns' => array('id'), 'fk_columns' => 'fk_diagram_id', 'order_by' => array()),
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_diagram_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
