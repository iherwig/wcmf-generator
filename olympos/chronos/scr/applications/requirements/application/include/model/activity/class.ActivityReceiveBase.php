<?php
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Tue Jun 29 10:42:31 CEST 2010. 
...
class ActivityReceiveBase extends ChiBase
{
    ...
    {
      if ($type == null)
        parent::__construct($oid, 'ActivityReceive');
      else
      ...
      if ($name == 'setPackage')
    {
      ...
      // child: ARControlFlowSourceEnd
      if ($name == 'getARControlFlowSourceEndList')
    {
      ...
      if ($name == 'getARControlFlowSourceEndChildren') {
      ...
      if ($name == 'getActivityFinalChildren')
    {
      ...
      // child: ARControlFlowTargetEnd
      if ($name == 'getARControlFlowTargetEndList')
    {
      ...
      if ($name == 'getARControlFlowTargetEndChildren') {
