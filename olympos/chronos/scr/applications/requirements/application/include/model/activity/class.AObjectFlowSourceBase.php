 ...
 * @version 1.0
 */
class AObjectFlowSourceBase extends Activity
{
    function AObjectFlowSourceBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::__construct($oid, 'AObjectFlowSource');
      else
    ...
    {
      return Message::get("AObjectFlowSource");
    }
}
?>
