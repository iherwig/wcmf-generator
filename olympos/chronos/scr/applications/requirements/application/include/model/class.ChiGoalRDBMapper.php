...
require_once(BASE."application/include/model/class.ChiGoal.php");
...
// PROTECTED REGION ID(application/include/model/class.ChiGoalRDBMapper.php/Properties) START
// PROTECTED REGION END
    ...
    (
	  ...
	  * Value description: 
	  */
      array('name' => 'Author', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'author', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text'),
      /* 
	  * Value description: 
	  */
