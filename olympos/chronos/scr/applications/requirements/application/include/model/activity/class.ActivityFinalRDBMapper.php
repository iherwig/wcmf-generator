...
require_once(BASE."application/include/model/activity/class.ActivityFinal.php");

/**
 * @class ActivityFinalRDBMapper
 * ActivityFinalRDBMapper maps ActivityFinal Nodes to the database.
 * ActivityFinal description: An final t node is depicted by a cirlcled small black spot.
 *
 * @author 
 * @version 1.0
 */
class ActivityFinalRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivityFinal' && $parentType == 'ActivitySet') return 'Aggregation';
    if ($this->getType() == 'ActivityFinal' && $parentType == 'Activity') return 'Association';
    if ($this->getType() == 'ActivityFinal' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION ID(application/include/model/activity/class.ActivityFinalRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_activityfinal_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
