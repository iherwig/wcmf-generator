...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowSource', 'AControlFlowTarget', 'ADControlFlowTarget', 'ADControlFlowSource', 'ARControlFlowTarget', 'ARControlFlowSource', 'ASControlFlowTarget', 'ASControlFlowSource', 'ActivityInitial', 'ActivityFinal')),
