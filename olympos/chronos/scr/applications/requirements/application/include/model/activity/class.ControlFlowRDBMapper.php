...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowTarget', 'AControlFlowSource', 'ADControlFlowTarget', 'ADControlFlowSource', 'ARControlFlowTarget', 'ARControlFlowSource', 'ASControlFlowSource', 'ASControlFlowTarget', 'ActivityInitial', 'ActivityFinal')),
