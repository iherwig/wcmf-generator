...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ASControlFlowTarget' && $parentType == 'ActivitySend') return 'fk_ascontrolflowtarget_id';
    ...
    if ($parentType == 'ASControlFlowTargetEnd') return 'fk_ascontrolflowtarget_id';
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowTarget', 'AControlFlowSource', 'ADControlFlowSource', 'ADControlFlowTarget', 'ARControlFlowSource', 'ARControlFlowTarget', 'ASControlFlowSource', 'ASControlFlowTargetEnd', 'ActivityInitial', 'ActivityFinal')),
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'ASControlFlowTargetEnd', 'is_navigable' => true, 'table_name' => 'ActivitySend', 'pk_columns' => array('id'), 'fk_columns' => 'fk_ascontrolflowtarget_id'),
