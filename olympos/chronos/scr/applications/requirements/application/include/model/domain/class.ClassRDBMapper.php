...
/**
 * @class ClassRDBMapper
 * ClassRDBMapper maps Class Nodes to the database.
 * Class description: this object reppresent a UML::class
 *
 * @author 
 * @version 1.0
 */
class ClassRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Class' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION ID(application/include/model/domain/class.ClassRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_class_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
