...
class LocktableRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Locktable' && $parentType == 'UserRDB') return 'fk_userrdb_id';
...
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'sessionid', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'sessionid', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
      array('name' => 'since', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'since', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text')
    );
    $nodeDef['_ref'] = array
    (
    );
