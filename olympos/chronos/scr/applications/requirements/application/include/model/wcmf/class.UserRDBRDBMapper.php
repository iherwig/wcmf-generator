...
// PROTECTED REGION END
    ...
    (
	  ...
	  * Value description: 
	  */
      array('name' => 'firstname', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'firstname', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text'),
      /* 
	  * Value description: 
	  */
      array('name' => 'config', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'config', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text')
    );
    $nodeDef['_ref'] = array
    (
    );
    ...
    (
      ...
      array('type' => 'NMUserRole', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMUserRole', 'pk_columns' => array('fk_user_id', 'fk_role_id'), 'fk_columns' => 'fk_user_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
