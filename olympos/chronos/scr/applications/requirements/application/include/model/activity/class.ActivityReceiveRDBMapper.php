...
class ActivityReceiveRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivityReceive' && $parentType == 'ActivitySend') return 'fk_activitysend_id';
...
/* 
    ...
    (
      array('type' => 'Activity', 'minOccurs' => 1, 'maxOccurs' => 1, 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Activity', 'pk_columns' => array('id'), 'fk_columns' => 'fk_activityreceive_id', 'order_by' => array()),
