...
class ChiViewRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiView' && $parentType == 'ChiNode') return 'fk_chinode_id';
    if ($this->getType() == 'ChiView' && $parentType == 'Package') return 'fk_package_id';
    if ($this->getType() == 'ChiView' && $parentType == 'ChiNodeManyToMany') return 'fk_chinodemanytomany_id';
...
// PROTECTED REGION ID(application/include/model/domain/class.ChiViewRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'NMChiControllerActionKeyChiView', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMChiControllerActionKeyChiView', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chiview_id', 'order_by' => array()),
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chiview_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
