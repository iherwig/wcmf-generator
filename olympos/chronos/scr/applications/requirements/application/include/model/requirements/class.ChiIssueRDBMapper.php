...
class ChiIssueRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiIssue' && $parentType == 'ChiRequirement') return 'Dependency';
    if ($this->getType() == 'ChiIssue' && $parentType == 'Package') return 'fk_package_id';
    if ($parentType == 'ChiRequirement') return 'Dependency';
...
// PROTECTED REGION ID(application/include/model/requirements/class.ChiIssueRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'Dependency', 'app_data_type' => DATATYPE_IGNORE, 'column_name' => 'Dependency', 'db_data_type' => 'INT(11)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
    ...
    (
      array('type' => 'ChiRequirement', 'is_navigable' => true, 'table_name' => 'ChiRequirement', 'pk_columns' => array('id'), 'fk_columns' => 'Dependency'),
      array('type' => 'Package', 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'fk_package_id')
    );
    $nodeDef['_children'] = array
    (
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chiissue_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
