 ...
 * @version 1.0
 */
class RelationTypeBase extends EntityBaseExtended
{
    function RelationTypeBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::EntityBaseExtended($oid, 'RelationType');
      else
    ...
    {
      return Message::get("RelationType");
    }
    /**
    ...
    {
      return Message::get("this class host all the relations type hosted by relation. Like Generalizzation, realization, aggregation, composition, etc.");
    }
    /**
