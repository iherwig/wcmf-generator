...
require_once(BASE."application/include/model/class.Language.php");
...
class LanguageRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      ...
      array('name' => 'display_value', 'value' => 'Name|code'),
// PROTECTED REGION ID(application/include/model/class.LanguageRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'code', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'code', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
