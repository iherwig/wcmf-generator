...
class ActivitySendRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivitySend' && $parentType == 'ProductionRuleSet') return 'fk_productionruleset_id';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ASControlFlowSourceEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_ascontrolflowsource_id', 'order_by' => array()),
      array('type' => 'ASControlFlowTargetEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_ascontrolflowtarget_id', 'order_by' => array()),
