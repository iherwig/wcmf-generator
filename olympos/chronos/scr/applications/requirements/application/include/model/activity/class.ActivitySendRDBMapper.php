...
class ActivitySendRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivitySend' && $parentType == 'ActivitySet') return 'Aggregation';
    if ($this->getType() == 'ActivitySend' && $parentType == 'Activity') return 'Association';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ActivityReceive', 'minOccurs' => 0, 'maxOccurs' => 1, 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ActivityReceive', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
