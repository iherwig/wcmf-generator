...
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Mon Apr 26 17:26:57 CEST 2010. 
...
class ChiBusinessPartnerPassiveRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessPartnerPassive' && $parentType == 'ChiBusinessPartnerPassive') return 'fk_chibusinesspartnerpassive_id';
    if ($this->getType() == 'ChiBusinessPartnerPassive' && $parentType == 'Package') return 'fk_package_id';
    if ($this->getType() == 'ChiBusinessPartnerPassive' && $parentType == 'ChiBusinessPartner') return 'fk_chibusinesspartner_id';
    if ($this->getType() == 'ChiBusinessPartnerPassive' && $parentType == 'ChiBusinessPartnerActive') return 'fk_chibusinesspartneractive_id';
...
// PROTECTED REGION ID(application/include/model/UseCases/class.ChiBusinessPartnerPassiveRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiBusinessPartnerPassive', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessPartnerPassive', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartnerpassive_id', 'order_by' => array('sortkey')),
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartnerpassive_id', 'order_by' => array()),
      array('type' => 'ChiBusinessPartner', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessPartner', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartnerpassive_id', 'order_by' => array('sortkey')),
      array('type' => 'ChiBusinessPartnerActive', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessPartnerActive', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartnerpassive_id', 'order_by' => array('sortkey')),
      array('type' => 'NMUCActor', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMUCActor', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartnerpassive_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
