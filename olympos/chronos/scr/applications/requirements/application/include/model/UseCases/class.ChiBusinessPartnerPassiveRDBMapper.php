...
class ChiBusinessPartnerPassiveRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessPartnerPassive' && $parentType == 'Figure') return 'fk_figure_id';
    return '';
  }
  /**
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'NMUCActor', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMUCActor', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartnerpassive_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
