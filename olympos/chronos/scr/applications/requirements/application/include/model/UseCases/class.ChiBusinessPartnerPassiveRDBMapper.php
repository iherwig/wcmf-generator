<?php
/**
 * This file was generated by wCMFGenerator 3.0.0017 from requirements.uml on Wed Jul 01 16:44:17 CEST 2009. 
...
class ChiBusinessPartnerPassiveRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessPartnerPassive' && $parentType == 'ChiBusinessPartnerPassive') return 'Generalization';
    if ($this->getType() == 'ChiBusinessPartnerPassive' && $parentType == 'Package') return 'fk_package_id';
    if ($parentType == 'ChiBusinessPartnerPassive') return 'Generalization';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiBusinessPartnerPassive', 'is_navigable' => true, 'table_name' => 'ChiBusinessPartnerPassive', 'pk_columns' => array('id'), 'fk_columns' => 'Generalization'),
      array('type' => 'Package', 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'fk_package_id')
    );
    $nodeDef['_children'] = array
    (
      array('type' => 'ChiBusinessPartnerPassive', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessPartnerPassive', 'pk_columns' => array('id'), 'fk_columns' => 'Generalization', 'order_by' => array('sortkey')),
