...
class ChiControllerRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiController' && $parentType == 'ChiBusinessProcess') return 'fk_chibusinessprocess_id';
    return '';
  }
  /**
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chicontroller_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
