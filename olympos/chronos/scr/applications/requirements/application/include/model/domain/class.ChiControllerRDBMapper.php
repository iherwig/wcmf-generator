...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'ChiNode', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiNode', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chicontroller_id', 'order_by' => array('sortkey')),
      ...
      array('type' => 'ChiNodeManyToMany', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiNodeManyToMany', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chicontroller_id', 'order_by' => array('sortkey'))
    );
    return $nodeDef;
  }
}
