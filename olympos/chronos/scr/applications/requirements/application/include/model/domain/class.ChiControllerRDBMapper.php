...
class ChiControllerRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiController' && $parentType == 'ChiBusinessUseCase') return 'Realization';
    ...
    if ($parentType == 'ChiBusinessUseCase') return 'Realization';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiBusinessUseCase', 'is_navigable' => true, 'table_name' => 'ChiBusinessUseCase', 'pk_columns' => array('id'), 'fk_columns' => 'Realization'),
    ...
    (
      array('type' => 'Property', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Property', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chicontroller_id', 'order_by' => array()),
      array('type' => 'ChiNode', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiNode', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
      ...
      array('type' => 'Operation', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Operation', 'pk_columns' => array('id'), 'fk_columns' => 'Contains', 'order_by' => array()),
      ...
      array('type' => 'ChiValue', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiValue', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chicontroller_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
