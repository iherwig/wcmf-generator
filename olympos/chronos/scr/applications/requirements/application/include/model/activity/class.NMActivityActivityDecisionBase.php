 ...
 * @version 1.0
 */
class NMActivityActivityDecisionBase extends ChiBase
{
    function NMActivityActivityDecisionBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::ChiBase($oid, 'NMActivityActivityDecision');
      else
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_nmactivityactivitydecision_id' => $this->getDBID()), null);
    }
