...
class PackageBase extends EntityBaseExtended
{
    ...
    /**
     * @deprecated use getRuleSetVariableChildren() instead
     */
    function getRuleSetVariableList()
    {
    ...
    function getRuleSetVariableChildren()
    {
    ...
    /**
     * @deprecated use getProductionRuleSetChildren() instead
     */
    function getProductionRuleSetList()
    {
    ...
    function getProductionRuleSetChildren()
    {
