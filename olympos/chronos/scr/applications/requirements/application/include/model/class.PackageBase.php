...
class PackageBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'ChiValue', array('fk_package_id' => $this->getDBID()), null);
    }
    /**
    ...
    /**
     * @deprecated use getModelChildren() instead
     */
    function getModelList()
    {
      Message::log("use of deprecated method getModelList. use getModelChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
      return $this->getModelChildren();
    }
    function getModelChildren()
    {
      return $this->getChildrenEx(null, 'Model', array('fk_package_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_package_id' => $this->getDBID()), null);
    }
