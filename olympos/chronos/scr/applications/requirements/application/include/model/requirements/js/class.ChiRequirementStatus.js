...
req.figure.ChiRequirementStatus = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiRequirementStatus", label, oid, parentoids, childoids);
}
...
req.figure.ChiRequirementStatus.prototype.getStore = function(){
...
req.figure.ChiRequirementStatus.prototype.showEdit = function(bd, oid){
