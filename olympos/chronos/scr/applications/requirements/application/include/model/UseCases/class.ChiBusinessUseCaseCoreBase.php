...
class ChiBusinessUseCaseCoreBase extends ChiBusinessUseCase
{
    ...
    {
      Message::log("use of deprecated method getActivitySetList. use getActivitySetChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
    ...
    function addChild(&$child, $addtype=ADDCHILD_BACK)
    {
      ...
      if ($child != null && $child->getType() == 'ChiBusinessUseCase')
      {
        ...
        $persistenceFacade = &PersistenceFacade::getInstance();
        // check if the relation already exists
        $relOID = $persistenceFacade->getFirstOID('NMUCActor', array('fk_chibusinessusecasecore_id' => $this->getDBID(), 'fk_chibusinessusecase_id' => $child->getDBID()));
        if ($relOID == null)
        {
          // add the child only if it is not added already
          $associationNode = &$persistenceFacade->create('NMUCActor', BUILDTYPE_SINGLE);
