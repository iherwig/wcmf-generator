...
class ChiBusinessUseCaseCoreBase extends ChiBusinessUseCase
{
	...
	{
		if ($type == null)
			parent::ChiBusinessUseCase($oid, 'ChiBusinessUseCaseCore');
		else
...
if ($name == 'fk_chibusinessprocess_id')
	$displayName = Message::get("fk_chibusinessprocess_id");
if ($name == 'fk_chifeature_id')
	$displayName = Message::get("fk_chifeature_id");
if ($name == 'fk_package_id')
	$displayName = Message::get("fk_package_id");
if ($name == 'PrimaryActor')
	$displayName = Message::get("PrimaryActor");
if ($name == 'OtherActors')
	$displayName = Message::get("OtherActors");
if ($name == 'GoalInContext')
	$displayName = Message::get("GoalInContext");
if ($name == 'Scope')
	$displayName = Message::get("Scope");
if ($name == 'Level')
	$displayName = Message::get("Level");
if ($name == 'Stakeholders')
	$displayName = Message::get("Stakeholders");
if ($name == 'Precondition')
	$displayName = Message::get("Precondition");
if ($name == 'Trigger')
	$displayName = Message::get("Trigger");
if ($name == 'MainSuccessScenario')
	$displayName = Message::get("MainSuccessScenario");
if ($name == 'Extensions')
	$displayName = Message::get("Extensions");
if ($name == 'Alias')
...
if ($name == 'fk_package_id')
	$description = Message::get("");
if ($name == 'PrimaryActor')
	$description = Message::get("the main actor of this use case");
if ($name == 'OtherActors')
	$description = Message::get("The list of actors associated with the use case. Although this information is contained in the use case itself, it helps to increase the understandability of the use case when the diagram is unavailable.");
if ($name == 'GoalInContext')
	$description = Message::get("The goal should implicitly express the actor's intent or purpose of the use case, such as *Enrol Student in Seminar.*");
if ($name == 'Scope')
	$description = Message::get("Boundaries in which the use case is operated when invoked (E.g. CMS)");
if ($name == 'Level')
	$description = Message::get("Authorizations for operations/actions to be performed against the Chi business objects in scope. Against every object/process 4 CRUD basic operations are possible: Create (Write) Read (Open) Update (Change) Delete  (Destroy)");
if ($name == 'Stakeholders')
	$description = Message::get("List of actors that have a special interest (i.e. to be informed every time) in completion of the use case");
if ($name == 'Precondition')
	$description = Message::get("A list of the conditions, if any, that must be met before a use case may be invoked. Can be a previous Use case or self the presence of the system in Scope.");
if ($name == 'Trigger')
	$description = Message::get("Event that is responsible for invocation of the use case.");
if ($name == 'MainSuccessScenario')
	$description = Message::get("The main path of logic an actor follows through a use case. Often referred to as the *happy path* or the *main path* because it describes how the use case works when everything works as it normally should.");
if ($name == 'Extensions')
	$description = Message::get("");
if ($name == 'Alias')
...
{
	return $this->getChildrenEx(null, 'Figure', array ('fk_chibusinessusecasecore_id'=>$this->getDBID()), null);
}
...
{
	return $this->getChildrenEx(null, 'ChiController', array ('fk_chibusinessusecasecore_id'=>$this->getDBID()), null);
}
...
{
	return $this->getChildrenEx(null, 'ActivitySet', array ('fk_chibusinessusecasecore_id'=>$this->getDBID()), null);
}
...
{
	return $this->getChildrenEx(null, 'NMUCActor', array ('fk_chibusinessusecasecore_id'=>$this->getDBID()), null);
}
...
function loadChildren($type, $buildDepth = BUILDDEPTH_SINGLE, $forceUpdate = false)
{
	...
	$children = parent::getChildrenEx(null, 'NMUCActor', array ('fk_chibusinessusecasecore_id'=>$this->getDBID()), null);
