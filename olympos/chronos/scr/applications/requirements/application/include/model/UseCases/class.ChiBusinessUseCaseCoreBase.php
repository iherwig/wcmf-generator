<?php
/**
 * This file was generated by wCMFGenerator 3.0.0017 from requirements.uml on Thu Jul 02 09:52:19 CEST 2009. 
...
class ChiBusinessUseCaseCoreBase extends ChiBusinessUseCase
{
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'Actor')
      {
        ...
        $associationNodeConstraint = array('NMUCActor', array('fk_chibusinessusecasecore_id' => $this->getDBID(), 'fk_actor_id' => $ids[0]));
