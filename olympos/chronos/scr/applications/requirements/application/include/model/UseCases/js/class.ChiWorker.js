...
req.figure.ChiWorker = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiWorker", label, oid, parentoids, childoids);
}
...
req.figure.ChiWorker.prototype.getStore = function(){
...
req.figure.ChiWorker.prototype.showEdit = function(bd, oid){
