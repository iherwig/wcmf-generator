...
require_once(BASE."application/include/model/requirements/class.ChiRequirementType.php");

/**
 * @class ChiRequirementTypeRDBMapper
 * ChiRequirementTypeRDBMapper maps ChiRequirementType Nodes to the database.
 * ChiRequirementType description: Type of requirement
 *
 * @author 
 * @version 1.0
 */
class ChiRequirementTypeRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  {
    return new ChiRequirementType($oid);
  }
  /**
...
// PROTECTED REGION ID(application/include/model/requirements/class.ChiRequirementTypeRDBMapper.php/Properties) ENABLED START
