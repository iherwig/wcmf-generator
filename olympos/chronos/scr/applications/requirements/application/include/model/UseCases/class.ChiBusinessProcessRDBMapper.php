...
class ChiBusinessProcessRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessProcess' && $parentType == 'Model') return 'fk_model_id';
...
// PROTECTED REGION ID(application/include/model/UseCases/class.ChiBusinessProcessRDBMapper.php/Properties) START
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiBusinessUseCase', 'minOccurs' => 1, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessUseCase', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      array('type' => 'ChiBusinessUseCaseCore', 'minOccurs' => 1, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessUseCaseCore', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      array('type' => 'Actor', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'Actor', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      array('type' => 'ChiGoal', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiGoal', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      array('type' => 'Package', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      array('type' => 'ChiIssue', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiIssue', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      array('type' => 'ChiFeature', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiFeature', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      array('type' => 'ChiRequirement', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiRequirement', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array('priority')),
      array('type' => 'Diagram', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'Diagram', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
