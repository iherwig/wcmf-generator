...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiBusinessUseCase', 'minOccurs' => 1, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessUseCase', 'pk_columns' => array('id'), 'fk_columns' => 'Composition', 'order_by' => array('sortkey')),
      ...
      array('type' => 'ChiBusinessUseCaseCore', 'minOccurs' => 1, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessUseCaseCore', 'pk_columns' => array('id'), 'fk_columns' => 'Composition', 'order_by' => array('sortkey'))
    );
    return $nodeDef;
  }
}
