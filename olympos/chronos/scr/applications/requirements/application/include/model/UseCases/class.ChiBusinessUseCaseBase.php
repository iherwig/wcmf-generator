...
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Thu Nov 26 12:43:53 CET 2009. 
...
class ChiBusinessUseCaseBase extends ChiBase
{
    ...
    {
      if ($type == null)
        parent::__construct($oid, 'ChiBusinessUseCase');
      else
    ...
    {
      return $this->getChildrenEx(null, 'ActivitySet', array('fk_chibusinessusecase_id' => $this->getDBID()), null, false);
    }
    /**
     * @deprecated use getChiUseCaseTargetEndChildren() instead
     */
    function getChiUseCaseTargetEndList()
    {
      Log::warn("use of deprecated method getChiUseCaseTargetEndList. use getChiUseCaseTargetEndChildren() instead.\n".WCMFException::getStackTrace(), __CLASS__);
      return $this->getChiUseCaseTargetEndChildren();
    }
    function getChiUseCaseTargetEndChildren()
    {
      return $this->getChildrenEx(null, 'NMChiUseCaseChiUseCase', array('fk_chiusecasetarget_id' => $this->getDBID()), null, false);
    }
    /**
     * @deprecated use getChiUseCaseSourceEndChildren() instead
     */
    function getChiUseCaseSourceEndList()
    {
      Log::warn("use of deprecated method getChiUseCaseSourceEndList. use getChiUseCaseSourceEndChildren() instead.\n".WCMFException::getStackTrace(), __CLASS__);
      return $this->getChiUseCaseSourceEndChildren();
    }
    function getChiUseCaseSourceEndChildren()
    {
      return $this->getChildrenEx(null, 'NMChiUseCaseChiUseCase', array('fk_chiusecasesource_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'NMUCActor', array('fk_chibusinessusecase_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiController', array('fk_chibusinessusecase_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    function loadChildren($type, $buildDepth=BUILDDEPTH_SINGLE, $forceUpdate=false)
    {
      ...
      if ($type == 'Actor')
      {
        ...
        $children = parent::getChildrenEx(null, 'NMUCActor', array('fk_chibusinessusecase_id' => $this->getDBID()), null, false);
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'Actor')
      {
        ...
        $associationNodeConstraint = array('fk_chibusinessusecase_id' => $this->getDBID(), 'fk_actor_id' => $ids[0]);
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessPartner')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('fk_chibusinessusecase_id' => $this->getDBID(), 'fk_chibusinesspartner_id' => $ids[0]);
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null, false);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessPartnerPassive')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('fk_chibusinessusecase_id' => $this->getDBID(), 'fk_chibusinesspartnerpassive_id' => $ids[0]);
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null, false);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessPartnerActive')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('fk_chibusinessusecase_id' => $this->getDBID(), 'fk_chibusinesspartneractive_id' => $ids[0]);
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null, false);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiWorker')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('fk_chibusinessusecase_id' => $this->getDBID(), 'fk_chiworker_id' => $ids[0]);
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null, false);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiWorkerInternal')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('fk_chibusinessusecase_id' => $this->getDBID(), 'fk_chiworkerinternal_id' => $ids[0]);
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null, false);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiWorkerExternal')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('fk_chibusinessusecase_id' => $this->getDBID(), 'fk_chiworkerexternal_id' => $ids[0]);
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null, false);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
