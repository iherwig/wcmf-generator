...
{
	return $this->getChildrenEx(null, 'ActivitySet', array ('fk_chibusinessusecase_id'=>$this->getDBID()), null);
}
...
{
	return $this->getChildrenEx(null, 'ChiController', array ('fk_chibusinessusecase_id'=>$this->getDBID()), null);
}
