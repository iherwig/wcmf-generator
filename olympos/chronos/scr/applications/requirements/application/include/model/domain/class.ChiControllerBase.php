 ...
 * @version 1.0
 */
class ChiControllerBase extends Class
{
    function ChiControllerBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::Class($oid, 'ChiController');
      else
    ...
    {
      return $this->getChildrenEx(null, 'ChiNode', array('Association' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Operation', array('Contains' => $this->getDBID()), null, false);
    }
    /**
