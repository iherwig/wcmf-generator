...
class ChiControllerBase extends ChiClass
{
    ...
    {
      if ($type == null)
        parent::ChiClass($oid, 'ChiController');
      else
    ...
    {
      return $this->getChildrenEx(null, 'NMChiControllerActionKeyChiController', array('fk_chicontroller_id' => $this->getDBID()), null, false);
    }
    /**
