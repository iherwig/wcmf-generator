...
class ChiControllerBase extends ChiBase
{
    ...
    {
      Message::log("use of deprecated method getTargetEndList. use getTargetEndChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
    ...
    {
      Message::log("use of deprecated method getSourceEndList. use getSourceEndChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
