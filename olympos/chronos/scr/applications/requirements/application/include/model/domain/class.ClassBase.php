 ...
 * @version 1.0
 */
class ClassBase extends ChiBase
{
    function ClassBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::ChiBase($oid, 'Class');
      else
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_class_id' => $this->getDBID()), null, false);
    }
