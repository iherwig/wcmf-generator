 ...
 *
 * [actionmapping]
 * ChronosGeneratorController??done = TerminateController
 * ??generateWcmf = ChronosGeneratorController
 * ChronosGeneratorController??continue = ChronosGeneratorController
 *
 * [views]
 * 
 * @author 
 * @version 1.0
 */
class ChronosGeneratorController extends BatchController
{
// PROTECTED REGION ID(application/include/controller/class.ChronosGeneratorController.php/Body) ENABLED START
	// session name constants
	private $PARAM_START_MODEL = 'ChronosGeneratorController.startModel';

	private $TEMP_UWM_EXPORT_PATH = 'ChronosGeneratorController.tmpUwmExportPath';
	private $TEMP_PROPERTIES_PATH = 'ChronosGeneratorController.tmpPropertiesPath';
	...
	function runOAW($oids)
	{
		...
		$runCfg = OawUtil::runOaw($tmpPropertiesPath, 'cartridge/ChiCmf/workflow/ChronosGenerator.oaw');
