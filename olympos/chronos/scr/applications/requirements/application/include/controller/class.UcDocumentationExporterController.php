...
/**
 * @class UcDocumentationExporterController
 * @ingroup Controller
 ...
 */
class UcDocumentationExporterController extends BatchController
{
	const PROBLEM_REPORT = 'UcDocumentationExporterController.problemReport';
	const TEMP_WORKING_DIR = 'UcDocumentationExporterController.workingDiw';
	...
	function runOAW($oids)
	{
		...
		// select the template
		$templateName = 'useCaseDocumentation';
