...
class UWMImporterController extends Controller
{
	...
	private static $roleTargetToSourceMapper = array('ChiNodeTarget' => 'ChiNodeSource', 'ChiNodeManyToMany' => 'NMChiNodeChiMany2ManyChiNodeEnd');
		...
		if ($childObj) {
			...
			if ($parentObj) {
				...
				foreach ($valueNames as $currValueName)	{
					...
					if ($attrValue) {
						$link->setValue($currValueName, $attrValue);
					}
				}
