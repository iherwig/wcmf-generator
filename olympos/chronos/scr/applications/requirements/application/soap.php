<?php
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Mon Mar 21 15:07:28 CET 2011. 
...
$server->wsdl->addComplexType('ActivitySet', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'umi' => array('name' => 'umi', 'type' => 'xsd:string'),
        ...
        'ProductionRuleSet' => array('name' => 'ProductionRuleSet', 'type' => 'tns:ProductionRuleSetList'),
...
$server->wsdl->addComplexType('ChiObject', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'fk_productionruleset_id' => array('name' => 'fk_productionruleset_id', 'type' => 'xsd:string'),
...
/**
 * WSDL definition for ProductionRule
 */
$server->wsdl->addComplexType('ProductionRule', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
        'fk_package_id' => array('name' => 'fk_package_id', 'type' => 'xsd:string'),
        'fk_productionruleset_id' => array('name' => 'fk_productionruleset_id', 'type' => 'xsd:string'),
        ...
        'modified' => array('name' => 'modified', 'type' => 'xsd:string'),
        'umi' => array('name' => 'umi', 'type' => 'xsd:string'),
        'RuleAction' => array('name' => 'RuleAction', 'type' => 'tns:RuleActionList'),
        'RuleCondition' => array('name' => 'RuleCondition', 'type' => 'tns:RuleConditionList'),
        'RuleVariable' => array('name' => 'RuleVariable', 'type' => 'tns:RuleVariableList'),
        'Figure' => array('name' => 'Figure', 'type' => 'tns:FigureList'),
        'parentoids' => array('name' => 'parentoids', 'type' => 'tns:OidList'),
        'childoids' => array('name' => 'childoids', 'type' => 'tns:OidList')
    )
);
$server->wsdl->addComplexType('ProductionRuleList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:ProductionRule[]')
    ),
    'tns:ProductionRule'
);
$server->register('getProductionRuleList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:ProductionRuleList'), $NAMESPACE);
  
$server->register('createProductionRule',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'ProductionRule'=>'tns:ProductionRule', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readProductionRule',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:ProductionRule'), $NAMESPACE);
  
$server->register('updateProductionRule',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'ProductionRule'=>'tns:ProductionRule', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteProductionRule',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);

/**
 * WSDL definition for ProductionRuleSet
 */
$server->wsdl->addComplexType('ProductionRuleSet', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
        'fk_package_id' => array('name' => 'fk_package_id', 'type' => 'xsd:string'),
        'fk_activityset_id' => array('name' => 'fk_activityset_id', 'type' => 'xsd:string'),
        ...
        'ActivityInitial' => array('name' => 'ActivityInitial', 'type' => 'tns:ActivityInitialList'),
        'ActivityFinal' => array('name' => 'ActivityFinal', 'type' => 'tns:ActivityFinalList'),
        'ProductionRule' => array('name' => 'ProductionRule', 'type' => 'tns:ProductionRuleList'),
        'RuleSetVariable' => array('name' => 'RuleSetVariable', 'type' => 'tns:RuleSetVariableList'),
        'Figure' => array('name' => 'Figure', 'type' => 'tns:FigureList'),
        'parentoids' => array('name' => 'parentoids', 'type' => 'tns:OidList'),
        'childoids' => array('name' => 'childoids', 'type' => 'tns:OidList')
    )
);
$server->wsdl->addComplexType('ProductionRuleSetList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:ProductionRuleSet[]')
    ),
    'tns:ProductionRuleSet'
);
$server->register('getProductionRuleSetList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:ProductionRuleSetList'), $NAMESPACE);
  
$server->register('createProductionRuleSet',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'ProductionRuleSet'=>'tns:ProductionRuleSet', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readProductionRuleSet',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:ProductionRuleSet'), $NAMESPACE);
  
$server->register('updateProductionRuleSet',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'ProductionRuleSet'=>'tns:ProductionRuleSet', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteProductionRuleSet',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);

/**
 * WSDL definition for RuleAction
 */
$server->wsdl->addComplexType('RuleAction', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
        'fk_package_id' => array('name' => 'fk_package_id', 'type' => 'xsd:string'),
        'fk_productionrule_id' => array('name' => 'fk_productionrule_id', 'type' => 'xsd:string'),
        'Status' => array('name' => 'Status', 'type' => 'xsd:string'),
        'Alias' => array('name' => 'Alias', 'type' => 'xsd:string'),
        'Author' => array('name' => 'Author', 'type' => 'xsd:string'),
        'Version' => array('name' => 'Version', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('RuleActionList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:RuleAction[]')
    ),
    'tns:RuleAction'
);
$server->register('getRuleActionList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:RuleActionList'), $NAMESPACE);
  
$server->register('createRuleAction',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleAction'=>'tns:RuleAction', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readRuleAction',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:RuleAction'), $NAMESPACE);
  
$server->register('updateRuleAction',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleAction'=>'tns:RuleAction', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteRuleAction',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);

/**
 * WSDL definition for RuleCondition
 */
$server->wsdl->addComplexType('RuleCondition', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
        'fk_package_id' => array('name' => 'fk_package_id', 'type' => 'xsd:string'),
        'fk_productionrule_id' => array('name' => 'fk_productionrule_id', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('RuleConditionList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:RuleCondition[]')
    ),
    'tns:RuleCondition'
);
$server->register('getRuleConditionList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:RuleConditionList'), $NAMESPACE);
  
$server->register('createRuleCondition',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleCondition'=>'tns:RuleCondition', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readRuleCondition',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:RuleCondition'), $NAMESPACE);
  
$server->register('updateRuleCondition',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleCondition'=>'tns:RuleCondition', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteRuleCondition',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);

/**
 * WSDL definition for RuleSetVariable
 */
$server->wsdl->addComplexType('RuleSetVariable', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
        'fk_package_id' => array('name' => 'fk_package_id', 'type' => 'xsd:string'),
        'fk_productionruleset_id' => array('name' => 'fk_productionruleset_id', 'type' => 'xsd:string'),
        'context' => array('name' => 'context', 'type' => 'xsd:string'),
        'ruleValue' => array('name' => 'ruleValue', 'type' => 'xsd:string'),
        'variableType' => array('name' => 'variableType', 'type' => 'xsd:string'),
        'isEditable' => array('name' => 'isEditable', 'type' => 'xsd:string'),
        'Status' => array('name' => 'Status', 'type' => 'xsd:string'),
        'Alias' => array('name' => 'Alias', 'type' => 'xsd:string'),
        'Author' => array('name' => 'Author', 'type' => 'xsd:string'),
        'Version' => array('name' => 'Version', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('RuleSetVariableList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:RuleSetVariable[]')
    ),
    'tns:RuleSetVariable'
);
$server->register('getRuleSetVariableList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:RuleSetVariableList'), $NAMESPACE);
  
$server->register('createRuleSetVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleSetVariable'=>'tns:RuleSetVariable', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readRuleSetVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:RuleSetVariable'), $NAMESPACE);
  
$server->register('updateRuleSetVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleSetVariable'=>'tns:RuleSetVariable', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteRuleSetVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);

/**
 * WSDL definition for RuleVariable
 */
$server->wsdl->addComplexType('RuleVariable', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
        'fk_package_id' => array('name' => 'fk_package_id', 'type' => 'xsd:string'),
        'fk_productionrule_id' => array('name' => 'fk_productionrule_id', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('RuleVariableList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:RuleVariable[]')
    ),
    'tns:RuleVariable'
);
$server->register('getRuleVariableList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:RuleVariableList'), $NAMESPACE);
  
$server->register('createRuleVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleVariable'=>'tns:RuleVariable', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readRuleVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:RuleVariable'), $NAMESPACE);
  
$server->register('updateRuleVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'RuleVariable'=>'tns:RuleVariable', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteRuleVariable',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
...
$server->register('getUserConfigList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:UserConfigList'), $NAMESPACE);
  
$server->register('createUserConfig',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'UserConfig'=>'tns:UserConfig', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readUserConfig',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:UserConfig'), $NAMESPACE);
  
$server->register('updateUserConfig',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'UserConfig'=>'tns:UserConfig', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteUserConfig',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
...
$server->wsdl->addComplexType('NMChiUseCaseChiUseCase', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'targetName' => array('name' => 'targetName', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('ChiValueRef', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'fk_chinode_id' => array('name' => 'fk_chinode_id', 'type' => 'xsd:string'),
        'reference_type' => array('name' => 'reference_type', 'type' => 'xsd:string'),
        'reference_value' => array('name' => 'reference_value', 'type' => 'xsd:string'),
        'Name' => array('name' => 'Name', 'type' => 'xsd:string'),
        'Notes' => array('name' => 'Notes', 'type' => 'xsd:string'),
        'created' => array('name' => 'created', 'type' => 'xsd:string'),
        'creator' => array('name' => 'creator', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('Counter', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'ProductionRuleSet' => array('name' => 'ProductionRuleSet', 'type' => 'xsd:string'),
        'ProductionRule' => array('name' => 'ProductionRule', 'type' => 'xsd:string'),
        'RuleSetVariable' => array('name' => 'RuleSetVariable', 'type' => 'xsd:string'),
        'RuleVariable' => array('name' => 'RuleVariable', 'type' => 'xsd:string'),
        'RuleCondition' => array('name' => 'RuleCondition', 'type' => 'xsd:string'),
        'RuleAction' => array('name' => 'RuleAction', 'type' => 'xsd:string'),
        'created' => array('name' => 'created', 'type' => 'xsd:string'),
        'creator' => array('name' => 'creator', 'type' => 'xsd:string'),
        'last_editor' => array('name' => 'last_editor', 'type' => 'xsd:string'),
        'modified' => array('name' => 'modified', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('Figure', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'fk_productionrule_id' => array('name' => 'fk_productionrule_id', 'type' => 'xsd:string'),
        'fk_productionruleset_id' => array('name' => 'fk_productionruleset_id', 'type' => 'xsd:string'),
        'fk_ruleaction_id' => array('name' => 'fk_ruleaction_id', 'type' => 'xsd:string'),
        'fk_rulecondition_id' => array('name' => 'fk_rulecondition_id', 'type' => 'xsd:string'),
        'fk_rulesetvariable_id' => array('name' => 'fk_rulesetvariable_id', 'type' => 'xsd:string'),
        'fk_rulevariable_id' => array('name' => 'fk_rulevariable_id', 'type' => 'xsd:string'),
        'fk_chiworkerexternal_id' => array('name' => 'fk_chiworkerexternal_id', 'type' => 'xsd:string'),
        'fk_chiworkerinternal_id' => array('name' => 'fk_chiworkerinternal_id', 'type' => 'xsd:string'),
        'fk_chiworker_id' => array('name' => 'fk_chiworker_id', 'type' => 'xsd:string'),
        'fk_chibusinesspartneractive_id' => array('name' => 'fk_chibusinesspartneractive_id', 'type' => 'xsd:string'),
        ...
        'showInheritedAttributes' => array('name' => 'showInheritedAttributes', 'type' => 'xsd:string'),
...
/**  
 * SOAP Method getProductionRuleList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getProductionRuleList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'ProductionRule'));
// PROTECTED REGION ID(soap/Methods/getProductionRuleList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createProductionRule
 * @param login The login name
 * @param password The login password
 * @param ProductionRule The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createProductionRule($login, $password, $ProductionRule, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'ProductionRule',  PersistenceFacade::composeOID(array('type' => 'ProductionRule')) => $ProductionRule, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createProductionRule) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method readProductionRule 
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to load
 * @param depth The number of generations to load
 * @return string
 */  
function readProductionRule($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readProductionRule) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateProductionRule 
 * @param login The login name
 * @param password The login password
 * @param ProductionRule The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateProductionRule($login, $password, $ProductionRule, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $ProductionRule, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateProductionRule) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteProductionRule
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteProductionRule($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteProductionRule) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method getProductionRuleSetList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getProductionRuleSetList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'ProductionRuleSet'));
// PROTECTED REGION ID(soap/Methods/getProductionRuleSetList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createProductionRuleSet
 * @param login The login name
 * @param password The login password
 * @param ProductionRuleSet The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createProductionRuleSet($login, $password, $ProductionRuleSet, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'ProductionRuleSet',  PersistenceFacade::composeOID(array('type' => 'ProductionRuleSet')) => $ProductionRuleSet, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createProductionRuleSet) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method readProductionRuleSet 
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to load
 * @param depth The number of generations to load
 * @return string
 */  
function readProductionRuleSet($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readProductionRuleSet) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateProductionRuleSet 
 * @param login The login name
 * @param password The login password
 * @param ProductionRuleSet The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateProductionRuleSet($login, $password, $ProductionRuleSet, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $ProductionRuleSet, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateProductionRuleSet) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteProductionRuleSet
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteProductionRuleSet($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteProductionRuleSet) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method getRuleActionList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getRuleActionList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'RuleAction'));
// PROTECTED REGION ID(soap/Methods/getRuleActionList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createRuleAction
 * @param login The login name
 * @param password The login password
 * @param RuleAction The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createRuleAction($login, $password, $RuleAction, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'RuleAction',  PersistenceFacade::composeOID(array('type' => 'RuleAction')) => $RuleAction, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createRuleAction) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function readRuleAction($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readRuleAction) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function updateRuleAction($login, $password, $RuleAction, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $RuleAction, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateRuleAction) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteRuleAction
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteRuleAction($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteRuleAction) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method getRuleConditionList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getRuleConditionList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'RuleCondition'));
// PROTECTED REGION ID(soap/Methods/getRuleConditionList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createRuleCondition
 * @param login The login name
 * @param password The login password
 * @param RuleCondition The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createRuleCondition($login, $password, $RuleCondition, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'RuleCondition',  PersistenceFacade::composeOID(array('type' => 'RuleCondition')) => $RuleCondition, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createRuleCondition) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function readRuleCondition($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readRuleCondition) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateRuleCondition 
 * @param login The login name
 * @param password The login password
 * @param RuleCondition The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateRuleCondition($login, $password, $RuleCondition, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $RuleCondition, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateRuleCondition) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteRuleCondition
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteRuleCondition($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteRuleCondition) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method getRuleSetVariableList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getRuleSetVariableList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'RuleSetVariable'));
// PROTECTED REGION ID(soap/Methods/getRuleSetVariableList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createRuleSetVariable
 * @param login The login name
 * @param password The login password
 * @param RuleSetVariable The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createRuleSetVariable($login, $password, $RuleSetVariable, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'RuleSetVariable',  PersistenceFacade::composeOID(array('type' => 'RuleSetVariable')) => $RuleSetVariable, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createRuleSetVariable) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method readRuleSetVariable 
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to load
 * @param depth The number of generations to load
 * @return string
 */  
function readRuleSetVariable($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readRuleSetVariable) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateRuleSetVariable 
 * @param login The login name
 * @param password The login password
 * @param RuleSetVariable The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateRuleSetVariable($login, $password, $RuleSetVariable, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $RuleSetVariable, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateRuleSetVariable) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteRuleSetVariable
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteRuleSetVariable($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteRuleSetVariable) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method getRuleVariableList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getRuleVariableList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'RuleVariable'));
// PROTECTED REGION ID(soap/Methods/getRuleVariableList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createRuleVariable
 * @param login The login name
 * @param password The login password
 * @param RuleVariable The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createRuleVariable($login, $password, $RuleVariable, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'RuleVariable',  PersistenceFacade::composeOID(array('type' => 'RuleVariable')) => $RuleVariable, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createRuleVariable) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function readRuleVariable($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readRuleVariable) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateRuleVariable 
 * @param login The login name
 * @param password The login password
 * @param RuleVariable The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateRuleVariable($login, $password, $RuleVariable, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $RuleVariable, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateRuleVariable) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteRuleVariable
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteRuleVariable($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteRuleVariable) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method getUserConfigList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getUserConfigList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'UserConfig'));
// PROTECTED REGION ID(soap/Methods/getUserConfigList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createUserConfig
 * @param login The login name
 * @param password The login password
 * @param UserConfig The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createUserConfig($login, $password, $UserConfig, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'UserConfig',  PersistenceFacade::composeOID(array('type' => 'UserConfig')) => $UserConfig, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createUserConfig) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function readUserConfig($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readUserConfig) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function updateUserConfig($login, $password, $UserConfig, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $UserConfig, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateUserConfig) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteUserConfig
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteUserConfig($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteUserConfig) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
