...
$server->register('getNMChiUseCaseChiUseCaseList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:NMChiUseCaseChiUseCaseList'), $NAMESPACE);
  
$server->register('createNMChiUseCaseChiUseCase',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'NMChiUseCaseChiUseCase'=>'tns:NMChiUseCaseChiUseCase', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readNMChiUseCaseChiUseCase',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:NMChiUseCaseChiUseCase'), $NAMESPACE);
  
$server->register('updateNMChiUseCaseChiUseCase',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'NMChiUseCaseChiUseCase'=>'tns:NMChiUseCaseChiUseCase', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteNMChiUseCaseChiUseCase',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
...
$server->register('getNMChiNodeChiMany2ManyList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:NMChiNodeChiMany2ManyList'), $NAMESPACE);
  
$server->register('createNMChiNodeChiMany2Many',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'NMChiNodeChiMany2Many'=>'tns:NMChiNodeChiMany2Many', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readNMChiNodeChiMany2Many',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:NMChiNodeChiMany2Many'), $NAMESPACE);
  
$server->register('updateNMChiNodeChiMany2Many',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'NMChiNodeChiMany2Many'=>'tns:NMChiNodeChiMany2Many', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteNMChiNodeChiMany2Many',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
...
/**  
 * SOAP Method getNMChiUseCaseChiUseCaseList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getNMChiUseCaseChiUseCaseList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'NMChiUseCaseChiUseCase'));
// PROTECTED REGION ID(soap/Methods/getNMChiUseCaseChiUseCaseList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createNMChiUseCaseChiUseCase
 * @param login The login name
 * @param password The login password
 * @param NMChiUseCaseChiUseCase The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createNMChiUseCaseChiUseCase($login, $password, $NMChiUseCaseChiUseCase, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'NMChiUseCaseChiUseCase',  PersistenceFacade::composeOID(array('type' => 'NMChiUseCaseChiUseCase')) => $NMChiUseCaseChiUseCase, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createNMChiUseCaseChiUseCase) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method readNMChiUseCaseChiUseCase 
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to load
 * @param depth The number of generations to load
 * @return string
 */  
function readNMChiUseCaseChiUseCase($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readNMChiUseCaseChiUseCase) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateNMChiUseCaseChiUseCase 
 * @param login The login name
 * @param password The login password
 * @param NMChiUseCaseChiUseCase The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateNMChiUseCaseChiUseCase($login, $password, $NMChiUseCaseChiUseCase, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $NMChiUseCaseChiUseCase, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateNMChiUseCaseChiUseCase) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteNMChiUseCaseChiUseCase
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteNMChiUseCaseChiUseCase($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteNMChiUseCaseChiUseCase) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method getNMChiNodeChiMany2ManyList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getNMChiNodeChiMany2ManyList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'NMChiNodeChiMany2Many'));
// PROTECTED REGION ID(soap/Methods/getNMChiNodeChiMany2ManyList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createNMChiNodeChiMany2Many
 * @param login The login name
 * @param password The login password
 * @param NMChiNodeChiMany2Many The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createNMChiNodeChiMany2Many($login, $password, $NMChiNodeChiMany2Many, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'NMChiNodeChiMany2Many',  PersistenceFacade::composeOID(array('type' => 'NMChiNodeChiMany2Many')) => $NMChiNodeChiMany2Many, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createNMChiNodeChiMany2Many) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method readNMChiNodeChiMany2Many 
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to load
 * @param depth The number of generations to load
 * @return string
 */  
function readNMChiNodeChiMany2Many($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readNMChiNodeChiMany2Many) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateNMChiNodeChiMany2Many 
 * @param login The login name
 * @param password The login password
 * @param NMChiNodeChiMany2Many The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateNMChiNodeChiMany2Many($login, $password, $NMChiNodeChiMany2Many, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $NMChiNodeChiMany2Many, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateNMChiNodeChiMany2Many) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteNMChiNodeChiMany2Many
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteNMChiNodeChiMany2Many($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteNMChiNodeChiMany2Many) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
