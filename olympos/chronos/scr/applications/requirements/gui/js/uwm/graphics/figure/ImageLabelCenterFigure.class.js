 ...
 * 
 * @extends uwm.graphics.figure.LabelCenterFigure
 * @constructor
 ...
 */
uwm.graphics.figure.ImageLabelCenterFigure = function(label, figure, imageUrl, minWidth, minHeight, startWidth, startHeight) {
	this.url = imageUrl;
	
	uwm.graphics.figure.LabelCenterFigure.call(this, label, figure, minWidth, minHeight, startWidth, startHeight);
}

Ext.extend(uwm.graphics.figure.ImageLabelCenterFigure, uwm.graphics.figure.LabelCenterFigure);

uwm.graphics.figure.ImageLabelCenterFigure.prototype.createHTMLElement = function() {
	var item = uwm.graphics.figure.LabelCenterFigure.prototype.createHTMLElement.call(this);
...
uwm.graphics.figure.ImageLabelCenterFigure.prototype.paint = function() {
    uwm.graphics.figure.LabelCenterFigure.prototype.paint.call(this);
}

uwm.graphics.figure.ImageLabelCenterFigure.prototype.setDimension = function(w, h) {
	uwm.graphics.figure.LabelCenterFigure.prototype.setDimension.call(this, w, h);
