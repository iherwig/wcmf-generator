...
uwm.model.builtin.Model.prototype = new uwm.model.ModelNode;

uwm.model.builtin.Model.prototype.initByDisplayResult = function(node) {
...
uwm.model.builtin.Model.prototype.populatePropertyForm = function(form) {
