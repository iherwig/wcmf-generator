...
cwm.ChiBusinessPartnerActive = function(modelNodeClass) {
	cwm.ChiBusinessPartnerActive.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiBusinessPartnerActive, uwm.model.ModelObject);

cwm.ChiBusinessPartnerActive.prototype.initByDisplayResult = function(node) {
	cwm.ChiBusinessPartnerActive.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiBusinessPartnerActive.prototype.populatePropertyForm = function(form) {
...
cwm.ChiBusinessPartnerActive.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
