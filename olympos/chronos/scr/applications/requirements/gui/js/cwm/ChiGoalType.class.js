...
cwm.ChiGoalType = function(modelNodeClass) {
	cwm.ChiGoalType.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiGoalType, uwm.model.ModelObject);

cwm.ChiGoalType.prototype.initByDisplayResult = function(node) {
	cwm.ChiGoalType.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiGoalType.prototype.populatePropertyForm = function(form) {
