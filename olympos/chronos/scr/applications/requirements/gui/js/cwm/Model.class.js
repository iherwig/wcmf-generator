...
cwm.Model = function(modelNodeClass) {
	cwm.Model.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.Model, uwm.model.ModelObject);

cwm.Model.prototype.initByDisplayResult = function(node) {
	cwm.Model.superclass.initByDisplayResult.call(this, node);
...
cwm.Model.prototype.populatePropertyForm = function(form) {
...
cwm.Model.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
