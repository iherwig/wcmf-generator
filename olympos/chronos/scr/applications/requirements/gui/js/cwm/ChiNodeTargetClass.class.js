...
cwm.ChiNodeTargetClass = function() {
	cwm.ChiNodeTargetClass.superclass.constructor.call(this);
	
	this.uwmClassName = "ChiNodeTarget";
	this.instanceClassName = "cwm.ChiNodeTarget";
	this.treeIcon = "FigureChiNodeTarget";
	this.figureIcon = "FigureChiNodeTarget";
	this.figureClass = "uwm.graphics.figure.RectangleFigure";
	this.description = " A Domain Object type used in Chronos. ChiNodes and ChiValues define the application data model.";
	this.helpUrl = "help/index.html#ChiNodeTarget|outline";
	this.defaultLabel = "New ChiNodeTarget";
	this.semanticGroup = "domain";
	this.labelProperties = {
		Name: true
	};

	this.gridTabIconClass = "ChiNodeTargetTab";
	this.gridTabTip = "Shows all <b>ChiNodeTarget</b> within selected scope";
	this.gridFields = [{
		name: "oid",
		mapping: "oid"
	}, {
...
Ext.extend(cwm.ChiNodeTargetClass, uwm.model.ModelClass);

cwm.ChiNodeTargetClass.prototype.getPropertyForm = function(modelNode, isLockedByOtherUser) {
...
cwm.ChiNodeTargetClass.prototype.getGraphics = function(label, figure) {
	return new uwm.graphics.figure.ImageFigure(label, figure, "../application/images/ChiNodeTarget.PNG", 96, 95, 96, 95);
}

uwm.model.ModelNodeClassContainer.getInstance().registerClass(new cwm.ChiNodeTargetClass());
