...
cwm.ChiControllerTarget = function(modelNodeClass) {
	cwm.ChiControllerTarget.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiControllerTarget, uwm.model.ModelObject);

cwm.ChiControllerTarget.prototype.initByDisplayResult = function(node) {
	cwm.ChiControllerTarget.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiControllerTarget.prototype.populatePropertyForm = function(form) {
...
cwm.ChiControllerTarget.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
