...
cwm.UserRDBClass.prototype.getPropertyForm = function(modelNode) {
	return new uwm.property.PropertyForm({
		items: [new uwm.property.Textfield({fieldLabel: 'login',
			name: 'login',
			toolTip: '',
			modelNode: modelNode			 
		})new uwm.property.Textfield({fieldLabel: 'password',
			name: 'password',
			toolTip: '',
			modelNode: modelNode			 
		}),new uwm.property.Textfield({fieldLabel: 'name',
			name: 'name',
			toolTip: '',
			modelNode: modelNode			 
		}),new uwm.property.Textfield({fieldLabel: 'firstname',
			name: 'firstname',
			toolTip: '',
			modelNode: modelNode			 
		}),fieldLabel: 'config',
