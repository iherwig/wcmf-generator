...
cwm.Package = function(modelNodeClass) {
	cwm.Package.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.Package, uwm.model.ModelObject);

cwm.Package.prototype.initByDisplayResult = function(node) {
	cwm.Package.superclass.initByDisplayResult.call(this, node);
      this.data.Name = node.values[1].Name;
      this.data.Notes = node.values[1].Notes;
	  this.data.Author = node.values[1].Authors;
...
cwm.Package.prototype.populatePropertyForm = function(form) {
