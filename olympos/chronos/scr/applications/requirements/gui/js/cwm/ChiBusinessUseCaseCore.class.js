...
cwm.ChiBusinessUseCaseCore = function(modelNodeClass) {
	cwm.ChiBusinessUseCaseCore.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiBusinessUseCaseCore, uwm.model.ModelObject);

cwm.ChiBusinessUseCaseCore.prototype.initByDisplayResult = function(node) {
	cwm.ChiBusinessUseCaseCore.superclass.initByDisplayResult.call(this, node);
