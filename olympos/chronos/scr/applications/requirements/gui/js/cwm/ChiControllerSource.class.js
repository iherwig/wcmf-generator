...
cwm.ChiControllerSource = function(modelNodeClass) {
	cwm.ChiControllerSource.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiControllerSource, uwm.model.ModelObject);

cwm.ChiControllerSource.prototype.initByDisplayResult = function(node) {
	cwm.ChiControllerSource.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiControllerSource.prototype.populatePropertyForm = function(form) {
...
cwm.ChiControllerSource.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
