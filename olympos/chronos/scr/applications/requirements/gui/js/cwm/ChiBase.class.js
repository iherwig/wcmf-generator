...
cwm.ChiBase = function(modelNodeClass) {
	cwm.ChiBase.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiBase, uwm.model.ModelObject);

cwm.ChiBase.prototype.initByDisplayResult = function(node) {
	cwm.ChiBase.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiBase.prototype.populatePropertyForm = function(form) {
