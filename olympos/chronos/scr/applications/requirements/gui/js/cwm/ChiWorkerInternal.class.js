...
cwm.ChiWorkerInternal = function(modelNodeClass) {
	cwm.ChiWorkerInternal.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiWorkerInternal, uwm.model.ModelObject);

cwm.ChiWorkerInternal.prototype.initByDisplayResult = function(node) {
	cwm.ChiWorkerInternal.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiWorkerInternal.prototype.populatePropertyForm = function(form) {
...
cwm.ChiWorkerInternal.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
