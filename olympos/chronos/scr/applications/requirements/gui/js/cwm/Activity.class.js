...
cwm.Activity = function(modelNodeClass) {
	cwm.Activity.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.Activity, uwm.model.ModelObject);

cwm.Activity.prototype.initByDisplayResult = function(node) {
	cwm.Activity.superclass.initByDisplayResult.call(this, node);
...
cwm.Activity.prototype.populatePropertyForm = function(form) {
...
cwm.Activity.prototype.getGridData = function() {
	return {
		oid :this.getOid(),
		label :this.getLabel()
	}
