...
cwm.relations.SourceEndClass = function(){
    cwm.relations.SourceEndClass.superclass.constructor.call(this);
    
    this.uwmClassName = "SourceEnd";
...
uwm.model.ModelNodeClassContainer.getInstance().registerClass(new cwm.relations.SourceEndClass());
