 ...
 */
cwm.ChiBusinessUseCase.prototype.associate = function(otherModelObject, connectionInfo, nmUwmClassName, connection) {
		...
		if (processParentOids) {
			for (var i=0; i<processParentOids.length; i++) {
				if (uwm.Util.getUwmClassNameFromOid(processParentOids[i]) == 'Package') {
					...
					cwm.ChiBusinessUseCase.superclass.associate.call(this, otherModelObject, connectionInfo, nmUwmClassName, connection);
