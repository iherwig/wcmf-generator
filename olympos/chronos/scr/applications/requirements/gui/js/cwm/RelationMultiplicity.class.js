...
cwm.RelationMultiplicity = function(modelNodeClass) {
	cwm.RelationMultiplicity.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.RelationMultiplicity, uwm.model.TechnicalObject);

cwm.RelationMultiplicity.prototype.initByDisplayResult = function(node) {
	cwm.RelationMultiplicity.superclass.initByDisplayResult.call(this, node);
...
cwm.RelationMultiplicity.prototype.populatePropertyForm = function(form) {
...
cwm.RelationMultiplicity.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
