...
cwm.ChiView = function(modelNodeClass) {
	cwm.ChiView.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiView, uwm.model.ModelObject);

cwm.ChiView.prototype.initByDisplayResult = function(node) {
	cwm.ChiView.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiView.prototype.populatePropertyForm = function(form) {
...
cwm.ChiView.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
