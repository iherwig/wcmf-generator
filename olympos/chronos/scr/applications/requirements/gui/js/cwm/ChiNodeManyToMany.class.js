...
cwm.ChiNodeManyToMany = function(modelNodeClass) {
	cwm.ChiNodeManyToMany.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiNodeManyToMany, uwm.model.ClassObject);

cwm.ChiNodeManyToMany.prototype.addAttribute = function() {
	uwm.model.ModelContainer.getInstance().createModelObject("ChiValue", this);
}

cwm.ChiNodeManyToMany.prototype.addOperation = function() {
	uwm.model.ModelContainer.getInstance().createModelObject("Operation", this);
}

cwm.ChiNodeManyToMany.prototype.initByDisplayResult = function(node) {
	cwm.ChiNodeManyToMany.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiNodeManyToMany.prototype.populatePropertyForm = function(form) {
...
cwm.ChiNodeManyToMany.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
