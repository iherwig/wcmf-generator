...
cwm.ChiBusinessPartnerPassive = function(modelNodeClass) {
	cwm.ChiBusinessPartnerPassive.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiBusinessPartnerPassive, uwm.model.ModelObject);

cwm.ChiBusinessPartnerPassive.prototype.initByDisplayResult = function(node) {
	cwm.ChiBusinessPartnerPassive.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiBusinessPartnerPassive.prototype.populatePropertyForm = function(form) {
...
cwm.ChiBusinessPartnerPassive.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
