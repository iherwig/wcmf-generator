...
cwm.ChiNodeBase = function(modelNodeClass) {
	cwm.ChiNodeBase.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiNodeBase, uwm.model.ModelObject);

cwm.ChiNodeBase.prototype.initByDisplayResult = function(node) {
	cwm.ChiNodeBase.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiNodeBase.prototype.populatePropertyForm = function(form) {
...
cwm.ChiNodeBase.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
