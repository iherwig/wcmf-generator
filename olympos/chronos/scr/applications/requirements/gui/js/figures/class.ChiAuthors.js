...
req.figure.ChiAuthors = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiAuthors", label, oid, parentoids, childoids);
}
...
req.figure.ChiAuthors.prototype.getStore = function(){
...
req.figure.ChiAuthors.prototype.showEdit = function(bd, oid){
