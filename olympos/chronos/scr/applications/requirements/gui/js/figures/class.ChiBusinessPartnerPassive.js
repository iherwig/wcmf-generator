...
req.figure.ChiBusinessPartnerPassive = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiBusinessPartnerPassive", label, oid, parentoids, childoids);
}
...
req.figure.ChiBusinessPartnerPassive.prototype.getStore = function(){
...
req.figure.ChiBusinessPartnerPassive.prototype.showEdit = function(bd, oid){
