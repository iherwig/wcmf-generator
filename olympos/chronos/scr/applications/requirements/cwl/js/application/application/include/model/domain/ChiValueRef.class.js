...
Ext.extend(application.application.include.model.domain.ChiValueRef, chi.model.ModelClass);
...
application.application.include.model.domain.ChiValueRef.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiValueRef.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiValueRef());
