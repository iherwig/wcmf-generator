...
application.application.include.model.configuration.ChiSystemDescription = function() {
	application.application.include.model.configuration.ChiSystemDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiSystem";
	this.name = "ChiSystem";
...
Ext.extend(application.application.include.model.configuration.ChiSystemDescription, chi.model.ModelDescription);


application.application.include.model.configuration.ChiSystemDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.configuration.ChiSystemDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.configuration.ChiSystemDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.configuration.ChiSystemDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.configuration.ChiSystemDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.configuration.ChiSystem(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.configuration.ChiSystemDescription());
