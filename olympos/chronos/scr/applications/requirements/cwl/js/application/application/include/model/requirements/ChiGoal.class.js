...
Ext.extend(application.application.include.model.requirements.ChiGoal, chi.model.ModelClass);
...
application.application.include.model.requirements.ChiGoal.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.requirements.ChiGoal.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.requirements.ChiGoal());
