...
application.application.include.model.activity.Activity = function() {
	application.application.include.model.activity.Activity.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.activity.Activity, chi.model.ModelClass);
...
application.application.include.model.activity.Activity.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.Activity.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.Activity());
