...
Ext.extend(application.application.include.model.domain.RelationType, chi.model.ModelClass);
...
application.application.include.model.domain.RelationType.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.RelationType.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.RelationType());
