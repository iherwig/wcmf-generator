...
Ext.extend(application.application.include.model.UseCases.ChiBusinessPartner, chi.model.ModelClass);
...
application.application.include.model.UseCases.ChiBusinessPartner.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessPartner.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessPartner());
