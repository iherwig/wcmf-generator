...
application.application.include.model.rules.RuleSetVariableDescription = function() {
	application.application.include.model.rules.RuleSetVariableDescription.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.rules.RuleSetVariableDescription, chi.model.ModelDescription);


application.application.include.model.rules.RuleSetVariableDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.RuleSetVariableDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.rules.RuleSetVariableDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.RuleSetVariableDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.rules.RuleSetVariableDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.rules.RuleSetVariable(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.rules.RuleSetVariableDescription());
