...
Ext.extend(application.application.include.model.UseCases.ChiWorkerExternal, chi.model.ModelClass);


application.application.include.model.UseCases.ChiWorkerExternal.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorkerExternal.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiWorkerExternal.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiWorkerExternal());
