...
Ext.extend(application.application.include.model.activity.ActivitySet, chi.model.ModelClass);
...
application.application.include.model.activity.ActivitySet.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivitySet.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivitySet());
