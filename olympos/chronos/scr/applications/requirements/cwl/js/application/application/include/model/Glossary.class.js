...
application.application.include.model.Glossary = function() {
	application.application.include.model.Glossary.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.Glossary, chi.model.ModelClass);


application.application.include.model.Glossary.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.Glossary.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.Glossary.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.Glossary.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.Glossary());
