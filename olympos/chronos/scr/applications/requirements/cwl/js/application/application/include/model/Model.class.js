...
Ext.extend(application.application.include.model.Model, chi.model.ModelClass);


application.application.include.model.Model.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.Model.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.Model.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.Model());
