...
application.application.include.model.rules.ProductionRuleSetDescription = function() {
	application.application.include.model.rules.ProductionRuleSetDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ProductionRuleSet";
	this.name = "ProductionRuleSet";
	this.treeIconClass = "ProductionRuleSetTreeIcon16x16";
...
Ext.extend(application.application.include.model.rules.ProductionRuleSetDescription, chi.model.ModelDescription);


application.application.include.model.rules.ProductionRuleSetDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.ProductionRuleSetDescription.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.ProductionRuleSetDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.rules.ProductionRuleSetDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.rules.ProductionRuleSet(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.rules.ProductionRuleSetDescription());
