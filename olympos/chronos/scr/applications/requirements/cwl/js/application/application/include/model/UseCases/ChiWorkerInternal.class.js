...
Ext.extend(application.application.include.model.UseCases.ChiWorkerInternal, chi.model.ModelClass);


application.application.include.model.UseCases.ChiWorkerInternal.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorkerInternal.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiWorkerInternal.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiWorkerInternal());
