...
application.application.include.model.domain.OperationDescription = function() {
	application.application.include.model.domain.OperationDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "Operation";
	this.name = "Operation";
...
Ext.extend(application.application.include.model.domain.OperationDescription, chi.model.ModelDescription);


application.application.include.model.domain.OperationDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.domain.OperationDescription.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.OperationDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.domain.OperationDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.domain.Operation(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.domain.OperationDescription());
