...
application.application.include.model.UseCases.ChiBusinessUseCaseCore = function() {
	application.application.include.model.UseCases.ChiBusinessUseCaseCore.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessUseCaseCore, chi.model.ModelClass);
...
application.application.include.model.UseCases.ChiBusinessUseCaseCore.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessUseCaseCore.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessUseCaseCore());
