...
Ext.extend(application.application.include.model.domain.Operation, chi.model.ModelClass);
...
application.application.include.model.domain.Operation.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.Operation.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.Operation());
