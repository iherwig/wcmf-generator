...
application.application.include.model.domain.ChiView = function() {
	application.application.include.model.domain.ChiView.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.domain.ChiView, chi.model.ModelClass);


application.application.include.model.domain.ChiView.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.domain.ChiView.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.domain.ChiView.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiView.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiView());
