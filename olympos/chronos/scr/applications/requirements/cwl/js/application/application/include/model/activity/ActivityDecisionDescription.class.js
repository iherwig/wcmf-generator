...
application.application.include.model.activity.ActivityDecisionDescription = function() {
	application.application.include.model.activity.ActivityDecisionDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ActivityDecision";
	this.name = "ActivityDecision";
	this.treeIconClass = "ActivityDecisionTreeIcon16x16";
...
Ext.extend(application.application.include.model.activity.ActivityDecisionDescription, chi.model.ModelDescription);


application.application.include.model.activity.ActivityDecisionDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityDecisionDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivityDecisionDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityDecisionDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.activity.ActivityDecisionDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.activity.ActivityDecision(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.activity.ActivityDecisionDescription());
