...
application.application.include.model.domain.ChiClass = function() {
	application.application.include.model.domain.ChiClass.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.domain.ChiClass, chi.model.ModelClass);


application.application.include.model.domain.ChiClass.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.domain.ChiClass.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.domain.ChiClass.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiClass.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiClass());
