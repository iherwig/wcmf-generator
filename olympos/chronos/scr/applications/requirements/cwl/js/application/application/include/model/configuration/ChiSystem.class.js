...
Ext.extend(application.application.include.model.configuration.ChiSystem, chi.model.ModelClass);
...
application.application.include.model.configuration.ChiSystem.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.configuration.ChiSystem.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.configuration.ChiSystem());
