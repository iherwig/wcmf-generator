...
application.application.include.model.requirements.ChiIssue = function() {
	application.application.include.model.requirements.ChiIssue.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.requirements.ChiIssue, chi.model.ModelClass);
...
application.application.include.model.requirements.ChiIssue.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.requirements.ChiIssue.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.requirements.ChiIssue());
