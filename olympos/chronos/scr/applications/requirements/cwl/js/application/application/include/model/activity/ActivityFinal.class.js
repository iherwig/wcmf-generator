...
application.application.include.model.activity.ActivityFinal = function() {
	application.application.include.model.activity.ActivityFinal.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.activity.ActivityFinal, chi.model.ModelClass);


application.application.include.model.activity.ActivityFinal.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityFinal.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivityFinal.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityFinal.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivityFinal());
