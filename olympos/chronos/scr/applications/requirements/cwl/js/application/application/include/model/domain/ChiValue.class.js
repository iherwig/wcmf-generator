...
Ext.extend(application.application.include.model.domain.ChiValue, chi.model.ModelClass);
	...
	return [
		...
		, 
			...
			new chi.editor.control.ComboBox({
				targetChiModelElementId: "DisplayType"
			})
		...
		, 
			...
			new chi.editor.control.ComboBox({
				targetChiModelElementId: "InputType"
			})
...
application.application.include.model.domain.ChiValue.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiValue.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiValue());
