...
application.application.include.model.PackageDescription = function() {
	application.application.include.model.PackageDescription.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.PackageDescription, chi.model.ModelDescription);


application.application.include.model.PackageDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.PackageDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.PackageDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.PackageDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.PackageDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.Package(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.PackageDescription());
