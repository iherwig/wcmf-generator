...
application.application.include.model.domain.ChiNodeManyToMany = function() {
	application.application.include.model.domain.ChiNodeManyToMany.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.domain.ChiNodeManyToMany, chi.model.ModelClass);


application.application.include.model.domain.ChiNodeManyToMany.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.domain.ChiNodeManyToMany.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.domain.ChiNodeManyToMany.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiNodeManyToMany.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiNodeManyToMany());
