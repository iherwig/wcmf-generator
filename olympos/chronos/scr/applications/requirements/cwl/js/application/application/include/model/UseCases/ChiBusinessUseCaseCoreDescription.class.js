...
application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription = function() {
	application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiBusinessUseCaseCore";
	this.name = "ChiBusinessUseCaseCore";
	this.treeIconClass = "ChiBusinessUseCaseCoreTreeIcon16x16";
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.ChiBusinessUseCaseCore(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ChiBusinessUseCaseCoreDescription());
