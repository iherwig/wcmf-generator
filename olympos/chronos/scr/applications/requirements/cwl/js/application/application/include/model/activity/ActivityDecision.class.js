...
Ext.extend(application.application.include.model.activity.ActivityDecision, chi.model.ModelClass);
...
application.application.include.model.activity.ActivityDecision.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityDecision.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivityDecision());
