...
application.application.include.model.UseCases.ChiBusinessPartnerPassive = function() {
	application.application.include.model.UseCases.ChiBusinessPartnerPassive.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessPartnerPassive, chi.model.ModelClass);


application.application.include.model.UseCases.ChiBusinessPartnerPassive.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerPassive.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerPassive.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessPartnerPassive.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessPartnerPassive());
