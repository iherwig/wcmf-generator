...
application.application.include.model.UseCases.ActorDescription = function() {
	application.application.include.model.UseCases.ActorDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "Actor";
	this.name = "Actor";
	this.treeIconClass = "ActorTreeIcon16x16";
...
Ext.extend(application.application.include.model.UseCases.ActorDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ActorDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ActorDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ActorDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ActorDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ActorDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.Actor(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ActorDescription());
