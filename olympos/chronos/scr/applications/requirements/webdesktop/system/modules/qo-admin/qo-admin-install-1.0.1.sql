...
('QoDesk.QoAdminMenu', 'menu', 'qo-admin-menu', '1.0.1', 'Paul Simmons', 'Menu for QO Admin modules', 'system/modules/qo-admin/', 'true'),
('QoDesk.QoAdminMembers', 'system', 'qo-admin-members', '1.0.1', 'Paul Simmons', 'QO Admin module for Members', 'system/modules/qo-admin/qo-admin-members/', 'true'),
('QoDesk.QoAdminModules', 'system', 'qo-admin-modules', '1.0.1', 'Paul Simmons', 'Admin module to edit/delete/add members', 'system/modules/qo-admin/qo-admin-modules/', 'true'),
('QoDesk.QoAdminModuleFiles', 'system', 'qo-admin-module-files', '1.0.1', 'Paul Simmons', 'Admin module to edit/delete/add module files', 'system/modules/qo-admin/qo-admin-module-files/', 'true'),
('QoDesk.QoAdminGroups', 'system', 'qo-admin-groups', '1.0.1', 'Paul Simmons', 'Admin module to edit/delete/add groups', 'system/modules/qo-admin/qo-admin-groups/', 'true'),
('QoDesk.QoAdminGroupModules', 'system', 'qo-admin-group-modules', '1.0.1', 'Paul Simmons', 'Admin module to edit/delete/add module group authorities', 'system/modules/qo-admin/qo-admin-group-modules/', 'true'),
('QoDesk.QoAdminMemberGroups', 'system', 'qo-admin-member-groups', '1.0.1', 'Paul Simmons', 'Admin module to edit/delete/add member group authorities', 'system/modules/qo-admin/qo-admin-member-groups/', 'true'),
('QoDesk.QoAdminModuleLaunchers', 'system', 'qo-admin-module-launchers', '1.0.1', 'Paul Simmons', 'Admin module to edit/delete/add module launcher authorities', 'system/modules/qo-admin/qo-admin-module-launchers/', 'true'),
...
-- ----------------------------------------------------------------------------
-- Add My Profile to other groups
-- ----------------------------------------------------------------------------
insert into `qo_groups_has_modules` (`qo_groups_id`, `qo_modules_id`, `active`)
select g.id, m.id, 'true'
from (select id from qo_groups where ucase(name) <> 'ADMINISTRATOR') g
