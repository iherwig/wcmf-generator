...
('QoDesk.QoAdminMenu', 'menu', 'qo-admin-menu', '1.1.0', 'Paul Simmons', 'Menu for QO Admin modules', 'system/modules/qo-admin/', 'true'),
('QoDesk.QoAdminMembers', 'system', 'qo-admin-members', '1.1.0', 'Paul Simmons', 'QO Admin module for Members', 'system/modules/qo-admin/qo-admin-members/', 'true'),
('QoDesk.QoAdminModules', 'system', 'qo-admin-modules', '1.1.0', 'Paul Simmons', 'Admin module to edit/delete/add members', 'system/modules/qo-admin/qo-admin-modules/', 'true'),
('QoDesk.QoAdminModuleFiles', 'system', 'qo-admin-module-files', '1.1.0', 'Paul Simmons', 'Admin module to edit/delete/add module files', 'system/modules/qo-admin/qo-admin-module-files/', 'true'),
('QoDesk.QoAdminGroups', 'system', 'qo-admin-groups', '1.1.0', 'Paul Simmons', 'Admin module to edit/delete/add groups', 'system/modules/qo-admin/qo-admin-groups/', 'true'),
('QoDesk.QoAdminGroupModules', 'system', 'qo-admin-group-modules', '1.1.0', 'Paul Simmons', 'Admin module to edit/delete/add module group authorities', 'system/modules/qo-admin/qo-admin-group-modules/', 'true'),
('QoDesk.QoAdminMemberGroups', 'system', 'qo-admin-member-groups', '1.1.0', 'Paul Simmons', 'Admin module to edit/delete/add member group authorities', 'system/modules/qo-admin/qo-admin-member-groups/', 'true'),
('QoDesk.QoAdminModuleLaunchers', 'system', 'qo-admin-module-launchers', '1.1.0', 'Paul Simmons', 'Admin module to edit/delete/add module launcher authorities', 'system/modules/qo-admin/qo-admin-module-launchers/', 'true'),
('QoDesk.QoAdminMyProfile', 'system', 'qo-admin-my-profile', '1.1.0', 'Paul Simmons', 'Allows users to modify their own profile', 'system/modules/qo-admin/qo-admin-my-profile/', 'true'),
