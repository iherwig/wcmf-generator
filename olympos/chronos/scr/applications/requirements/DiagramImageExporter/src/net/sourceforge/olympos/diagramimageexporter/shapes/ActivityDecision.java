...
public class ActivityDecision extends Figure{
	...
	private InfoLine infLine1 = new InfoLine( 0, 20, 20, 0); //oben links
	private InfoLine infLine2 = new InfoLine( 20, 38, 0,  19);//unten links
	private InfoLine infLine3 = new InfoLine( 19, 38, 39, 18);//unten rechts
	private InfoLine infLine4 = new InfoLine(19, 0, 39,  19); //oben rechts
