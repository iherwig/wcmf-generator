...
public class DrawConnectionType {
	...
	private class DiamandCoordinates {
		...
		int rightx, righty, middle1x, middle1y, leftx, lefty;
	...
	// connection method
	public void connection(Graphics2D g2d, InfoFigureParameter source, InfoFigureParameter target, InfoCoordinate toPoint, EnumDirection toDirection, InfoCoordinate fromPoint,
			EnumDirection fromDirection, EnumConnectionEnd sourceEnd, EnumConnectionEnd targetEnd) {

		// ElementDiagram elem =
		// ElementDiagram.getCatalogEntry(source.getType());
		...
		drawConnectionEnd(g2d, toDirection, fromPoint, targetEnd);
		// }
	}
	...
	private void drawClosedDiamond(Graphics2D g2d, EnumDirection toDirection, InfoCoordinate toPoint) {
		// create a new hashtable for the four directions and give them the
		// right parameter
...
//		g2d.setColor(Color.white);
//		polygon.addPoint((int) fromPoint.getX() - 2, (int) fromPoint.getY() - 2);
//		polygon.addPoint((int) fromPoint.getX() + (int) xy2.getX() + 1, (int) fromPoint.getY() + (int) xy2.getY() - 2);
//		polygon.addPoint((int) fromPoint.getX() - 2, (int) fromPoint.getY() - 2);
//		g2d.setStroke(new BasicStroke(1, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER));
//		g2d.fillPolygon(polygon);
	}
