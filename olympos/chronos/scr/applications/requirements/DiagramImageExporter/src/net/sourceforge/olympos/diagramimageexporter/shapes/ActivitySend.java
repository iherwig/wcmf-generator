...
public class ActivitySend extends Figure{
	...
	private InfoLine infLine1 = new InfoLine( 0, 0, 56, 0); //oben
	private InfoLine infLine2 = new InfoLine( 0, 0, 0, 39); //links
	private InfoLine infLine3 = new InfoLine( 56, 0, 76, 20); //rechts oben
	private InfoLine infLine4 = new InfoLine( 56, 39, 76,20); //rechts unten
	private InfoLine infLine5 = new InfoLine( 0, 39, 56, 39); // unten
