...
class ChiValueBase extends Property
{
    ...
    {
      if ($type == null)
        parent::__construct($oid, 'ChiValue');
      else
      ...
      if ($name == 'getChiValueRefList')
    {
      ...
      if ($name == 'getChiValueRefChildren') {
        return $this->getChildrenEx(null, 'ChiValueRef', array('fk_chivalue_id' => $this->getDBID()), null, false);
    }
      // child: Figure
      if ($name == 'getFigureList')
    {
      ...
      if ($name == 'getFigureChildren') {
        return $this->getChildrenEx(null, 'Figure', array('fk_chivalue_id' => $this->getDBID()), null, false);
    }
    }
