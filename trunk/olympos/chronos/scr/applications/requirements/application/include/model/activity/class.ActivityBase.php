<?php
/**
 * This file was generated by wCMFGenerator 3 from src/model/wcmf_default.uml on Mon Apr 27 11:16:17 CEST 2009. 
...
class ActivityBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'NMActivityChiObject', array('fk_activity_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      // the foreign key column does not exist
      return $this->getChildrenEx(null, 'ChiObject', null, null);
    }
    /**
    ...
    function loadChildren($type, $buildDepth=BUILDDEPTH_SINGLE, $forceUpdate=false)
    {
      ...
      if ($type == 'ChiObject')
      {
        ...
        $children = parent::getChildrenEx(null, 'NMActivityChiObject', array('fk_activity_id' => $this->getDBID()), null);
        $persistenceFacade = &PersistenceFacade::getInstance();
        $grandChildren = array();
        for($i=0; $i<sizeof($children); $i++)
        {
