...
// PROTECTED REGION END
    ...
    (
	  ...
	  */
      array('name' => 'Proofreader', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'proofreader', 'db_data_type' => 'VARCHAR(255)', 'default' => 'aName, Client', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text'),
      /* 
	  * Value description: This feature's status
	  */
      array('name' => 'Status', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'status', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'select#async:ChiFeaturesStatus', 'display_type' => 'text'),
      /* 
	  * Value description: 
	  */
