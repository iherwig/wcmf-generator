...
require_once(BASE."application/include/model/class.ChiBaseStatus.php");

/**
 * @class ChiBaseStatusRDBMapper
 * ChiBaseStatusRDBMapper maps ChiBaseStatus Nodes to the database.
 ...
 * @version 1.0
 */
class ChiBaseStatusRDBMapper extends NodeUnifiedRDBMapper
{
  /**
...
// PROTECTED REGION ID(application/include/model/class.ChiBaseStatusRDBMapper.php/Properties) ENABLED START
