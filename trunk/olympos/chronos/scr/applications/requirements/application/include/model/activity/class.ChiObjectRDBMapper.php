...
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'is instance of', 'app_data_type' => DATATYPE_IGNORE, 'column_name' => 'is instance of', 'db_data_type' => 'INT(11)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
    ...
    (
      ...
      */
      array('name' => 'ChiNodeName', 'ref_type' => 'ChiNode', 'ref_value' => 'Name', 'ref_table' => 'ChiNode', 'id_column' => 'id', 'fk_columns' => 'is instance of', 'ref_column' => 'name')
    );
    $nodeDef['_parents'] = array
    (
      array('type' => 'ActivitySet', 'is_navigable' => true, 'table_name' => 'ActivitySet', 'pk_columns' => array('id'), 'fk_columns' => 'fk_activityset_id'),
      array('type' => 'ChiNode', 'is_navigable' => true, 'table_name' => 'ChiNode', 'pk_columns' => array('id'), 'fk_columns' => 'is instance of'),
