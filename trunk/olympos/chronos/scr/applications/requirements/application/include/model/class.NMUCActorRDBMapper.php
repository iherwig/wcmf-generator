...
require_once(BASE."application/include/model/class.NMUCActor.php");
...
class NMUCActorRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('ChiBusinessUseCase', 'Actor')),
      array('name' => 'is_searchable', 'value' => true),
// PROTECTED REGION ID(application/include/model/class.NMUCActorRDBMapper.php/Properties) START
