...
require_once(BASE."application/include/model/rules/class.RuleSetVariable.php");

/**
 * @class RuleSetVariableRDBMapper
 * RuleSetVariableRDBMapper maps RuleSetVariable Nodes to the database.
 * RuleSetVariable description: 
 *
 * @author 
 * @version 1.0
 */
class RuleSetVariableRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  {
    return new RuleSetVariable($oid);
  }
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'RuleSetVariable' && $parentType == 'ProductionRuleSet') return 'fk_productionruleset_id';
    if ($this->getType() == 'RuleSetVariable' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION ID(application/include/model/rules/class.RuleSetVariableRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_rulesetvariable_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
