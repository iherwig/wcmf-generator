...
class ModelRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Model' && $parentType == 'Package') return 'fk_package_id';
    if ($this->getType() == 'Model' && $parentType == 'ChiBusinessProcess') return 'fk_chibusinessprocess_id';
    return '';
  }
  /**
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'ChiBusinessProcess', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessProcess', 'pk_columns' => array('id'), 'fk_columns' => 'fk_model_id', 'order_by' => array()),
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_model_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
