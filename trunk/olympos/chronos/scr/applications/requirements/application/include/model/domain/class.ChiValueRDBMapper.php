...
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Mon Jan 10 18:22:53 CET 2011. 
...
// PROTECTED REGION END
    ...
    (
     ...
     /* 
      * Value description: this is the type of this property (e.g. string. int, etc.). not necessary. NOTE: The type ChiNode could cause problems when primitive types like Sting, Integer schould be used.
      */
      array('name' => 'PropertyType', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'propertytype', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'select#async:ChiNode', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
    ...
    (
      array('type' => 'ChiValueRef', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiValueRef', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chivalue_id', 'order_by' => array('sortkey')),
