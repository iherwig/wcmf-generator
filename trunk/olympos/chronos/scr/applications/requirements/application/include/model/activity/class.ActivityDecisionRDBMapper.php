...
class ActivityDecisionRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivityDecision' && $parentType == 'ProductionRuleSet') return 'fk_productionruleset_id';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ADControlFlowSourceEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_adcontrolflowsource_id', 'order_by' => array()),
      array('type' => 'ADControlFlowTargetEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_adcontrolflowtarget_id', 'order_by' => array()),
