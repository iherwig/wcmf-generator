...
req.figure.ChiIssue = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiIssue", label, oid, parentoids, childoids);
}
...
req.figure.ChiIssue.prototype.getStore = function(){
...
req.figure.ChiIssue.prototype.showEdit = function(bd, oid){
