...
require_once(BASE."application/include/model/domain/class.InputType.php");

/**
 * @class InputTypeRDBMapper
 * InputTypeRDBMapper maps InputType Nodes to the database.
 ...
 * @version 1.0
 */
class InputTypeRDBMapper extends NodeUnifiedRDBMapper
{
  /**
...
// PROTECTED REGION ID(application/include/model/domain/class.InputTypeRDBMapper.php/Properties) ENABLED START
