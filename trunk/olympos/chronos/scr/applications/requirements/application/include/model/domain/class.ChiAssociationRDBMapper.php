...
class ChiAssociationRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'NodeSourceEndChiAssociation' && $parentType == 'ChiNodeManyToMany') return 'fk_chinodemanytomany_id';
    if ($parentType == 'ChiNodeSource') return 'fk_chinodesource_id';
    if ($parentType == 'ChiNodeTarget') return 'fk_chinodetarget_id';
    if ($parentType == 'ChiNodeSource') return 'fk_chinodemanytomany_id';
    return '';
  }
  /**
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('ChiNodeSource', 'ChiNodeTarget', 'ChiNodeSource')),
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'ChiNodeSource', 'is_navigable' => true, 'table_name' => 'ChiNodeManyToMany', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chinodemanytomany_id')
    );
