...
class ActivitySendBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'ActivityReceive', array('fk_activitysend_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_activitysend_id' => $this->getDBID()), null);
    }
