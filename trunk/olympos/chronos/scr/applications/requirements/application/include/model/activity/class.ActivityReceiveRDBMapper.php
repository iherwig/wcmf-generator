...
class ActivityReceiveRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivityReceive' && $parentType == 'ActivitySet') return 'Aggregation';
    if ($this->getType() == 'ActivityReceive' && $parentType == 'ActivitySend') return 'Association';
    if ($this->getType() == 'ActivityReceive' && $parentType == 'Package') return 'fk_package_id';
    if ($parentType == 'ActivitySet') return 'Aggregation';
    if ($parentType == 'ActivitySend') return 'Association';
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'ActivitySend', 'is_navigable' => true, 'table_name' => 'ActivitySend', 'pk_columns' => array('id'), 'fk_columns' => 'Association'),
      array('type' => 'Package', 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'fk_package_id')
    );
    $nodeDef['_children'] = array
    (
      array('type' => 'Activity', 'minOccurs' => 1, 'maxOccurs' => 1, 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Activity', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
