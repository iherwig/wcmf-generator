...
class OperationRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Operation' && $parentType == 'ChiNode') return 'Composition';
    if ($this->getType() == 'Operation' && $parentType == 'ChiController') return 'Contains';
    if ($parentType == 'ChiNode') return 'Composition';
    if ($parentType == 'ChiController') return 'Contains';
    return '';
  }
  /**
...
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'Contains', 'app_data_type' => DATATYPE_IGNORE, 'column_name' => 'Contains', 'db_data_type' => 'INT(11)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
    ...
    (
      ...
      array('type' => 'ChiController', 'is_navigable' => true, 'table_name' => 'ChiController', 'pk_columns' => array('id'), 'fk_columns' => 'Contains')
    );
