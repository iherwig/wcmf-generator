...
class ActivityDecisionBase extends ChiBase
{
    ...
    {
      if ($type == null)
        parent::__construct($oid, 'ActivityDecision');
      else
      ...
      if ($name == 'setPackage')
    {
      ...
      // child: ADControlFlowTargetEnd
      if ($name == 'getADControlFlowTargetEndList')
    {
      ...
      if ($name == 'getADControlFlowTargetEndChildren') {
      ...
      if ($name == 'getActivityFinalChildren')
    {
      ...
      // child: ADControlFlowSourceEnd
      if ($name == 'getADControlFlowSourceEndList')
    {
      ...
      if ($name == 'getADControlFlowSourceEndChildren') {
