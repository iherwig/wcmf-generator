...
class ChiSystemBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'Property', array('fk_chisystem_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_chisystem_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiValue', array('fk_chisystem_id' => $this->getDBID()), null);
    }
