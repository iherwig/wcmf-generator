...
class ChiWorkerInternalRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiWorkerInternal' && $parentType == 'ChiWorkerInternal') return 'fk_chiworkerinternal_id';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiWorkerInternal', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiWorkerInternal', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chiworkerinternal_id', 'order_by' => array('sortkey')),
