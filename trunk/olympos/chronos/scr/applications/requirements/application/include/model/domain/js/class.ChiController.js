...
req.figure.ChiController = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiController", label, oid, parentoids, childoids);
}
...
req.figure.ChiController.prototype.getStore = function(){
...
req.figure.ChiController.prototype.showEdit = function(bd, oid){
