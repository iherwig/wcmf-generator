...
class ActivityInitialRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivityInitial' && $parentType == 'ProductionRuleSet') return 'fk_productionruleset_id';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ControlFlow', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_activityinitial_id', 'order_by' => array()),
