...
class NMChiControllerActionKeyChiControllerRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'TargetActionKeyEnd' && $parentType == 'ChiController') return 'fk_chicontroller_id';
    if ($this->getType() == 'SourceActionKeyEnd' && $parentType == 'ChiController') return 'fk_chicontroller_id';
    if ($parentType == 'ChiControllerActionKeyTarget') return 'fk_chicontroller_id';
    if ($parentType == 'ChiControllerActionKeySource') return 'fk_chicontroller_id';
    if ($parentType == 'ChiControllerActionKeyTarget') return 'fk_chicontroller_id';
    if ($parentType == 'ChiControllerActionKeySource') return 'fk_chicontroller_id';
    return '';
  }
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiControllerActionKeyTarget', 'is_navigable' => true, 'table_name' => 'ChiController', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chicontroller_id'),
      array('type' => 'ChiControllerActionKeySource', 'is_navigable' => true, 'table_name' => 'ChiController', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chicontroller_id')
    );
