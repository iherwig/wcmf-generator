 ...
 * @version 1.0
 */
class EnterpriseBase extends EntityBase
{
    function EnterpriseBase($oid=null, $type=null)
    {
    if ($type == null)
      parent::EntityBase($oid, 'Enterprise');
    else
    ...
    function getDescription($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('Description', DATATYPE_ATTRIBUTE);
      else
        return $this->getValue('Description', DATATYPE_ATTRIBUTE);
    }
    function setDescription($Description)
    {
      return $this->setValue('Description', $Description, DATATYPE_ATTRIBUTE);
    }
    function getWorkerList()
    {
      return $this->getChildrenEx(null, 'Worker', array('fk_enterprise_id' => $this->getDBID()), null);
    }
