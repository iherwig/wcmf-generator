...
require_once(BASE."application/include/model/domain/class.RelationMultiplicity.php");

/**
 * @class RelationMultiplicityRDBMapper
 * RelationMultiplicityRDBMapper maps RelationMultiplicity Nodes to the database.
 * RelationMultiplicity description: this class contains all the multiplicities that are supported by a relation.
 *
 * @author 
 * @version 1.0
 */
class RelationMultiplicityRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  {
    return new RelationMultiplicity($oid);
  }
  /**
...
// PROTECTED REGION ID(application/include/model/domain/class.RelationMultiplicityRDBMapper.php/Properties) ENABLED START
