...
req.figure.Actor = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "Actor", label, oid, parentoids, childoids);
}
...
req.figure.Actor.prototype.getStore = function(){
...
req.figure.Actor.prototype.showEdit = function(bd, oid){
