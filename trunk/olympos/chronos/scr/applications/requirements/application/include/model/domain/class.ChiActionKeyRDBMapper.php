...
/**
 * @class ChiActionKeyRDBMapper
 * ChiActionKeyRDBMapper maps ChiActionKey Nodes to the database.
 ...
 * @version 1.0
 */
class ChiActionKeyRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      ...
      array('name' => 'display_value', 'value' => 'action|context|context'),
// PROTECTED REGION ID(application/include/model/domain/class.ChiActionKeyRDBMapper.php/Properties) ENABLED START
