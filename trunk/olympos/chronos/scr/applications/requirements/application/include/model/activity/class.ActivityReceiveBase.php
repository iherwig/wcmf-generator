...
class ActivityReceiveBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'Activity', array('fk_activityreceive_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_activityreceive_id' => $this->getDBID()), null);
    }
