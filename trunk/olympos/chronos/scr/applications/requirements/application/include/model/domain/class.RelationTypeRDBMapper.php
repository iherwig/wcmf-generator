...
require_once(BASE."application/include/model/domain/class.RelationType.php");

/**
 * @class RelationTypeRDBMapper
 * RelationTypeRDBMapper maps RelationType Nodes to the database.
 ...
 * @version 1.0
 */
class RelationTypeRDBMapper extends NodeUnifiedRDBMapper
{
  /**
...
// PROTECTED REGION ID(application/include/model/domain/class.RelationTypeRDBMapper.php/Properties) ENABLED START
