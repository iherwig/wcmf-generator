...
{if $viewMode == 'detail'}
    ...
    {if $template->getProperty('canAssociate') == true}
      ...
      curButtonDefs.push({ldelim}icon:'images/link.png', cls:'x-btn-icon', tooltip:{ldelim}text:'{translate text="Associate selected"}'{rdelim}, handler:function(){ldelim}dlgChiRequirementParent.show('ChiRequirement', grids['ChiRequirementParent'], '{$node->getOID()}', true);{rdelim}{rdelim});
    {/if}
