...
class ChiBusinessUseCaseCoreBase extends ChiBusinessUseCase
{
      ...
      if ($name == 'setChiBusinessProcess')
    {
      ...
      // child: ChiUseCaseCoreTargetEnd
      if ($name == 'getChiUseCaseCoreTargetEndList')
    {
      ...
      if ($name == 'getChiUseCaseCoreSourceEndList')
    {
      ...
      if ($name == 'getChiUseCaseCoreSourceEndChildren') {
