...
class FigureRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($parentType == 'NMActivityActivityDecision') return 'fk_nmactivityactivitydecision_id';
    ...
    if ($this->getType() == 'Figure' && $parentType == 'NMActivityActivityDecision') return 'fk_nmactivityactivitydecision_id';
    return '';
  }
  /**
...
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'fk_nmactivityactivitydecision_id', 'app_data_type' => DATATYPE_IGNORE, 'column_name' => 'fk_nmactivityactivitydecision_id', 'db_data_type' => 'INT(11)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
    ...
    (
      ...
      array('type' => 'NMActivityActivityDecision', 'is_navigable' => true, 'table_name' => 'NMActivityActivityDecision', 'pk_columns' => array('id'), 'fk_columns' => 'fk_nmactivityactivitydecision_id')
    );
