...
class FigureRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Figure' && $parentType == 'Relation') return 'fk_relation_id';
    if ($this->getType() == 'Figure' && $parentType == 'NMChiNodeChiNode') return 'fk_nmchinodechinode_id';
    if ($this->getType() == 'Figure' && $parentType == 'NMChiControllerChiController') return 'fk_nmchicontrollerchicontroller_id';
    ...
    if ($parentType == 'Relation') return 'fk_relation_id';
    if ($parentType == 'NMChiNodeChiNode') return 'fk_nmchinodechinode_id';
    if ($parentType == 'NMChiControllerChiController') return 'fk_nmchicontrollerchicontroller_id';
...
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'fk_nmchicontrollerchicontroller_id', 'app_data_type' => DATATYPE_IGNORE, 'column_name' => 'fk_nmchicontrollerchicontroller_id', 'db_data_type' => 'INT(11)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
      array('name' => 'fk_nmchinodechinode_id', 'app_data_type' => DATATYPE_IGNORE, 'column_name' => 'fk_nmchinodechinode_id', 'db_data_type' => 'INT(11)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
      array('name' => 'fk_relation_id', 'app_data_type' => DATATYPE_IGNORE, 'column_name' => 'fk_relation_id', 'db_data_type' => 'INT(11)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => false, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
      * Value description: 
      */
    ...
    (
      ...
      array('type' => 'Relation', 'is_navigable' => true, 'table_name' => 'Relation', 'pk_columns' => array('id'), 'fk_columns' => 'fk_relation_id'),
      array('type' => 'NMChiNodeChiNode', 'is_navigable' => true, 'table_name' => 'NMChiNodeChiNode', 'pk_columns' => array('id'), 'fk_columns' => 'fk_nmchinodechinode_id'),
      array('type' => 'NMChiControllerChiController', 'is_navigable' => true, 'table_name' => 'NMChiControllerChiController', 'pk_columns' => array('id'), 'fk_columns' => 'fk_nmchicontrollerchicontroller_id'),
