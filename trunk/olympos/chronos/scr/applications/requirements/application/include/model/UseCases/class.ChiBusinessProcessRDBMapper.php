...
class ChiBusinessProcessRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessProcess' && $parentType == 'ChiBusinessProcess') return 'fk_chibusinessprocess_id';
    return '';
  }
  /**
...
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'ChiBase', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => false, 'is_navigable' => true, 'table_name' => 'ChiBase', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array()),
      ...
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinessprocess_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
