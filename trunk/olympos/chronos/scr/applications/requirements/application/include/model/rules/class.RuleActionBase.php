 ...
 * @version 1.0
 */
class RuleActionBase extends ChiBase
{
    function RuleActionBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::__construct($oid, 'RuleAction');
      else
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_ruleaction_id' => $this->getDBID()), null, false);
    }
