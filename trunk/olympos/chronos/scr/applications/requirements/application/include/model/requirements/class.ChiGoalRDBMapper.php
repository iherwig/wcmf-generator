...
class ChiGoalRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiGoal' && $parentType == 'ChiGoal') return 'Composition';
...
// PROTECTED REGION ID(application/include/model/requirements/class.ChiGoalRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'GoalType', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'goaltype', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'select#async:ChiGoalType', 'display_type' => 'text'),
     /* 
    ...
    (
      array('type' => 'ChiGoal', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiGoal', 'pk_columns' => array('id'), 'fk_columns' => 'Composition', 'order_by' => array('sortkey')),
      array('type' => 'ChiRequirement', 'minOccurs' => 1, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiRequirement', 'pk_columns' => array('id'), 'fk_columns' => 'Composition', 'order_by' => array('priority')),
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chigoal_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
