 ...
 * @version 1.0
 */
class RelationMultiplicityBase extends EntityBaseExtended
{
    function RelationMultiplicityBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::EntityBaseExtended($oid, 'RelationMultiplicity');
      else
    ...
    {
      return Message::get("RelationMultiplicity");
    }
    /**
    ...
    {
      return Message::get("this class contains all the multiplicities that are supported by a relation.");
    }
    /**
