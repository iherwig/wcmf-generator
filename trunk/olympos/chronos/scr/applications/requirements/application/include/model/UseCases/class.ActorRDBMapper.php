...
/**
 * @class ActorRDBMapper
 * ActorRDBMapper maps Actor Nodes to the database.
 * Actor description: this class reppresent a generic actor.
 *
 * @author 
 * @version 1.0
 */
class ActorRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Actor' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION ID(application/include/model/UseCases/class.ActorRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      ...
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_actor_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
