...
class RoleRDBBase extends Role
{
    ...
    {
      Message::log("use of deprecated method getNMUserRoleList. use getNMUserRoleChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
    ...
    {
      Message::log("use of deprecated method getUserRDBList. use getUserRDBChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
