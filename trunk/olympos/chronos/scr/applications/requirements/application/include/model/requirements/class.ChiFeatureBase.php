...
class ChiFeatureBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'ChiBusinessUseCase', array('Realization' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiBusinessUseCaseCore', array('Realization' => $this->getDBID()), null, false);
    }
