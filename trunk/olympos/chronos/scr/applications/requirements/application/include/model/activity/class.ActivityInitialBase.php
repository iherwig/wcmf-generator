...
class ActivityInitialBase extends ChiBase
{
    ...
    {
      return $this->getChildrenEx(null, 'Activity', array('fk_activityinitial_id' => $this->getDBID()), null);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Figure', array('fk_activityinitial_id' => $this->getDBID()), null);
    }
