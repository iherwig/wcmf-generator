...
This requirement's proofreader's name and role in the project
    ...
    (
      ...
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chirequirement_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
