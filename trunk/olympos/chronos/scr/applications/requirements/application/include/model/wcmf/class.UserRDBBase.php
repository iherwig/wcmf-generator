...
class UserRDBBase extends User
{
      ...
      if ($name == 'getRoleRDBChildren')
    {
      ...
      // child: UserConfig
      if ($name == 'getUserConfigList')
    {
      Log::warn("use of deprecated method getUserConfigList. use getUserConfigChildren() instead.\n".WCMFException::getStackTrace(), __CLASS__);
      return $this->getUserConfigChildren();
    }
      if ($name == 'getUserConfigChildren') {
        return $this->getChildrenEx(null, 'UserConfig', array('fk_user_id' => $this->getDBID()), null, false);
    }
    }
