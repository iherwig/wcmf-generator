...
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Mon Apr 26 17:26:11 CEST 2010. 
...
class ActivityFinalRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ActivityFinal' && $parentType == 'ActivitySet') return 'fk_activityset_id';
    if ($this->getType() == 'ActivityFinal' && $parentType == 'ProductionRuleSet') return 'fk_productionruleset_id';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ControlFlow', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_activityfinal_id', 'order_by' => array()),
