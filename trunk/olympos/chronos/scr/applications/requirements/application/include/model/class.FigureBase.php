...
class FigureBase extends EntityBase
{
    ...
    function getValueDisplayName($name, $type=null)
    {
      ...
      if ($name == 'fk_nmchicontrollerchicontroller_id') $displayName = Message::get("fk_nmchicontrollerchicontroller_id");
      if ($name == 'fk_nmchinodechinode_id') $displayName = Message::get("fk_nmchinodechinode_id");
      if ($name == 'fk_relation_id') $displayName = Message::get("fk_relation_id");
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'fk_nmchicontrollerchicontroller_id') $description = Message::get("");
      if ($name == 'fk_nmchinodechinode_id') $description = Message::get("");
      if ($name == 'fk_relation_id') $description = Message::get("");
    ...
    function getFkNmchicontrollerchicontrollerId($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('fk_nmchicontrollerchicontroller_id', DATATYPE_IGNORE);
      else
        return $this->getValue('fk_nmchicontrollerchicontroller_id', DATATYPE_IGNORE);
    }
    function setFkNmchicontrollerchicontrollerId($fk_nmchicontrollerchicontroller_id)
    {
      return $this->setValue('fk_nmchicontrollerchicontroller_id', $fk_nmchicontrollerchicontroller_id, DATATYPE_IGNORE);
    }
    function getFkNmchinodechinodeId($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('fk_nmchinodechinode_id', DATATYPE_IGNORE);
      else
        return $this->getValue('fk_nmchinodechinode_id', DATATYPE_IGNORE);
    }
    function setFkNmchinodechinodeId($fk_nmchinodechinode_id)
    {
      return $this->setValue('fk_nmchinodechinode_id', $fk_nmchinodechinode_id, DATATYPE_IGNORE);
    }
    function getFkRelationId($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('fk_relation_id', DATATYPE_IGNORE);
      else
        return $this->getValue('fk_relation_id', DATATYPE_IGNORE);
    }
    function setFkRelationId($fk_relation_id)
    {
      return $this->setValue('fk_relation_id', $fk_relation_id, DATATYPE_IGNORE);
    }
    ...
    function getRelationOID()
    {
      $fkValue = $this->getValue('fk_relation_id', DATATYPE_IGNORE);
      if ($fkValue != null)
        return PersistenceFacade::composeOID(array('type' => 'Relation', 'id' => array($fkValue)));
      else
        return null;
    }
    function setRelation(&$node)
    {
      if ($node != null)
        $this->setValue('fk_relation_id', $node->getDBID(), DATATYPE_IGNORE);
    }
    function getNMChiNodeChiNodeOID()
    {
      $fkValue = $this->getValue('fk_nmchinodechinode_id', DATATYPE_IGNORE);
      if ($fkValue != null)
        return PersistenceFacade::composeOID(array('type' => 'NMChiNodeChiNode', 'id' => array($fkValue)));
      else
        return null;
    }
    function setNMChiNodeChiNode(&$node)
    {
      if ($node != null)
        $this->setValue('fk_nmchinodechinode_id', $node->getDBID(), DATATYPE_IGNORE);
    }
    function getNMChiControllerChiControllerOID()
    {
      $fkValue = $this->getValue('fk_nmchicontrollerchicontroller_id', DATATYPE_IGNORE);
      if ($fkValue != null)
        return PersistenceFacade::composeOID(array('type' => 'NMChiControllerChiController', 'id' => array($fkValue)));
      else
        return null;
    }
    function setNMChiControllerChiController(&$node)
    {
      if ($node != null)
        $this->setValue('fk_nmchicontrollerchicontroller_id', $node->getDBID(), DATATYPE_IGNORE);
    }
    ...
    function getRelationParents()
    {
      return $this->getParentsEx(null, 'Relation', null, null);
    }
    function getNMChiNodeChiNodeParents()
    {
      return $this->getParentsEx(null, 'NMChiNodeChiNode', null, null);
    }
    function getNMChiControllerChiControllerParents()
    {
      return $this->getParentsEx(null, 'NMChiControllerChiController', null, null);
    }
