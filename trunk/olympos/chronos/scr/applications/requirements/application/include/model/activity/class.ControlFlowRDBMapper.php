...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowSource', 'AControlFlowTarget', 'ADControlFlowSource', 'ADControlFlowTarget', 'ARControlFlowSource', 'ARControlFlowTarget', 'ASControlFlowSource', 'ASControlFlowTarget', 'ActivityInitial', 'ActivityFinal')),
