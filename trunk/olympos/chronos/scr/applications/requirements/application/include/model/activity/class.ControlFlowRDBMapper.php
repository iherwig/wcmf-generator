...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowSource', 'AControlFlowTarget', 'ADControlFlowTarget', 'ADControlFlowSource', 'ARControlFlowSource', 'ARControlFlowTarget', 'ASControlFlowSource', 'ASControlFlowTarget', 'ActivityInitial', 'ActivityFinal')),
