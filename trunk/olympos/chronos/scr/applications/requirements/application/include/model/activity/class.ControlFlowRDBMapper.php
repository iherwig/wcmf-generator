...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowTarget', 'AControlFlowSource', 'ADControlFlowTarget', 'ADControlFlowSource', 'ARControlFlowSource', 'ARControlFlowTarget', 'ASControlFlowSource', 'ASControlFlowTarget', 'ActivityInitial', 'ActivityFinal')),
