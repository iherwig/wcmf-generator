...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowSource', 'AControlFlowTarget', 'ADControlFlowSource', 'ADControlFlowTarget', 'ARControlFlowSource', 'ARControlFlowTarget', 'ASControlFlowTarget', 'ASControlFlowSource', 'ActivityInitial', 'ActivityFinal')),
