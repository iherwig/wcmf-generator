...
class ControlFlowRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getObjectDefinitionImpl()
  {
    ...
    (
      array('name' => 'manyToMany', 'value' => array('AControlFlowTarget', 'AControlFlowSource', 'ADControlFlowSource', 'ADControlFlowTarget', 'ARControlFlowSource', 'ARControlFlowTarget', 'ASControlFlowTarget', 'ASControlFlowSource', 'ActivityInitial', 'ActivityFinal')),
