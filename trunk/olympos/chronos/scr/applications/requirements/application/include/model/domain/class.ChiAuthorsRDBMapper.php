<?php
/**
 * This file was generated by wCMFGenerator 3 from src/model/wcmf_default.uml on Mon Apr 27 15:03:55 CEST 2009. 
 * Manual modifications should be placed inside the protected regions.
 */
require_once(BASE."wcmf/lib/model/mapper/class.NodeUnifiedRDBMapper.php");
require_once(BASE."application/include/model/domain/class.ChiAuthors.php");

/**
 * @class ChiAuthorsRDBMapper
 * ChiAuthorsRDBMapper maps ChiAuthors Nodes to the database.
 * ChiAuthors description: This class host all the actors actively involved in the project.
 *
 * @author 
 * @version 1.0
 */
class ChiAuthorsRDBMapper extends NodeUnifiedRDBMapper
{
  /**
...
// PROTECTED REGION ID(application/include/model/domain/class.ChiAuthorsRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      ...
      * Value description: 
      */
      array('name' => 'Role', 'app_data_type' => DATATYPE_ATTRIBUTE, 'column_name' => 'role', 'db_data_type' => 'VARCHAR(255)', 'default' => '', 'restrictions_match' => '', 'restrictions_not_match' => '', 'restrictions_description' => '', 'is_editable' => true, 'input_type' => 'text', 'display_type' => 'text'),
     /* 
