...
require_once(BASE."application/include/model/rules/class.RuleCondition.php");

/**
 * @class RuleConditionRDBMapper
 * RuleConditionRDBMapper maps RuleCondition Nodes to the database.
 * RuleCondition description: 
 *
 * @author 
 * @version 1.0
 */
class RuleConditionRDBMapper extends NodeUnifiedRDBMapper
{
  /**
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'RuleCondition' && $parentType == 'ProductionRule') return 'fk_productionrule_id';
    if ($this->getType() == 'RuleCondition' && $parentType == 'Package') return 'fk_package_id';
...
// PROTECTED REGION ID(application/include/model/rules/class.RuleConditionRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
    ...
    (
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_rulecondition_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
