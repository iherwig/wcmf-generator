...
class ChiBusinessUseCaseBase extends ChiBase
{
      ...
      if ($name == 'getActivitySetList')
    {
      ...
      // child: ChiUseCaseTargetEnd
      if ($name == 'getChiUseCaseTargetEndList')
    {
      ...
      if ($name == 'getChiUseCaseSourceEndList')
    {
      ...
      if ($name == 'getChiUseCaseSourceEndChildren') {
