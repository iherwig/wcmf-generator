...
// PROTECTED REGION ID(application/include/model/UseCases/class.ChiBusinessPartnerActiveRDBMapper.php/Properties) START
// PROTECTED REGION END
    ...
    (
      array('type' => 'NMUCActor', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMUCActor', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartneractive_id', 'order_by' => array()),
      array('type' => 'Figure', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => true, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Figure', 'pk_columns' => array('id'), 'fk_columns' => 'fk_chibusinesspartneractive_id', 'order_by' => array())
    );
    return $nodeDef;
  }
}
