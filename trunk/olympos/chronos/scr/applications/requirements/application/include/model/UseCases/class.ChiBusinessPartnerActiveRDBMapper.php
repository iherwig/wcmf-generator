...
class ChiBusinessPartnerActiveRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'ChiBusinessPartnerActive' && $parentType == 'ChiBusinessPartnerActive') return 'Generalization';
    if ($this->getType() == 'ChiBusinessPartnerActive' && $parentType == 'Package') return 'fk_package_id';
    if ($parentType == 'ChiBusinessPartnerActive') return 'Generalization';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ChiBusinessPartnerActive', 'is_navigable' => true, 'table_name' => 'ChiBusinessPartnerActive', 'pk_columns' => array('id'), 'fk_columns' => 'Generalization'),
      array('type' => 'Package', 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'fk_package_id')
    );
    $nodeDef['_children'] = array
    (
      array('type' => 'ChiBusinessPartnerActive', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ChiBusinessPartnerActive', 'pk_columns' => array('id'), 'fk_columns' => 'Generalization', 'order_by' => array('sortkey')),
