...
class ActivityRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Activity' && $parentType == 'ActivitySet') return 'Aggregation';
    if ($this->getType() == 'Activity' && $parentType == 'Activity') return 'Association';
    if ($this->getType() == 'Activity' && $parentType == 'ActivityReceive') return 'Association';
    if ($this->getType() == 'Activity' && $parentType == 'ActivityInitial') return 'Association';
    if ($this->getType() == 'Activity' && $parentType == 'Package') return 'fk_package_id';
    if ($parentType == 'ActivitySet') return 'Aggregation';
    if ($parentType == 'Activity') return 'Association';
    if ($parentType == 'ActivityReceive') return 'Association';
    if ($parentType == 'ActivityInitial') return 'Association';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'ActivitySet', 'is_navigable' => true, 'table_name' => 'ActivitySet', 'pk_columns' => array('id'), 'fk_columns' => 'Aggregation'),
      array('type' => 'Activity', 'is_navigable' => true, 'table_name' => 'Activity', 'pk_columns' => array('id'), 'fk_columns' => 'Association'),
      array('type' => 'ActivityReceive', 'is_navigable' => true, 'table_name' => 'ActivityReceive', 'pk_columns' => array('id'), 'fk_columns' => 'Association'),
      array('type' => 'ActivityInitial', 'is_navigable' => true, 'table_name' => 'ActivityInitial', 'pk_columns' => array('id'), 'fk_columns' => 'Association'),
      array('type' => 'Package', 'is_navigable' => true, 'table_name' => 'Package', 'pk_columns' => array('id'), 'fk_columns' => 'fk_package_id')
    );
    $nodeDef['_children'] = array
    (
      array('type' => 'NMActivityActivityDecision', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'NMActivityActivityDecision', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
      ...
      array('type' => 'Activity', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'Activity', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
      array('type' => 'ActivitySend', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ActivitySend', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
      array('type' => 'ActivityFinal', 'minOccurs' => 1, 'maxOccurs' => 1, 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ActivityFinal', 'pk_columns' => array('id'), 'fk_columns' => 'Association', 'order_by' => array()),
