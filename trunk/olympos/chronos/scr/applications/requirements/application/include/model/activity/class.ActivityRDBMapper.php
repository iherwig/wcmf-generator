...
class ActivityRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  function getMyFKColumnNameImpl($parentType)
  {
    ...
    if ($this->getType() == 'Activity' && $parentType == 'ProductionRuleSet') return 'fk_productionruleset_id';
...
// PROTECTED REGION END
    ...
    (
      array('type' => 'AControlFlowSourceEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_acontrolflowsource_id', 'order_by' => array()),
      array('type' => 'AControlFlowTargetEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ControlFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_acontrolflowtarget_id', 'order_by' => array()),
      array('type' => 'AObjectFlowSourceEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ObjectFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_aobjectflowsource_id', 'order_by' => array()),
      array('type' => 'AObjectFlowTargetEnd', 'minOccurs' => 0, 'maxOccurs' => 'unbounded', 'aggregation' => false, 'composition' => true, 'is_navigable' => true, 'table_name' => 'ObjectFlow', 'pk_columns' => array('id'), 'fk_columns' => 'fk_aobjectflowtarget_id', 'order_by' => array()),
