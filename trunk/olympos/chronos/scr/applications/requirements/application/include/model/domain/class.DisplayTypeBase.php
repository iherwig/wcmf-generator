 ...
 * @version 1.0
 */
class DisplayTypeBase extends EntityBaseExtended
{
    function DisplayTypeBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::EntityBaseExtended($oid, 'DisplayType');
      else
    ...
    {
      return Message::get("DisplayType");
    }
    /**
    ...
    {
      return Message::get("list all the allowed display types (e.g image, text, links)");
    }
    /**
