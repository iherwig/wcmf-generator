...
class NMUserRoleBase extends Node
{
    ...
    function getValueDisplayName($name, $type=null)
    {
      ...
      if ($name == 'fk_rolerdb_id') $displayName = Message::get("fk_rolerdb_id");
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'fk_rolerdb_id') $description = Message::get("");
    ...
    function getFkRolerdbId($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('fk_rolerdb_id', DATATYPE_IGNORE);
      else
        return $this->getValue('fk_rolerdb_id', DATATYPE_IGNORE);
    }
    function setFkRolerdbId($fk_rolerdb_id)
    {
      return $this->setValue('fk_rolerdb_id', $fk_rolerdb_id, DATATYPE_IGNORE);
    }
    function getRoleRDBOID()
    {
      $fkValue = $this->getValue('fk_rolerdb_id', DATATYPE_IGNORE);
      if ($fkValue != null)
    ...
    {
      if ($node != null)
        $this->setValue('fk_rolerdb_id', $node->getDBID(), DATATYPE_IGNORE);
    }
    ...
    {
      if ($node != null)
        $this->setValue('fk_userrdb_id', $node->getDBID(), DATATYPE_IGNORE);
    }
