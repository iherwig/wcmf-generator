...
req.figure.EntityBaseExtended = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "EntityBaseExtended", label, oid, parentoids, childoids);
}
...
req.figure.EntityBaseExtended.prototype.getStore = function(){
...
req.figure.EntityBaseExtended.prototype.showEdit = function(bd, oid){
