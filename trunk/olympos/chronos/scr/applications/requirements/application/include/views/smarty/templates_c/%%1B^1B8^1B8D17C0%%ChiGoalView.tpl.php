...
<?php if ($this->_tpl_vars['viewMode'] == 'detail'): ?>
    ...
    // ChiRequirement
    <?php $this->assign('template', $this->_tpl_vars['possiblechildren']['ChiRequirement']); ?>
...
, sortable:true, renderer:grids['ChiRequirementChild'].renderColumnDefault.createDelegate(grids['ChiRequirementChild'])});
...
'}, 
        handler:function(){dlgChiRequirementChild.show('<?php echo $this->_tpl_vars['realSubject']->getType(); ?>
', grids['ChiRequirementChild'], '<?php echo $this->_tpl_vars['poid']; ?>
', false);}});
      <?php endif; ?>
    <?php endif; ?>
    buttonDefs['ChiRequirementChild'] = curButtonDefs;
    // grid initialization
    grids['ChiRequirementChild'].init('<?php echo $this->_tpl_vars['realSubject']->getObjectDisplayName(); ?>
', 'ChiRequirement', '<?php echo ((is_array($_tmp=$this->_tpl_vars['nodeUtil']->getChildQuery($this->_tpl_vars['node'],'ChiRequirement'))) ? $this->_run_mod_handler('replace', true, $_tmp, "'", "\'") : smarty_modifier_replace($_tmp, "'", "\'")); ?>
', columDefs['ChiRequirementChild'], {paging:true, autoheight:true, singleSelect:true, ddRows:<?php echo $this->_tpl_vars['ddRows']; ?>
}, [new wcmf.grid.EditAction(), <?php if ($this->_tpl_vars['template']->getProperty('canCreate')): ?>new wcmf.grid.DuplicateAction(), <?php endif; ?>new wcmf.grid.DeleteAction()], buttonDefs['ChiRequirementChild'], {ptype:'<?php echo $this->_tpl_vars['node']->getType(); ?>
...
<div class="contentblock">
	<img align="right" src="images/ChiRequirementGoal.PNG" width="50" height="50" alt="ChiGoal border="0" />
...
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('Priority'); ?>
	...
	<span class="dottedSeparator"></span>
	<span class="left" title="<?php echo $this->_tpl_vars['node']->getValueDescription('Value_Name'); ?>
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('Value_Name'); ?>
</span>
	<span class="right"><?php echo $this->_tpl_vars['nodeUtil']->getInputControl($this->_tpl_vars['node'],'Value_Name'); ?>
</span>

	<span class="dottedSeparator"></span>
	<span class="left" title="<?php echo $this->_tpl_vars['node']->getValueDescription('Value_ammount'); ?>
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('Value_ammount'); ?>
</span>
	<span class="right"><?php echo $this->_tpl_vars['nodeUtil']->getInputControl($this->_tpl_vars['node'],'Value_ammount'); ?>
</span>

	<span class="dottedSeparator"></span>
	<span class="left" title="<?php echo $this->_tpl_vars['node']->getValueDescription('Value_Goal'); ?>
"><?php echo $this->_tpl_vars['node']->getValueDisplayName('Value_Goal'); ?>
</span>
	<span class="right"><?php echo $this->_tpl_vars['nodeUtil']->getInputControl($this->_tpl_vars['node'],'Value_Goal'); ?>
</span>
