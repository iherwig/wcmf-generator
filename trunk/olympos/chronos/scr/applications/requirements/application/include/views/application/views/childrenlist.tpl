...
<div class="sublist">
    ...
    {if !$composition}
		...
		<a href="javascript:setVariable('associateoid', document.getElementById('{$type}ChildrenIFrame').contentWindow.document.forms[0].associateTo.value); submitAction('associate');" target="_parent" title="{translate text="Associate selected"}"><img src="images/link.png" alt="{translate text="Associate selected"}" title="{translate text="Associate selected"}" border="0"></a>
    {else}
    &nbsp;
    {/if}
	</span>
