...
class ChiObjectBase extends ChiBase
{
    ...
    function getValueDisplayName($name, $type=null)
    {
      ...
      if ($name == 'is instance of') $displayName = Message::get("is instance of");
    ...
    function getValueDescription($name, $type=null)
    {
      ...
      if ($name == 'is instance of') $description = Message::get("");
    ...
    function getIs instance of($unconverted=false)
    {
      if ($unconverted)
        return $this->getUnconvertedValue('is instance of', DATATYPE_IGNORE);
      else
        return $this->getValue('is instance of', DATATYPE_IGNORE);
    }
    function setIs instance of($is instance of)
    {
      return $this->setValue('is instance of', $is instance of, DATATYPE_IGNORE);
    }
    ...
    {
      $fkValue = $this->getValue('is instance of', DATATYPE_IGNORE);
      if ($fkValue != null)
    ...
    {
      if ($node != null)
        $this->setValue('is instance of', $node->getDBID(), DATATYPE_IGNORE);
    }
    ...
    {
      return $this->getChildrenEx(null, 'NMActivityChiObject', array('fk_chiobject_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    function loadChildren($type, $buildDepth=BUILDDEPTH_SINGLE, $forceUpdate=false)
    {
      ...
      if ($type == 'Activity')
      {
        ...
        $children = parent::getChildrenEx(null, 'NMActivityChiObject', array('fk_chiobject_id' => $this->getDBID()), null, false);
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'Activity')
      {
        ...
        $associationNodeConstraint = array('NMActivityChiObject', array('fk_chiobject_id' => $this->getDBID(), 'fk_activity_id' => $ids[0]));
