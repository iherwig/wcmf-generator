 ...
 */
require_once(BASE."application/include/model/domain/class.Class.php");
 ...
 * @version 1.0
 */
class ChiNodeBase extends Class
{
    function ChiNodeBase($oid=null, $type=null)
    {
      if ($type == null)
        parent::Class($oid, 'ChiNode');
      else
    ...
    {
      return $this->getChildrenEx(null, 'ChiObject', array('is instance of' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiValueRef', array('Composition' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'ChiValue', array('Composition' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'NMChiNodeChiNode', array('fk_chinodetarget_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'NMChiNodeChiNode', array('fk_chinodesource_id' => $this->getDBID()), null, false);
    }
    /**
    ...
    {
      return $this->getChildrenEx(null, 'Operation', array('Composition' => $this->getDBID()), null, false);
    }
    /**
