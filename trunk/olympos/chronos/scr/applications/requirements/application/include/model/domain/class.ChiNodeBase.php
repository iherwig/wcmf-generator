...
class ChiNodeBase extends ChiBase
{
    ...
    {
      Message::log("use of deprecated method getNodeSourceEndList. use getNodeSourceEndChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
    ...
    {
      Message::log("use of deprecated method getNodeTargetEndList. use getNodeTargetEndChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
    ...
    {
      Message::log("use of deprecated method getOperationList. use getOperationChildren() instead.\n".Message::getStackTrace(), __FILE__, __LINE__);
