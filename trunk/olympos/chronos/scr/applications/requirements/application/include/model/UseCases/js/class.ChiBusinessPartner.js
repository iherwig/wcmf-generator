...
req.figure.ChiBusinessPartner = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiBusinessPartner", label, oid, parentoids, childoids);
}
...
req.figure.ChiBusinessPartner.prototype.getStore = function(){
...
req.figure.ChiBusinessPartner.prototype.showEdit = function(bd, oid){
