...
class PackageBase extends EntityBaseExtended
{
    ...
    {
      return $this->getChildrenEx(null, 'Package', array('Composition' => $this->getDBID()), null, false);
    }
    /**
    ...
    /**
     * @deprecated use getClassChildren() instead
     */
    function getClassList()
    {
      Log::warn("use of deprecated method getClassList. use getClassChildren() instead.\n".WCMFException::getStackTrace(), __CLASS__);
      return $this->getClassChildren();
    }
    function getClassChildren()
    {
      return $this->getChildrenEx(null, 'Class', array('fk_package_id' => $this->getDBID()), null, false);
    }
    /**
