<?php
/**
 * This file was generated by wCMFGenerator 3.0.0018 from requirements.uml on Mon May 31 15:14:15 CEST 2010. 
...
class ChiBusinessPartnerBase extends Actor
{
    ...
    {
      if ($type == null)
        parent::__construct($oid, 'ChiBusinessPartner');
      else
      ...
      if ($name == 'getChiBusinessPartnerList')
    {
      ...
      if ($name == 'getChiBusinessPartnerChildren') {
        return $this->getChildrenEx(null, 'ChiBusinessPartner', array('fk_chibusinesspartner_id' => $this->getDBID()), null, false);
    }
      // child: Figure
      if ($name == 'getFigureList')
    {
      ...
      if ($name == 'getFigureChildren') {
        return $this->getChildrenEx(null, 'Figure', array('fk_chibusinesspartner_id' => $this->getDBID()), null, false);
    }
      ...
      if ($name == 'getChiBusinessPartnerPassiveList')
    {
      ...
      if ($name == 'getChiBusinessPartnerPassiveChildren') {
        return $this->getChildrenEx(null, 'ChiBusinessPartnerPassive', array('fk_chibusinesspartner_id' => $this->getDBID()), null, false);
    }
      ...
      if ($name == 'getChiBusinessPartnerActiveList')
    {
      ...
      if ($name == 'getChiBusinessPartnerActiveChildren') {
        return $this->getChildrenEx(null, 'ChiBusinessPartnerActive', array('fk_chibusinesspartner_id' => $this->getDBID()), null, false);
    }
      // child: NMUCActor
      if ($name == 'getNMUCActorList')
    {
      ...
      if ($name == 'getNMUCActorChildren') {
        return $this->getChildrenEx(null, 'NMUCActor', array('fk_chibusinesspartner_id' => $this->getDBID()), null, false);
    }
    ...
    function loadChildren($type, $buildDepth=BUILDDEPTH_SINGLE, $forceUpdate=false)
    {
      ...
      if ($type == 'ChiBusinessUseCase')
      {
        ...
        $children = parent::getChildrenEx(null, 'NMUCActor', array('fk_chibusinesspartner_id' => $this->getDBID()), null, false);
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessUseCase')
      {
        ...
        $associationNodeConstraint = array('fk_chibusinesspartner_id' => $this->getDBID(), 'fk_chibusinessusecase_id' => $ids[0]);
      ...
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessUseCaseCore')
      {
        ...
        // check if the connection child is loaded already
        $ids = PersistenceFacade::getOIDParameter($childOID, 'id');
        $associationNodeConstraint = array('fk_chibusinesspartner_id' => $this->getDBID(), 'fk_chibusinessusecasecore_id' => $ids[0]);
        $associationNode = &$this->getFirstChild('NMUCActor', $associationNodeConstraint, null, false);
        if ($associationNode != null)
          $childOID = $associationNode->getOID();
        else
