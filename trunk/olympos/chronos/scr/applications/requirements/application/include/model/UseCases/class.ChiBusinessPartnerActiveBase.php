<?php
/**
 * This file was generated by wCMFGenerator 3.0.0017 from requirements.uml on Thu Jul 02 09:52:21 CEST 2009. 
...
class ChiBusinessPartnerActiveBase extends ChiBusinessPartner
{
    ...
    function deleteChild($childOID, $reallyDelete=false)
    {
      if (PersistenceFacade::isValidOID($childOID) && PersistenceFacade::getOIDParameter($childOID, 'type') == 'ChiBusinessUseCase')
      {
        ...
        $associationNodeConstraint = array('NMUCActor', array('fk_chibusinesspartneractive_id' => $this->getDBID(), 'fk_chibusinessusecase_id' => $ids[0]));
