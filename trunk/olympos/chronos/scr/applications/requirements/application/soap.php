...
/**
 * WSDL definition for Glossar
 */
$server->wsdl->addComplexType('Glossar', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('GlossarList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:Glossar[]')
    ),
    'tns:Glossar'
);
$server->register('getGlossarList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:GlossarList'), $NAMESPACE);
  
$server->register('createGlossar',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'Glossar'=>'tns:Glossar', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readGlossar',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:Glossar'), $NAMESPACE);
  
$server->register('updateGlossar',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'Glossar'=>'tns:Glossar', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteGlossar',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
...
/**  
 * SOAP Method getGlossarList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getGlossarList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'Glossar'));
// PROTECTED REGION ID(soap/Methods/getGlossarList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createGlossar
 * @param login The login name
 * @param password The login password
 * @param Glossar The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createGlossar($login, $password, $Glossar, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'Glossar',  PersistenceFacade::composeOID(array('type' => 'Glossar')) => $Glossar, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createGlossar) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function readGlossar($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readGlossar) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function updateGlossar($login, $password, $Glossar, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $Glossar, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateGlossar) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteGlossar
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteGlossar($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteGlossar) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
