...
$server->wsdl->addComplexType('ChiGoal', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
        'fk_figure_id' => array('name' => 'fk_figure_id', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('Figure', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'PostionX' => array('name' => 'PostionX', 'type' => 'xsd:string'),
        'Width' => array('name' => 'Width', 'type' => 'xsd:string'),
        'created' => array('name' => 'created', 'type' => 'xsd:string'),
        'creator' => array('name' => 'creator', 'type' => 'xsd:string'),
        'last_editor' => array('name' => 'last_editor', 'type' => 'xsd:string'),
...
$server->register('getFigureList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:FigureList'), $NAMESPACE);
  
$server->register('createFigure',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'Figure'=>'tns:Figure', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readFigure',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:Figure'), $NAMESPACE);
  
$server->register('updateFigure',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'Figure'=>'tns:Figure', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteFigure',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
...
/**  
 * SOAP Method getFigureList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getFigureList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'Figure'));
// PROTECTED REGION ID(soap/Methods/getFigureList) START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createFigure
 * @param login The login name
 * @param password The login password
 * @param Figure The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createFigure($login, $password, $Figure, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'Figure',  PersistenceFacade::composeOID(array('type' => 'Figure')) => $Figure, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createFigure) START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
 ...
 * @return string
 */  
function readFigure($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readFigure) START
	$result = doSoapCall();
  // extract the childoids, parentoids properties
  $node = $result->getValue('node');
  $node['parentoids'] = $node['properties']['parentoids'];
 ...
 * @return string
 */  
function updateFigure($login, $password, $Figure, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $Figure, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateFigure) START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteFigure
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteFigure($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteFigure) START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
// PROTECTED REGION ID(soap/Methods/getNMFiguresDiagramList) START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
// PROTECTED REGION ID(soap/Methods/createNMFiguresDiagram) START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readNMFiguresDiagram) START
	$result = doSoapCall();
  // extract the childoids, parentoids properties
  $node = $result->getValue('node');
  $node['parentoids'] = $node['properties']['parentoids'];
...
// PROTECTED REGION ID(soap/Methods/updateNMFiguresDiagram) START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteNMFiguresDiagram) START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
// PROTECTED REGION ID(soap/Methods/getNMUCActorList) START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
// PROTECTED REGION ID(soap/Methods/createNMUCActor) START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readNMUCActor) START
	$result = doSoapCall();
  // extract the childoids, parentoids properties
  $node = $result->getValue('node');
  $node['parentoids'] = $node['properties']['parentoids'];
...
// PROTECTED REGION ID(soap/Methods/updateNMUCActor) START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteNMUCActor) START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
