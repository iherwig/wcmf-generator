<?php
/**
 * This file was generated by wCMFGenerator 3.0.0017 from requirements.uml on Thu Jul 02 15:18:35 CEST 2009. 
...
$server->wsdl->addComplexType('ChiNode', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'ChiValue' => array('name' => 'ChiValue', 'type' => 'tns:ChiValueList'),
        'NMChiNodeChiNode' => array('name' => 'NMChiNodeChiNode', 'type' => 'tns:NMChiNodeChiNodeList'),
        'NMChiNodeChiNode' => array('name' => 'NMChiNodeChiNode', 'type' => 'tns:NMChiNodeChiNodeList'),
...
/**
 * WSDL definition for NMChiNodeChiNode
 */
$server->wsdl->addComplexType('NMChiNodeChiNode', 'complexType', 'struct', 'sequence', '',
    array(
        'id' => array('name' => 'id', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('NMChiNodeChiNodeList', 'complexType', 'array', '', 'SOAP-ENC:Array', array(),
    array(
        array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:NMChiNodeChiNode[]')
    ),
    'tns:NMChiNodeChiNode'
);
$server->register('getNMChiNodeChiNodeList',
	array('login'=>'xsd:string', 'password'=>'xsd:string'),
	array('return'=>'tns:NMChiNodeChiNodeList'), $NAMESPACE);
  
$server->register('createNMChiNodeChiNode',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'NMChiNodeChiNode'=>'tns:NMChiNodeChiNode', 'parentoid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('readNMChiNodeChiNode',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string', 'depth'=>'xsd:integer'),
	array('return'=>'tns:NMChiNodeChiNode'), $NAMESPACE);
  
$server->register('updateNMChiNodeChiNode',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'NMChiNodeChiNode'=>'tns:NMChiNodeChiNode', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
  
$server->register('deleteNMChiNodeChiNode',
	array('login'=>'xsd:string', 'password'=>'xsd:string', 'oid'=>'xsd:string'),
	array('return'=>'xsd:string'), $NAMESPACE);
...
/**  
 * SOAP Method getNMChiNodeChiNodeList 
 * @param login The login name
 * @param password The login password
 * @return string
 */  
function getNMChiNodeChiNodeList($login, $password)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'list', 'type' => 'NMChiNodeChiNode'));
// PROTECTED REGION ID(soap/Methods/getNMChiNodeChiNodeList) ENABLED START
	$result = doSoapCall();
	return $result->getValue('objects');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method createNMChiNodeChiNode
 * @param login The login name
 * @param password The login password
 * @param NMChiNodeChiNode The serialized object data
 * @param parentoid The object id of the object to add the new object as child to
 * @return string
 */  
function createNMChiNodeChiNode($login, $password, $NMChiNodeChiNode, $parentoid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'new', 'newtype' => 'NMChiNodeChiNode',  PersistenceFacade::composeOID(array('type' => 'NMChiNodeChiNode')) => $NMChiNodeChiNode, 'poid' => $parentoid));
// PROTECTED REGION ID(soap/Methods/createNMChiNodeChiNode) ENABLED START
	$result = doSoapCall();
	return $result->getValue('oid');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method readNMChiNodeChiNode 
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to load
 * @param depth The number of generations to load
 * @return string
 */  
function readNMChiNodeChiNode($login, $password, $oid, $depth)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'display', 'oid' => $oid, 'depth' => $depth));
// PROTECTED REGION ID(soap/Methods/readNMChiNodeChiNode) ENABLED START
	$result = doSoapCall();
	return $result->getValue('node');
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method updateNMChiNodeChiNode 
 * @param login The login name
 * @param password The login password
 * @param NMChiNodeChiNode The serialized object data
 * @param oid The object id of the object to update
 * @return string
 */  
function updateNMChiNodeChiNode($login, $password, $NMChiNodeChiNode, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'save', $oid => $NMChiNodeChiNode, 'oid' => $oid));
// PROTECTED REGION ID(soap/Methods/updateNMChiNodeChiNode) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
...
/**  
 * SOAP Method deleteNMChiNodeChiNode
 * @param login The login name
 * @param password The login password
 * @param oid The object id of the object to delete
 * @return string
 */  
function deleteNMChiNodeChiNode($login, $password, $oid)  
{
	$_GET = array_merge($_GET, array('login' => $login, 'password' => $password, 'usr_action' => 'delete', 'deleteoids' => $oid));
// PROTECTED REGION ID(soap/Methods/deleteNMChiNodeChiNode) ENABLED START
	$result = doSoapCall();
	return $result;
// PROTECTED REGION END
}  
