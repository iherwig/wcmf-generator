...
$server->wsdl->addComplexType('Figure', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'fk_nmchicontrollerchicontroller_id' => array('name' => 'fk_nmchicontrollerchicontroller_id', 'type' => 'xsd:string'),
        'fk_nmchinodechinode_id' => array('name' => 'fk_nmchinodechinode_id', 'type' => 'xsd:string'),
        'fk_relation_id' => array('name' => 'fk_relation_id', 'type' => 'xsd:string'),
...
$server->wsdl->addComplexType('Package', 'complexType', 'struct', 'sequence', '',
    array(
        ...
        'Relation' => array('name' => 'Relation', 'type' => 'tns:RelationList'),
        'NMChiNodeChiNode' => array('name' => 'NMChiNodeChiNode', 'type' => 'tns:NMChiNodeChiNodeList'),
        'NMChiControllerChiController' => array('name' => 'NMChiControllerChiController', 'type' => 'tns:NMChiControllerChiControllerList'),
