...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ; // will be overriden by fckeditor.tpl
FCKConfig.LinkBrowserWindowWidth	= 800;
FCKConfig.LinkBrowserWindowHeight	= 600;

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ; // will be overriden by fckeditor.tpl
FCKConfig.ImageBrowserWindowWidth  = 800;
FCKConfig.ImageBrowserWindowHeight = 600;

FCKConfig.FlashBrowser = true ;
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Flash&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ; // will be overriden by fckeditor.tpl
