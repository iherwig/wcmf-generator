...
chi.persistency.ActionSet.prototype.addSearch = function(query, chiModelElementId, limit, offset, sortByRelevance, sortAttributeName, sortDirection, successHandler, errorHandler, errorLevel) {
	this.requests[this.getNextId()] = {
	    action : "search",
	    query : query,
