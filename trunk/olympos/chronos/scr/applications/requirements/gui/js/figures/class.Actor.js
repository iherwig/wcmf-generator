...
cwm.figure.Actor = function(label, oid, parentoids, childoids){

	cwm.figure.RectFigure.call(this, "Actor", label, oid, parentoids, childoids);
}

cwm.figure.Actor.prototype = new uwm.figure.RectFigure;

cwm.figure.Actor.prototype.type = "cwm.figure.Actor";

cwm.figure.Actor.prototype.getGrid = function(store) {
	return new Ext.grid.GridPanel({
	id: "GridActor",
		iconCls: "FigureGraphic FigureActor",
		layout: "fit",
					columns: [{
						header: "Actor",
						dataIndex: "Name",
...
cwm.figure.Actor.prototype.getStore = function(){
...
cwm.figure.Actor.prototype.showEdit = function(parentComponent, oid){
...
cwm.figure.Actor.prototype.getConstraints = function() {
	return {
