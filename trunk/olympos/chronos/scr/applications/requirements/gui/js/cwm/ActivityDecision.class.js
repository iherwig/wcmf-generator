...
cwm.ActivityDecision = function(modelNodeClass) {
	cwm.ActivityDecision.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ActivityDecision, uwm.model.ModelObject);

cwm.ActivityDecision.prototype.initByDisplayResult = function(node) {
	cwm.ActivityDecision.superclass.initByDisplayResult.call(this, node);
...
cwm.ActivityDecision.prototype.populatePropertyForm = function(form) {
...
cwm.ActivityDecision.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
