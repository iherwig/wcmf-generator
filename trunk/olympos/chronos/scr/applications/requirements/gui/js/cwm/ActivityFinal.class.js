...
cwm.ActivityFinal = function(modelNodeClass) {
	cwm.ActivityFinal.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ActivityFinal, uwm.model.ModelObject);

cwm.ActivityFinal.prototype.initByDisplayResult = function(node) {
	cwm.ActivityFinal.superclass.initByDisplayResult.call(this, node);
...
cwm.ActivityFinal.prototype.populatePropertyForm = function(form) {
...
cwm.ActivityFinal.prototype.getGridData = function() {
	return {
		oid :this.getOid(),
		label :this.getLabel()
	}
