 ...
 * @constructor
 */
ModelConnection = function(labelText){
	draw2d.Connection.call(this);
	
	this.setTargetDecorator(new ModelConnectionDecorator());
	...
	this.label = new draw2d.Label(labelText);
	this.label.setBackgroundColor(new draw2d.Color(255, 255, 255));
	
	this.addFigure(this.label, new ModelMidpointLocator(this));
	
	this.setDeleteable(true);
}

ModelConnection.prototype = new draw2d.Connection();

ModelConnection.prototype.getLabel = function(){
	return this.label;
}
