...
cwm.Glossar = function(modelNodeClass) {
	cwm.Glossar.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.Glossar, uwm.model.ModelObject);

cwm.Glossar.prototype.initByDisplayResult = function(node) {
	cwm.Glossar.superclass.initByDisplayResult.call(this, node);
...
cwm.Glossar.prototype.populatePropertyForm = function(form) {
...
cwm.Glossar.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
