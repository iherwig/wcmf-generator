...
uwm.modeltree.UseCaseCoreNode = function(config) {
	this.modelNode = uwm.model.ModelContainer.getInstance().createByClassAndNameAndOid("ChiBusinessUseCaseCore", config.text, config.oid);
...
uwm.modeltree.UseCaseCoreNode.prototype.showInHierarchy = function(self, e) {
...
uwm.modeltree.UseCaseCoreNode.prototype.duplicate = function(self, e) {
