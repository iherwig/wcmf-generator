...
uwm.graphics.figure.ClassFigure.prototype.setWorkflow = function(workflow) {
	return uwm.graphics.figure.BaseFigure.prototype.setWorkflow.call(this,
			workflow);
}
...
uwm.graphics.figure.ClassFigure.prototype.onContextMenu = function(x, y) {
	return uwm.graphics.figure.BaseFigure.prototype.onContextMenu.call(this, x,
			y);
}
...
uwm.graphics.figure.ClassFigure.prototype.setDimension = function(width, height) {
	uwm.graphics.figure.BaseFigure.prototype.setDimension.call(this, width,
			height);
...
uwm.graphics.figure.ClassFigure.prototype.createHTMLElement = function() {
	var item = uwm.graphics.figure.BaseFigure.prototype.createHTMLElement
			.call(this);
	...
	this.label.style.height = (uwm.graphics.figure.ClassFigure.LABEL_HEIGHT - 10)
			+ "px";
...
uwm.graphics.figure.ClassFigure.prototype.setLabel = function(newText) {
	return uwm.graphics.figure.BaseFigure.prototype.setLabel
			.call(this, newText);
}
...
uwm.graphics.figure.ClassFigure.prototype.addChildElement = function(newChild,
		expandFigure) {
	var newPropertyPosition = uwm.graphics.figure.ClassFigure.LABEL_HEIGHT
			+ uwm.graphics.figure.ClassFigure.SECTIONS_SPACING;
	var newOperationPosition = newPropertyPosition
			+ uwm.graphics.figure.ClassFigure.SECTIONS_SPACING * 3;
	...
	if (newChild instanceof uwm.graphics.figure.Attribute) {
		...
		this.workflow.getCommandStack().execute(
				new draw2d.CommandAdd(this.workflow, newChild,
						myPosition.x + 2, myPosition.y + newOperationPosition,
						this));
	}
	...
	if (expandFigure) {
		...
		command.setDimension(this.getWidth(), this.getHeight()
				+ newChild.getHeight());
...
uwm.graphics.figure.ClassFigure.prototype.removeChildElement = function(
		childToRemove, shrinkFigure) {
...
uwm.graphics.figure.ClassFigure.prototype.paint = function() {
	...
	this.graphics.drawLine(0, uwm.graphics.figure.ClassFigure.LABEL_HEIGHT,
			width, uwm.graphics.figure.ClassFigure.LABEL_HEIGHT);
	...
	var linePos = uwm.graphics.figure.ClassFigure.LABEL_HEIGHT + propertySize
			+ uwm.graphics.figure.ClassFigure.SECTIONS_SPACING * 2;
