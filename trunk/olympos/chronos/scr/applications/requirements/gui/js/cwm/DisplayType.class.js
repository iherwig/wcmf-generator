...
cwm.DisplayType = function(modelNodeClass) {
	cwm.DisplayType.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.DisplayType, uwm.model.TechnicalObject);

cwm.DisplayType.prototype.initByDisplayResult = function(node) {
	cwm.DisplayType.superclass.initByDisplayResult.call(this, node);
...
cwm.DisplayType.prototype.populatePropertyForm = function(form) {
...
cwm.DisplayType.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
