...
cwm.ChiNodeTarget = function(modelNodeClass) {
	cwm.ChiNodeTarget.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiNodeTarget, uwm.model.ModelObject);

cwm.ChiNodeTarget.prototype.initByDisplayResult = function(node) {
	cwm.ChiNodeTarget.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiNodeTarget.prototype.populatePropertyForm = function(form) {
...
cwm.ChiNodeTarget.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
