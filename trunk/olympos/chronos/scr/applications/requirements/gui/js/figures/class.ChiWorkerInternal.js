...
req.figure.ChiWorkerInternal = function(label, oid, parentoids, childoids){

	req.figure.RectFigure.call(this, "ChiWorkerInternal", label, oid, parentoids, childoids);
}
...
req.figure.ChiWorkerInternal.prototype.getStore = function(){
...
req.figure.ChiWorkerInternal.prototype.showEdit = function(bd, oid){
