...
cwm.ChiValueRef = function(modelNodeClass) {
	cwm.ChiValueRef.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiValueRef, uwm.model.AttributeObject);

cwm.ChiValueRef.prototype.initByDisplayResult = function(node) {
	cwm.ChiValueRef.superclass.initByDisplayResult.call(this, node);
      this.data.reference_type = node.values[1].reference_type;
      this.data.reference_value = node.values[1].reference_value;
...
cwm.ChiValueRef.prototype.populatePropertyForm = function(form) {
	var realForm = form.getForm();
      realForm.findField("reference_type").loadValue(this.data.reference_type);
      realForm.findField("reference_value").loadValue(this.data.reference_value);
...
cwm.ChiValueRef.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
