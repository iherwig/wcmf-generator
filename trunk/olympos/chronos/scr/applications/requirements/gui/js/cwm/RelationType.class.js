...
cwm.RelationType = function(modelNodeClass) {
	cwm.RelationType.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.RelationType, uwm.model.TechnicalObject);

cwm.RelationType.prototype.initByDisplayResult = function(node) {
	cwm.RelationType.superclass.initByDisplayResult.call(this, node);
