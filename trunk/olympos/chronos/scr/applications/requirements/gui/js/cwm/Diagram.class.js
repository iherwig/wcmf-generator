...
cwm.Diagram = function(modelNodeClass) {
	cwm.Diagram.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.Diagram, uwm.model.ModelObject);

cwm.Diagram.prototype.initByDisplayResult = function(node) {
	cwm.Diagram.superclass.initByDisplayResult.call(this, node);
...
cwm.Diagram.prototype.populatePropertyForm = function(form) {
...
cwm.Diagram.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		Label: this.getLabel()
	}
