...
cwm.ChiBusinessPartner = function(modelNodeClass) {
	cwm.ChiBusinessPartner.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiBusinessPartner, uwm.model.ModelObject);

cwm.ChiBusinessPartner.prototype.initByDisplayResult = function(node) {
	cwm.ChiBusinessPartner.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiBusinessPartner.prototype.populatePropertyForm = function(form) {
