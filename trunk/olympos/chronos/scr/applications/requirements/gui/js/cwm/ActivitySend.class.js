...
cwm.ActivitySend = function(modelNodeClass) {
	cwm.ActivitySend.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ActivitySend, uwm.model.ModelObject);

cwm.ActivitySend.prototype.initByDisplayResult = function(node) {
	cwm.ActivitySend.superclass.initByDisplayResult.call(this, node);
...
cwm.ActivitySend.prototype.populatePropertyForm = function(form) {
...
cwm.ActivitySend.prototype.getGridData = function() {
	return {
		oid :this.getOid(),
		label :this.getLabel()
	}
