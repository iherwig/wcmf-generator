...
cwm.ChiAuthors = function(modelNodeClass) {
	cwm.ChiAuthors.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiAuthors, uwm.model.ModelObject);

cwm.ChiAuthors.prototype.initByDisplayResult = function(node) {
	cwm.ChiAuthors.superclass.initByDisplayResult.call(this, node);
      this.data.Role = node.values[1].Role;
