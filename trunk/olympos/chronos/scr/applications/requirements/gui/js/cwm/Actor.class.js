...
cwm.Actor = function(modelNodeClass) {
	cwm.Actor.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.Actor, uwm.model.ModelObject);

cwm.Actor.prototype.initByDisplayResult = function(node) {
	cwm.Actor.superclass.initByDisplayResult.call(this, node);
...
cwm.Actor.prototype.populatePropertyForm = function(form) {
