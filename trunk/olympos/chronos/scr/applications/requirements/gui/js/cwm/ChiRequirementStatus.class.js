...
cwm.ChiRequirementStatus = function(modelNodeClass) {
	cwm.ChiRequirementStatus.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiRequirementStatus, uwm.model.ModelObject);

cwm.ChiRequirementStatus.prototype.initByDisplayResult = function(node) {
	cwm.ChiRequirementStatus.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiRequirementStatus.prototype.populatePropertyForm = function(form) {
