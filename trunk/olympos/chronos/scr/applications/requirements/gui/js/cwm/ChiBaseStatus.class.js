...
cwm.ChiBaseStatus = function(modelNodeClass) {
	cwm.ChiBaseStatus.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiBaseStatus, uwm.model.ModelObject);

cwm.ChiBaseStatus.prototype.initByDisplayResult = function(node) {
	cwm.ChiBaseStatus.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiBaseStatus.prototype.populatePropertyForm = function(form) {
...
cwm.ChiBaseStatus.prototype.getGridData = function() {
	return {
		oid: this.getOid(),
		label: this.getLabel()
	}
