...
cwm.ChiWorker = function(modelNodeClass) {
	cwm.ChiWorker.superclass.constructor.call(this, modelNodeClass);
}

Ext.extend(cwm.ChiWorker, uwm.model.ModelObject);

cwm.ChiWorker.prototype.initByDisplayResult = function(node) {
	cwm.ChiWorker.superclass.initByDisplayResult.call(this, node);
...
cwm.ChiWorker.prototype.populatePropertyForm = function(form) {
