...
cwm.figure.ChiWorker = function(label, oid, parentoids, childoids){

	cwm.figure.RectFigure.call(this, "ChiWorker", label, oid, parentoids, childoids);
}

cwm.figure.ChiWorker.prototype = new uwm.figure.RectFigure;

cwm.figure.ChiWorker.prototype.type = "cwm.figure.ChiWorker";

cwm.figure.ChiWorker.prototype.getGrid = function(store) {
	return new Ext.grid.GridPanel({
	id: "GridChiWorker",
		iconCls: "FigureGraphic FigureChiWorker",
		layout: "fit",
					columns: [{
						header: "ChiWorker",
						dataIndex: "Name",
...
cwm.figure.ChiWorker.prototype.getStore = function(){
...
cwm.figure.ChiWorker.prototype.showEdit = function(parentComponent, oid){
...
cwm.figure.ChiWorker.prototype.getConstraints = function() {
	return {
