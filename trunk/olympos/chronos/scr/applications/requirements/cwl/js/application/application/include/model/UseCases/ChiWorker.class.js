...
application.application.include.model.UseCases.ChiWorker = function() {
	application.application.include.model.UseCases.ChiWorker.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.UseCases.ChiWorker, chi.model.ModelClass);


application.application.include.model.UseCases.ChiWorker.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorker.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorker.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiWorker.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiWorker());
