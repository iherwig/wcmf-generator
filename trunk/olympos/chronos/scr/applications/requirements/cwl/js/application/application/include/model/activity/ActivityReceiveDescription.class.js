...
application.application.include.model.activity.ActivityReceiveDescription = function() {
	application.application.include.model.activity.ActivityReceiveDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ActivityReceive";
	this.name = "ActivityReceive";
	this.treeIconClass = "ActivityReceiveTreeIcon16x16";
...
Ext.extend(application.application.include.model.activity.ActivityReceiveDescription, chi.model.ModelDescription);


application.application.include.model.activity.ActivityReceiveDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityReceiveDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivityReceiveDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityReceiveDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.activity.ActivityReceiveDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.activity.ActivityReceive(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.activity.ActivityReceiveDescription());
