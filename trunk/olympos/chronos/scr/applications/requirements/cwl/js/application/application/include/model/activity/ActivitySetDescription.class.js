...
application.application.include.model.activity.ActivitySetDescription = function() {
	application.application.include.model.activity.ActivitySetDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ActivitySet";
...
Ext.extend(application.application.include.model.activity.ActivitySetDescription, chi.model.ModelDescription);


application.application.include.model.activity.ActivitySetDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivitySetDescription.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivitySetDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.activity.ActivitySetDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.activity.ActivitySet(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.activity.ActivitySetDescription());
