...
application.application.include.model.activity.ActivityFinalDescription = function() {
	application.application.include.model.activity.ActivityFinalDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ActivityFinal";
	this.name = "ActivityFinal";
	this.treeIconClass = "ActivityFinalTreeIcon16x16";
...
Ext.extend(application.application.include.model.activity.ActivityFinalDescription, chi.model.ModelDescription);


application.application.include.model.activity.ActivityFinalDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityFinalDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivityFinalDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityFinalDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.activity.ActivityFinalDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.activity.ActivityFinal(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.activity.ActivityFinalDescription());
