...
application.application.include.model.rules.ProductionRuleSet = function() {
	application.application.include.model.rules.ProductionRuleSet.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.rules.ProductionRuleSet, chi.model.ModelClass);


application.application.include.model.rules.ProductionRuleSet.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.ProductionRuleSet.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.rules.ProductionRuleSet.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.ProductionRuleSet.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.rules.ProductionRuleSet());
