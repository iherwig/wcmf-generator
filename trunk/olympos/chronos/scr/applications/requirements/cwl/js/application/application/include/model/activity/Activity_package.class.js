...
application.application.include.model.activity.Activity_package = function() {
	...
	this.chiModelElementId = "application.application.include.model.activity.Activity_package";
	this.name = "activity";
	this.owningPackageId = "application.application.include.model.Model_package";
	this.startExpanded = true;
};

Ext.extend(application.application.include.model.activity.Activity_package, chi.model.ModelPackage);

chi.model.ModelPackageContainer.getInstance().registerPackage(new application.application.include.model.activity.Activity_package());
