...
Ext.extend(application.application.include.model.requirements.ChiRequirement, chi.model.ModelClass);
...
application.application.include.model.requirements.ChiRequirement.prototype.getGridColumns = function() {
	return [
			...
			new chi.editor.control.ComboBox({
				targetChiModelElementId: "ChiRequirementType"
			})
		...
		, 
			...
			new chi.editor.control.ComboBox({
				targetChiModelElementId: "ChiRequirementStatus"
			})
...
application.application.include.model.requirements.ChiRequirement.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.requirements.ChiRequirement.prototype.getLabel = function(record) {
	var label = record.get("Name") + " - " + record.get("Priority");
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.requirements.ChiRequirement());
