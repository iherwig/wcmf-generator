...
application.application.include.model.activity.ActivityReceive = function() {
	application.application.include.model.activity.ActivityReceive.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.activity.ActivityReceive, chi.model.ModelClass);


application.application.include.model.activity.ActivityReceive.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityReceive.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivityReceive.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityReceive.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivityReceive());
