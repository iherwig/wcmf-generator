...
Ext.extend(application.application.include.model.requirements.ChiRequirementType, chi.model.ModelClass);


application.application.include.model.requirements.ChiRequirementType.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.requirements.ChiRequirementType.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.requirements.ChiRequirementType.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.requirements.ChiRequirementType());
