...
application.application.include.model.UseCases.ChiBusinessProcess = function() {
	application.application.include.model.UseCases.ChiBusinessProcess.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessProcess, chi.model.ModelClass);


application.application.include.model.UseCases.ChiBusinessProcess.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessProcess.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessProcess.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessProcess.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessProcess());
