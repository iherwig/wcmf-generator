...
application.application.include.model.UseCases.ChiBusinessProcessDescription = function() {
	application.application.include.model.UseCases.ChiBusinessProcessDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiBusinessProcess";
	this.name = "ChiBusinessProcess";
	this.treeIconClass = "ChiBusinessProcessTreeIcon16x16";
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessProcessDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ChiBusinessProcessDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessProcessDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessProcessDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessProcessDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ChiBusinessProcessDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.ChiBusinessProcess(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ChiBusinessProcessDescription());
