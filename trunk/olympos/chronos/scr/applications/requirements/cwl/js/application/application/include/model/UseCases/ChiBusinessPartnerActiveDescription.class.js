...
application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription = function() {
	application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiBusinessPartnerActive";
	this.name = "ChiBusinessPartnerActive";
	this.treeIconClass = "ChiBusinessPartnerActiveTreeIcon16x16";
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.ChiBusinessPartnerActive(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ChiBusinessPartnerActiveDescription());
