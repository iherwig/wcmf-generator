...
application.application.include.model.FigureDescription = function() {
	application.application.include.model.FigureDescription.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.FigureDescription, chi.model.ModelDescription);


application.application.include.model.FigureDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.FigureDescription.prototype.getLabelColumns = function() {
	return [
 ...
 */
application.application.include.model.FigureDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.Figure(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.FigureDescription());
