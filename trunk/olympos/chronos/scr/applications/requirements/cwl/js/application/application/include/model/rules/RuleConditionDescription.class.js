...
application.application.include.model.rules.RuleConditionDescription = function() {
	application.application.include.model.rules.RuleConditionDescription.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.rules.RuleConditionDescription, chi.model.ModelDescription);


application.application.include.model.rules.RuleConditionDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.RuleConditionDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.rules.RuleConditionDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.RuleConditionDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.rules.RuleConditionDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.rules.RuleCondition(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.rules.RuleConditionDescription());
