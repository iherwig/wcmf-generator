...
application.application.include.model.activity.ActivityDescription = function() {
	application.application.include.model.activity.ActivityDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "Activity";
	this.name = "Activity";
	this.treeIconClass = "ActivityTreeIcon16x16";
...
Ext.extend(application.application.include.model.activity.ActivityDescription, chi.model.ModelDescription);


application.application.include.model.activity.ActivityDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivityDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.activity.ActivityDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.activity.Activity(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.activity.ActivityDescription());
