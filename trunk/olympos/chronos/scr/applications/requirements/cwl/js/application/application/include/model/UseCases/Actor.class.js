...
application.application.include.model.UseCases.Actor = function() {
	application.application.include.model.UseCases.Actor.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.UseCases.Actor, chi.model.ModelClass);


application.application.include.model.UseCases.Actor.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.Actor.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.Actor.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.Actor.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.Actor());
