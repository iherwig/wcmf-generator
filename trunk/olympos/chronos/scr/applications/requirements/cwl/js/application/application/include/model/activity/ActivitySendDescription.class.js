...
application.application.include.model.activity.ActivitySendDescription = function() {
	application.application.include.model.activity.ActivitySendDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ActivitySend";
	this.name = "ActivitySend";
	this.treeIconClass = "ActivitySendTreeIcon16x16";
...
Ext.extend(application.application.include.model.activity.ActivitySendDescription, chi.model.ModelDescription);


application.application.include.model.activity.ActivitySendDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivitySendDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivitySendDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivitySendDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.activity.ActivitySendDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.activity.ActivitySend(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.activity.ActivitySendDescription());
