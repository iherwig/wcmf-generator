...
application.application.include.model.rules.ProductionRule = function() {
	application.application.include.model.rules.ProductionRule.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.rules.ProductionRule, chi.model.ModelClass);


application.application.include.model.rules.ProductionRule.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.ProductionRule.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.rules.ProductionRule.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.ProductionRule.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.rules.ProductionRule());
