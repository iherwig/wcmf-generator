...
application.application.include.model.rules.RuleActionDescription = function() {
	application.application.include.model.rules.RuleActionDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "RuleAction";
	this.name = "RuleAction";
	this.treeIconClass = "RuleActionTreeIcon16x16";
...
Ext.extend(application.application.include.model.rules.RuleActionDescription, chi.model.ModelDescription);


application.application.include.model.rules.RuleActionDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.RuleActionDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.rules.RuleActionDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.RuleActionDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.rules.RuleActionDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.rules.RuleAction(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.rules.RuleActionDescription());
