...
application.application.include.model.UseCases.ChiWorkerInternalDescription = function() {
	application.application.include.model.UseCases.ChiWorkerInternalDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiWorkerInternal";
...
Ext.extend(application.application.include.model.UseCases.ChiWorkerInternalDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ChiWorkerInternalDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorkerInternalDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorkerInternalDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiWorkerInternalDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ChiWorkerInternalDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.ChiWorkerInternal(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ChiWorkerInternalDescription());
