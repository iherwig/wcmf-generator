...
application.application.include.model.activity.ActivitySend = function() {
	application.application.include.model.activity.ActivitySend.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.activity.ActivitySend, chi.model.ModelClass);


application.application.include.model.activity.ActivitySend.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivitySend.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivitySend.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivitySend.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivitySend());
