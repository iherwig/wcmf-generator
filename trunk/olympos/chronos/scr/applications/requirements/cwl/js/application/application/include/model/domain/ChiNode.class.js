...
Ext.extend(application.application.include.model.domain.ChiNode, chi.model.ModelClass);
...
application.application.include.model.domain.ChiNode.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiNode.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiNode());
