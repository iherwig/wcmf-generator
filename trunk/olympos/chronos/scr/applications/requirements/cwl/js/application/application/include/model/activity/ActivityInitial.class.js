...
Ext.extend(application.application.include.model.activity.ActivityInitial, chi.model.ModelClass);


application.application.include.model.activity.ActivityInitial.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityInitial.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityInitial.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivityInitial());
