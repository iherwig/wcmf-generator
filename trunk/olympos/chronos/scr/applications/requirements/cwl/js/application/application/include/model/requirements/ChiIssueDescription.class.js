...
application.application.include.model.requirements.ChiIssueDescription = function() {
	application.application.include.model.requirements.ChiIssueDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiIssue";
	this.name = "ChiIssue";
...
Ext.extend(application.application.include.model.requirements.ChiIssueDescription, chi.model.ModelDescription);


application.application.include.model.requirements.ChiIssueDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.requirements.ChiIssueDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.requirements.ChiIssueDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.requirements.ChiIssueDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.requirements.ChiIssueDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.requirements.ChiIssue(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.requirements.ChiIssueDescription());
