...
application.application.include.model.UseCases.ChiWorkerDescription = function() {
	application.application.include.model.UseCases.ChiWorkerDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiWorker";
	this.name = "ChiWorker";
	this.treeIconClass = "ChiWorkerTreeIcon16x16";
...
Ext.extend(application.application.include.model.UseCases.ChiWorkerDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ChiWorkerDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorkerDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorkerDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiWorkerDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ChiWorkerDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.ChiWorker(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ChiWorkerDescription());
