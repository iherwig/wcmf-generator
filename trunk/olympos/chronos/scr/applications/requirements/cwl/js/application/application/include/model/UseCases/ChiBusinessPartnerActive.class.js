...
application.application.include.model.UseCases.ChiBusinessPartnerActive = function() {
	application.application.include.model.UseCases.ChiBusinessPartnerActive.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessPartnerActive, chi.model.ModelClass);


application.application.include.model.UseCases.ChiBusinessPartnerActive.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerActive.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerActive.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessPartnerActive.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessPartnerActive());
