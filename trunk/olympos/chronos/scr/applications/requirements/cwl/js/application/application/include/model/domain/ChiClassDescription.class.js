...
application.application.include.model.domain.ChiClassDescription = function() {
	application.application.include.model.domain.ChiClassDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiClass";
	this.name = "ChiClass";
	this.treeIconClass = "ChiClassTreeIcon16x16";
...
Ext.extend(application.application.include.model.domain.ChiClassDescription, chi.model.ModelDescription);


application.application.include.model.domain.ChiClassDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.domain.ChiClassDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.domain.ChiClassDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiClassDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.domain.ChiClassDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.domain.ChiClass(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.domain.ChiClassDescription());
