...
application.application.include.model.rules.RuleAction = function() {
	application.application.include.model.rules.RuleAction.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.rules.RuleAction, chi.model.ModelClass);


application.application.include.model.rules.RuleAction.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.RuleAction.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.rules.RuleAction.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.RuleAction.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.rules.RuleAction());
