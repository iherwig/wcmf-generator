...
application.application.include.model.UseCases.ChiWorkerExternalDescription = function() {
	application.application.include.model.UseCases.ChiWorkerExternalDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiWorkerExternal";
...
Ext.extend(application.application.include.model.UseCases.ChiWorkerExternalDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ChiWorkerExternalDescription.prototype.getGridColumns = function() {
	return [
	
		
			{
			    header : "isOfflineUser",
			    dataIndex : "isOfflineUser",
			    width : 100,
			    sortable : true,
			    hidden: true,
			    editor: 
...
application.application.include.model.UseCases.ChiWorkerExternalDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiWorkerExternalDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiWorkerExternalDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ChiWorkerExternalDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.ChiWorkerExternal(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ChiWorkerExternalDescription());
