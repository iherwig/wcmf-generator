...
application.application.include.model.UseCases.ChiBusinessPartnerDescription = function() {
	application.application.include.model.UseCases.ChiBusinessPartnerDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ChiBusinessPartner";
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessPartnerDescription, chi.model.ModelDescription);


application.application.include.model.UseCases.ChiBusinessPartnerDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.UseCases.ChiBusinessPartnerDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessPartnerDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.UseCases.ChiBusinessPartnerDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.UseCases.ChiBusinessPartner(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.UseCases.ChiBusinessPartnerDescription());
