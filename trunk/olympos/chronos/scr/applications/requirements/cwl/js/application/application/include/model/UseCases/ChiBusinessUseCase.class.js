...
Ext.extend(application.application.include.model.UseCases.ChiBusinessUseCase, chi.model.ModelClass);
...
application.application.include.model.UseCases.ChiBusinessUseCase.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.UseCases.ChiBusinessUseCase.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessUseCase());
