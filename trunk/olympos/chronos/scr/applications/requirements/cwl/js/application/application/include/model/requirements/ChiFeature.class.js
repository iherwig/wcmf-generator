...
Ext.extend(application.application.include.model.requirements.ChiFeature, chi.model.ModelClass);
...
application.application.include.model.requirements.ChiFeature.prototype.getGridColumns = function() {
	return [
		...
		, 
			...
			new chi.editor.control.ComboBox({
				targetChiModelElementId: "ChiFeatureStatus"
			})
...
application.application.include.model.requirements.ChiFeature.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.requirements.ChiFeature.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.requirements.ChiFeature());
