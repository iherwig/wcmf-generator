...
Ext.extend(application.application.include.model.domain.ChiController, chi.model.ModelClass);
...
application.application.include.model.domain.ChiController.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.domain.ChiController.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiController());
