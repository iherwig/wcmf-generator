...
application.application.include.model.rules.RuleVariable = function() {
	application.application.include.model.rules.RuleVariable.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.rules.RuleVariable, chi.model.ModelClass);


application.application.include.model.rules.RuleVariable.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.rules.RuleVariable.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.rules.RuleVariable.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.rules.RuleVariable.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.rules.RuleVariable());
