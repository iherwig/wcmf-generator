...
application.application.include.model.activity.ChiObject = function() {
	application.application.include.model.activity.ChiObject.superclass.constructor.call(this, arguments);
...
Ext.extend(application.application.include.model.activity.ChiObject, chi.model.ModelClass);


application.application.include.model.activity.ChiObject.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ChiObject.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ChiObject.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ChiObject.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ChiObject());
