...
Ext.extend(application.application.include.model.Diagram, chi.model.ModelClass);
...
application.application.include.model.Diagram.prototype.getLabelColumns = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.Diagram.prototype.getLabel = function(record) {
...
chi.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.Diagram());
