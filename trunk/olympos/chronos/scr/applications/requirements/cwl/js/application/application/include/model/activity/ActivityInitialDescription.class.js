...
application.application.include.model.activity.ActivityInitialDescription = function() {
	application.application.include.model.activity.ActivityInitialDescription.superclass.constructor.call(this, arguments);
	
	this.chiModelElementId = "ActivityInitial";
...
Ext.extend(application.application.include.model.activity.ActivityInitialDescription, chi.model.ModelDescription);


application.application.include.model.activity.ActivityInitialDescription.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.activity.ActivityInitialDescription.prototype.getLabelColumns = function() {
	return [
...
application.application.include.model.activity.ActivityInitialDescription.prototype.getEditorItems = function() {
	return [
 ...
 * @type String
 */
application.application.include.model.activity.ActivityInitialDescription.prototype.getLabel = function(record) {
 ...
 */
application.application.include.model.activity.ActivityInitialDescription.prototype.createInstance = function(oid, data) {
	return new application.application.include.model.activity.ActivityInitial(oid, data);
};


chi.model.ModelDescriptionContainer.getInstance().registerDescription(new application.application.include.model.activity.ActivityInitialDescription());
