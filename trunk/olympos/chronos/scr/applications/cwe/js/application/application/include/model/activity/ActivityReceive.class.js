...
application.application.include.model.activity.ActivityReceive = function() {
	...
	this.cweModelElementId = "ActivityReceive";
...
Ext.extend(application.application.include.model.activity.ActivityReceive, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivityReceive());
