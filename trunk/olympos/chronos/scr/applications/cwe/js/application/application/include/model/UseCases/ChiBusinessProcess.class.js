...
application.application.include.model.UseCases.ChiBusinessProcess = function() {
	...
	this.cweModelElementId = "ChiBusinessProcess";
...
Ext.extend(application.application.include.model.UseCases.ChiBusinessProcess, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiBusinessProcess());
