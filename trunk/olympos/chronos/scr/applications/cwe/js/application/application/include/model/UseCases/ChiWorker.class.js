...
application.application.include.model.UseCases.ChiWorker = function() {
	...
	this.cweModelElementId = "ChiWorker";
	this.name = "ChiWorker";
...
Ext.extend(application.application.include.model.UseCases.ChiWorker, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.UseCases.ChiWorker());
