...
application.application.include.model.domain.ChiAssociation = function() {
	application.application.include.model.domain.ChiAssociation.superclass.constructor.call(this, arguments);
	
	this.cweModelElementId = "ChiAssociation";
	this.name = "ChiAssociation";
	this.treeIconClass = "ChiAssociationTreeIcon16x16";
...
Ext.extend(application.application.include.model.domain.ChiAssociation, cwe.model.ModelClass);


application.application.include.model.domain.ChiAssociation.prototype.getGridColumns = function() {
	return [
...
application.application.include.model.domain.ChiAssociation.prototype.getEditorItems = function() {
	return [
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiAssociation());
