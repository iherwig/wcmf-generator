...
application.application.include.model.domain.ChiClass = function() {
	...
	this.cweModelElementId = "ChiClass";
	this.name = "ChiClass";
...
Ext.extend(application.application.include.model.domain.ChiClass, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiClass());
