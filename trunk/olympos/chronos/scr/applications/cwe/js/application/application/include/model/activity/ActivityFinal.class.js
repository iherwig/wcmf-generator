...
application.application.include.model.activity.ActivityFinal = function() {
	...
	this.cweModelElementId = "ActivityFinal";
...
Ext.extend(application.application.include.model.activity.ActivityFinal, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.activity.ActivityFinal());
