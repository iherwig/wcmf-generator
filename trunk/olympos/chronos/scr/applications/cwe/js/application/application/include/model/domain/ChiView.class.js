...
application.application.include.model.domain.ChiView = function() {
	...
	this.cweModelElementId = "ChiView";
	this.name = "ChiView";
...
Ext.extend(application.application.include.model.domain.ChiView, cwe.model.ModelClass);
...
cwe.model.ModelClassContainer.getInstance().registerClass(new application.application.include.model.domain.ChiView());
