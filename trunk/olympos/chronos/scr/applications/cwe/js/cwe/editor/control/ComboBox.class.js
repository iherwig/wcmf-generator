	...
	cwe.editor.control.ComboBox.superclass.constructor.call(this, Ext.apply(this, {
	    store : new Ext.data.Store( {
		    proxy : new cwe.editor.control.ComboBoxProxy( {
			    modelClass : cwe.model.ModelClassContainer.getInstance().getClass(config.targetCweModelElementId)
		    })
	    }),
	    displayField : 'val',
	    valueField : 'key',
...
Ext.extend(cwe.editor.control.ComboBox, Ext.form.ComboBox);

cwe.editor.control.ComboBox.prototype.render = function(container, position) {
	cwe.editor.control.ComboBox.superclass.render.apply(this, arguments);
 ...
 * the store is null, when you try to open a cwe.editor.control.ComboBox by
 * clicking the pulldown button and a (different) cwe.editor.control.ComboBox
 ...
 */
cwe.editor.control.ComboBox.prototype.findRecord = function(prop, value) {
